/**
 * WarHelmetSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> SuffixCooldown.
 */

class WarHelmetSuffixCooldownEngine {
...
module.exports = { WarHelmetSuffixCooldownEngine };
