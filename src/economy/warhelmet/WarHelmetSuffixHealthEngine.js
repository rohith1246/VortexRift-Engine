/**
 * WarHelmetSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> SuffixHealth.
 */

class WarHelmetSuffixHealthEngine {
...
module.exports = { WarHelmetSuffixHealthEngine };
