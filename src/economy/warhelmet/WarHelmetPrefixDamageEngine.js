/**
 * WarHelmetPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> PrefixDamage.
 */

class WarHelmetPrefixDamageEngine {
  constructor(itemLevel = 55) {
...
module.exports = { WarHelmetPrefixDamageEngine };
