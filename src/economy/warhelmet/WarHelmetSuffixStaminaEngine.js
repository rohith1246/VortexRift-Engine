/**
 * WarHelmetSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> SuffixStamina.
 */

class WarHelmetSuffixStaminaEngine {
...
module.exports = { WarHelmetSuffixStaminaEngine };
