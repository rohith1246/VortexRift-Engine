/**
 * WarHelmetAffixTierMultiplierEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> AffixTierMultiplier.
 */

class WarHelmetAffixTierMultiplierEngine {
  constructor(itemLevel = 94) {
...
module.exports = { WarHelmetAffixTierMultiplierEngine };
