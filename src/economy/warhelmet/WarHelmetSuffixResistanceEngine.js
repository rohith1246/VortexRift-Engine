/**
 * WarHelmetSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> SuffixResistance.
 */

class WarHelmetSuffixResistanceEngine {
...
module.exports = { WarHelmetSuffixResistanceEngine };
