/**
 * WarHelmetAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> AffixSockets.
 */

class WarHelmetAffixSocketsEngine {
...
module.exports = { WarHelmetAffixSocketsEngine };
