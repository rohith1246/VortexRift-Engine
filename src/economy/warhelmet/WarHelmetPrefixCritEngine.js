/**
 * WarHelmetPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> PrefixCrit.
 */

class WarHelmetPrefixCritEngine {
...
module.exports = { WarHelmetPrefixCritEngine };
