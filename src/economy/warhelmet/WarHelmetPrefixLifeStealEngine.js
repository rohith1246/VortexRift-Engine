/**
 * WarHelmetPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> PrefixLifeSteal.
 */

class WarHelmetPrefixLifeStealEngine {
  constructor(itemLevel = 67) {
...
module.exports = { WarHelmetPrefixLifeStealEngine };
