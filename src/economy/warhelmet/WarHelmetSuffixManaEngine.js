/**
 * WarHelmetSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> SuffixMana.
 */

class WarHelmetSuffixManaEngine {
...
module.exports = { WarHelmetSuffixManaEngine };
