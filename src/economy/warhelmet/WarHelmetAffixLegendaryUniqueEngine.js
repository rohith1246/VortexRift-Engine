/**
 * WarHelmetAffixLegendaryUniqueEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> AffixLegendaryUnique.
 */

class WarHelmetAffixLegendaryUniqueEngine {
  constructor(itemLevel = 97) {
...
module.exports = { WarHelmetAffixLegendaryUniqueEngine };
