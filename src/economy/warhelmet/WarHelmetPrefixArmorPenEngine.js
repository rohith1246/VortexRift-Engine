/**
 * WarHelmetPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: WarHelmet -> PrefixArmorPen.
 */

class WarHelmetPrefixArmorPenEngine {
  constructor(itemLevel = 64) {
...
module.exports = { WarHelmetPrefixArmorPenEngine };
