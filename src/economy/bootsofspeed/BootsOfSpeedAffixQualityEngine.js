/**
 * BootsOfSpeedAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> AffixQuality.
 */

class BootsOfSpeedAffixQualityEngine {
...
module.exports = { BootsOfSpeedAffixQualityEngine };
