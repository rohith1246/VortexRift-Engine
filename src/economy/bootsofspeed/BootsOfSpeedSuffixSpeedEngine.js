/**
 * BootsOfSpeedSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> SuffixSpeed.
 */

class BootsOfSpeedSuffixSpeedEngine {
...
module.exports = { BootsOfSpeedSuffixSpeedEngine };
