/**
 * BootsOfSpeedAffixLegendaryUniqueEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> AffixLegendaryUnique.
 */

class BootsOfSpeedAffixLegendaryUniqueEngine {
  constructor(itemLevel = 107) {
...
module.exports = { BootsOfSpeedAffixLegendaryUniqueEngine };
