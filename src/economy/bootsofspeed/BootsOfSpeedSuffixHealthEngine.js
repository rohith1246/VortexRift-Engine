/**
 * BootsOfSpeedSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> SuffixHealth.
 */

class BootsOfSpeedSuffixHealthEngine {
...
module.exports = { BootsOfSpeedSuffixHealthEngine };
