/**
 * BootsOfSpeedAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> AffixSockets.
 */

class BootsOfSpeedAffixSocketsEngine {
...
module.exports = { BootsOfSpeedAffixSocketsEngine };
