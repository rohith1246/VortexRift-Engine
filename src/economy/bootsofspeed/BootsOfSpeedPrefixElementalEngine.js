/**
 * BootsOfSpeedPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> PrefixElemental.
 */

class BootsOfSpeedPrefixElementalEngine {
...
module.exports = { BootsOfSpeedPrefixElementalEngine };
