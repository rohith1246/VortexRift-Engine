/**
 * BootsOfSpeedSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> SuffixStamina.
 */

class BootsOfSpeedSuffixStaminaEngine {
  constructor(itemLevel = 95) {
...
module.exports = { BootsOfSpeedSuffixStaminaEngine };
