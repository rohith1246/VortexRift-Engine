/**
 * BootsOfSpeedPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> PrefixDamage.
 */

class BootsOfSpeedPrefixDamageEngine {
...
module.exports = { BootsOfSpeedPrefixDamageEngine };
