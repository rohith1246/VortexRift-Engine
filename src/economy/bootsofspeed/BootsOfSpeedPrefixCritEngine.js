/**
 * BootsOfSpeedPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> PrefixCrit.
 */

class BootsOfSpeedPrefixCritEngine {
...
module.exports = { BootsOfSpeedPrefixCritEngine };
