/**
 * BootsOfSpeedSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> SuffixMana.
 */

class BootsOfSpeedSuffixManaEngine {
...
module.exports = { BootsOfSpeedSuffixManaEngine };
