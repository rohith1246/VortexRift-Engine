/**
 * BootsOfSpeedPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> PrefixArmorPen.
 */

class BootsOfSpeedPrefixArmorPenEngine {
  constructor(itemLevel = 74) {
...
module.exports = { BootsOfSpeedPrefixArmorPenEngine };
