/**
 * BootsOfSpeedPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: BootsOfSpeed -> PrefixLifeSteal.
 */

class BootsOfSpeedPrefixLifeStealEngine {
  constructor(itemLevel = 77) {
...
module.exports = { BootsOfSpeedPrefixLifeStealEngine };
