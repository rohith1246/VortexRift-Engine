/**
 * SpellStaffAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> AffixQuality.
 */

class SpellStaffAffixQualityEngine {
...
module.exports = { SpellStaffAffixQualityEngine };
