/**
 * SpellStaffPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> PrefixCrit.
 */

class SpellStaffPrefixCritEngine {
  constructor(itemLevel = 23) {
...
module.exports = { SpellStaffPrefixCritEngine };
