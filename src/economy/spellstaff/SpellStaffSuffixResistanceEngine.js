/**
 * SpellStaffSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixResistance.
 */

class SpellStaffSuffixResistanceEngine {
  constructor(itemLevel = 41) {
...
module.exports = { SpellStaffSuffixResistanceEngine };
