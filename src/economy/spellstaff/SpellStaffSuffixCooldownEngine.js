/**
 * SpellStaffSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixCooldown.
 */

class SpellStaffSuffixCooldownEngine {
...
module.exports = { SpellStaffSuffixCooldownEngine };
