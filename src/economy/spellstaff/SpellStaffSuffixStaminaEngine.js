/**
 * SpellStaffSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixStamina.
 */

class SpellStaffSuffixStaminaEngine {
...
module.exports = { SpellStaffSuffixStaminaEngine };
