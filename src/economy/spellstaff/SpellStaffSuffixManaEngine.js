/**
 * SpellStaffSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixMana.
 */

class SpellStaffSuffixManaEngine {
  constructor(itemLevel = 38) {
...
module.exports = { SpellStaffSuffixManaEngine };
