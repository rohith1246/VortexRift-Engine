/**
 * SpellStaffSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixSpeed.
 */

class SpellStaffSuffixSpeedEngine {
...
module.exports = { SpellStaffSuffixSpeedEngine };
