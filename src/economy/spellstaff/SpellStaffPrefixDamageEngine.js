/**
 * SpellStaffPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> PrefixDamage.
 */

class SpellStaffPrefixDamageEngine {
  constructor(itemLevel = 20) {
...
module.exports = { SpellStaffPrefixDamageEngine };
