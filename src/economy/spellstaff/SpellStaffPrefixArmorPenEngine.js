/**
 * SpellStaffPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> PrefixArmorPen.
 */

class SpellStaffPrefixArmorPenEngine {
  constructor(itemLevel = 29) {
...
module.exports = { SpellStaffPrefixArmorPenEngine };
