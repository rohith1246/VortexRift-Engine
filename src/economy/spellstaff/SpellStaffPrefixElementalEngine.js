/**
 * SpellStaffPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> PrefixElemental.
 */

class SpellStaffPrefixElementalEngine {
  constructor(itemLevel = 26) {
...
module.exports = { SpellStaffPrefixElementalEngine };
