/**
 * SpellStaffPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> PrefixLifeSteal.
 */

class SpellStaffPrefixLifeStealEngine {
  constructor(itemLevel = 32) {
    this.itemType = 'SpellStaff';
...
module.exports = { SpellStaffPrefixLifeStealEngine };
