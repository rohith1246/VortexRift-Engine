/**
 * SpellStaffSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> SuffixHealth.
 */

class SpellStaffSuffixHealthEngine {
...
module.exports = { SpellStaffSuffixHealthEngine };
