/**
 * SpellStaffAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: SpellStaff -> AffixSockets.
 */

class SpellStaffAffixSocketsEngine {
...
module.exports = { SpellStaffAffixSocketsEngine };
