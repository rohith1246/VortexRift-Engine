/**
 * GauntletsSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> SuffixHealth.
 */

class GauntletsSuffixHealthEngine {
...
module.exports = { GauntletsSuffixHealthEngine };
