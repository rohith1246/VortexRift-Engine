/**
 * GauntletsPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> PrefixLifeSteal.
 */

class GauntletsPrefixLifeStealEngine {
  constructor(itemLevel = 72) {
...
module.exports = { GauntletsPrefixLifeStealEngine };
