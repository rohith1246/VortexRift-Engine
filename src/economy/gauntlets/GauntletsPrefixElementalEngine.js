/**
 * GauntletsPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> PrefixElemental.
 */

class GauntletsPrefixElementalEngine {
...
module.exports = { GauntletsPrefixElementalEngine };
