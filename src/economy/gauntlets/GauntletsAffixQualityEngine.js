/**
 * GauntletsAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> AffixQuality.
 */

class GauntletsAffixQualityEngine {
...
module.exports = { GauntletsAffixQualityEngine };
