/**
 * GauntletsAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> AffixSockets.
 */

class GauntletsAffixSocketsEngine {
...
module.exports = { GauntletsAffixSocketsEngine };
