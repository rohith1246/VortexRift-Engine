/**
 * GauntletsPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> PrefixArmorPen.
 */

class GauntletsPrefixArmorPenEngine {
  constructor(itemLevel = 69) {
...
module.exports = { GauntletsPrefixArmorPenEngine };
