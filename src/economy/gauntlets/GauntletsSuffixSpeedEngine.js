/**
 * GauntletsSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> SuffixSpeed.
 */

class GauntletsSuffixSpeedEngine {
...
module.exports = { GauntletsSuffixSpeedEngine };
