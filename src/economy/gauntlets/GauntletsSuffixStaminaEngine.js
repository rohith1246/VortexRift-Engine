/**
 * GauntletsSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> SuffixStamina.
 */

class GauntletsSuffixStaminaEngine {
...
module.exports = { GauntletsSuffixStaminaEngine };
