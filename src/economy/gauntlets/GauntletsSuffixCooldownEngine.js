/**
 * GauntletsSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> SuffixCooldown.
 */

class GauntletsSuffixCooldownEngine {
...
module.exports = { GauntletsSuffixCooldownEngine };
