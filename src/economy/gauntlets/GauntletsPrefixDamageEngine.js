/**
 * GauntletsPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: Gauntlets -> PrefixDamage.
 */

class GauntletsPrefixDamageEngine {
...
module.exports = { GauntletsPrefixDamageEngine };
