/**
 * RelicTalismanPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> PrefixArmorPen.
 */

class RelicTalismanPrefixArmorPenEngine {
  constructor(itemLevel = 89) {
...
module.exports = { RelicTalismanPrefixArmorPenEngine };
