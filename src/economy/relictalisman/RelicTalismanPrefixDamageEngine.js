/**
 * RelicTalismanPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> PrefixDamage.
 */

class RelicTalismanPrefixDamageEngine {
  constructor(itemLevel = 80) {
...
module.exports = { RelicTalismanPrefixDamageEngine };
