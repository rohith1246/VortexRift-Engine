/**
 * RelicTalismanSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> SuffixMana.
 */

class RelicTalismanSuffixManaEngine {
  constructor(itemLevel = 98) {
...
module.exports = { RelicTalismanSuffixManaEngine };
