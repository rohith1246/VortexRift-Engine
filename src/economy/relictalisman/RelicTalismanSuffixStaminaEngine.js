/**
 * RelicTalismanSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> SuffixStamina.
 */

class RelicTalismanSuffixStaminaEngine {
  constructor(itemLevel = 110) {
...
module.exports = { RelicTalismanSuffixStaminaEngine };
