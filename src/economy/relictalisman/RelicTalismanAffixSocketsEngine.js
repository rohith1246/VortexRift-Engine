/**
 * RelicTalismanAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> AffixSockets.
 */

class RelicTalismanAffixSocketsEngine {
  constructor(itemLevel = 113) {
...
module.exports = { RelicTalismanAffixSocketsEngine };
