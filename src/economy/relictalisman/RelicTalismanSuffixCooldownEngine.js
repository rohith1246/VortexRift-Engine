/**
 * RelicTalismanSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> SuffixCooldown.
 */

class RelicTalismanSuffixCooldownEngine {
...
module.exports = { RelicTalismanSuffixCooldownEngine };
