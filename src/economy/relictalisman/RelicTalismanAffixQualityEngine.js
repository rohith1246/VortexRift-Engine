/**
 * RelicTalismanAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> AffixQuality.
 */

class RelicTalismanAffixQualityEngine {
  constructor(itemLevel = 116) {
...
module.exports = { RelicTalismanAffixQualityEngine };
