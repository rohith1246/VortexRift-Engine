/**
 * RelicTalismanPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: RelicTalisman -> PrefixCrit.
 */

class RelicTalismanPrefixCritEngine {
  constructor(itemLevel = 83) {
...
module.exports = { RelicTalismanPrefixCritEngine };
