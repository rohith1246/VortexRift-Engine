/**
 * RecurveBowSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixSpeed.
 */

class RecurveBowSuffixSpeedEngine {
...
module.exports = { RecurveBowSuffixSpeedEngine };
