/**
 * RecurveBowSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixResistance.
 */

class RecurveBowSuffixResistanceEngine {
...
module.exports = { RecurveBowSuffixResistanceEngine };
