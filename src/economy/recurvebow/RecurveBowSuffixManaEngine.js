/**
 * RecurveBowSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixMana.
 */

class RecurveBowSuffixManaEngine {
...
module.exports = { RecurveBowSuffixManaEngine };
