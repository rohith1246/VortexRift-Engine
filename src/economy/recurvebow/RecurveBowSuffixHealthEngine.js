/**
 * RecurveBowSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixHealth.
 */

class RecurveBowSuffixHealthEngine {
...
module.exports = { RecurveBowSuffixHealthEngine };
