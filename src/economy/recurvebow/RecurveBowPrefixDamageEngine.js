/**
 * RecurveBowPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> PrefixDamage.
 */

class RecurveBowPrefixDamageEngine {
  constructor(itemLevel = 25) {
...
module.exports = { RecurveBowPrefixDamageEngine };
