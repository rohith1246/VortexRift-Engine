/**
 * RecurveBowSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixStamina.
 */

class RecurveBowSuffixStaminaEngine {
...
module.exports = { RecurveBowSuffixStaminaEngine };
