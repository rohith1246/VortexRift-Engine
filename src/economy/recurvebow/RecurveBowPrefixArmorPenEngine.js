/**
 * RecurveBowPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> PrefixArmorPen.
 */

class RecurveBowPrefixArmorPenEngine {
  constructor(itemLevel = 34) {
...
module.exports = { RecurveBowPrefixArmorPenEngine };
