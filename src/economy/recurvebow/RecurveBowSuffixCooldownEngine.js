/**
 * RecurveBowSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> SuffixCooldown.
 */

class RecurveBowSuffixCooldownEngine {
...
module.exports = { RecurveBowSuffixCooldownEngine };
