/**
 * RecurveBowAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> AffixSockets.
 */

class RecurveBowAffixSocketsEngine {
...
module.exports = { RecurveBowAffixSocketsEngine };
