/**
 * RecurveBowPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> PrefixLifeSteal.
 */

class RecurveBowPrefixLifeStealEngine {
  constructor(itemLevel = 37) {
...
module.exports = { RecurveBowPrefixLifeStealEngine };
