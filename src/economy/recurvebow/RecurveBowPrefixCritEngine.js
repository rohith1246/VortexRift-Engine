/**
 * RecurveBowPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> PrefixCrit.
 */

class RecurveBowPrefixCritEngine {
...
module.exports = { RecurveBowPrefixCritEngine };
