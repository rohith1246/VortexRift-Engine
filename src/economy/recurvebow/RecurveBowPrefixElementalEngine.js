/**
 * RecurveBowPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: RecurveBow -> PrefixElemental.
 */

class RecurveBowPrefixElementalEngine {
...
module.exports = { RecurveBowPrefixElementalEngine };
