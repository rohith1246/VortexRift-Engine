/**
 * LeatherArmorPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> PrefixArmorPen.
 */

class LeatherArmorPrefixArmorPenEngine {
  constructor(itemLevel = 54) {
    this.itemType = 'LeatherArmor';
...
module.exports = { LeatherArmorPrefixArmorPenEngine };
