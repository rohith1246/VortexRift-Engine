/**
 * LeatherArmorSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> SuffixCooldown.
 */

class LeatherArmorSuffixCooldownEngine {
...
module.exports = { LeatherArmorSuffixCooldownEngine };
