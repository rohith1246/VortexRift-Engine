/**
 * LeatherArmorPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> PrefixElemental.
 */

class LeatherArmorPrefixElementalEngine {
...
module.exports = { LeatherArmorPrefixElementalEngine };
