/**
 * LeatherArmorPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> PrefixCrit.
 */

class LeatherArmorPrefixCritEngine {
  constructor(itemLevel = 48) {
...
module.exports = { LeatherArmorPrefixCritEngine };
