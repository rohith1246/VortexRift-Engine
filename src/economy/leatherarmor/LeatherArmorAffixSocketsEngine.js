/**
 * LeatherArmorAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> AffixSockets.
 */

class LeatherArmorAffixSocketsEngine {
...
module.exports = { LeatherArmorAffixSocketsEngine };
