/**
 * LeatherArmorSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> SuffixMana.
 */

class LeatherArmorSuffixManaEngine {
  constructor(itemLevel = 63) {
...
module.exports = { LeatherArmorSuffixManaEngine };
