/**
 * LeatherArmorSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> SuffixResistance.
 */

class LeatherArmorSuffixResistanceEngine {
  constructor(itemLevel = 66) {
...
module.exports = { LeatherArmorSuffixResistanceEngine };
