/**
 * LeatherArmorPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> PrefixLifeSteal.
 */

class LeatherArmorPrefixLifeStealEngine {
...
module.exports = { LeatherArmorPrefixLifeStealEngine };
