/**
 * LeatherArmorAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> AffixQuality.
 */

class LeatherArmorAffixQualityEngine {
...
module.exports = { LeatherArmorAffixQualityEngine };
