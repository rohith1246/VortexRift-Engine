/**
 * LeatherArmorSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> SuffixHealth.
 */

class LeatherArmorSuffixHealthEngine {
...
module.exports = { LeatherArmorSuffixHealthEngine };
