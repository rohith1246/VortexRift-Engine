/**
 * LeatherArmorPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> PrefixDamage.
 */

class LeatherArmorPrefixDamageEngine {
...
module.exports = { LeatherArmorPrefixDamageEngine };
