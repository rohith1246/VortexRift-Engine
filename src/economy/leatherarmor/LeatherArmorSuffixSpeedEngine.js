/**
 * LeatherArmorSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: LeatherArmor -> SuffixSpeed.
 */

class LeatherArmorSuffixSpeedEngine {
...
module.exports = { LeatherArmorSuffixSpeedEngine };
