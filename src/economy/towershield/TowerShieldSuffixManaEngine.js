/**
 * TowerShieldSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> SuffixMana.
 */

class TowerShieldSuffixManaEngine {
...
module.exports = { TowerShieldSuffixManaEngine };
