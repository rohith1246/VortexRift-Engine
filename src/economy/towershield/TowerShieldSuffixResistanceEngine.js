/**
 * TowerShieldSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> SuffixResistance.
 */

class TowerShieldSuffixResistanceEngine {
...
module.exports = { TowerShieldSuffixResistanceEngine };
