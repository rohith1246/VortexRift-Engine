/**
 * TowerShieldSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> SuffixSpeed.
 */

class TowerShieldSuffixSpeedEngine {
...
module.exports = { TowerShieldSuffixSpeedEngine };
