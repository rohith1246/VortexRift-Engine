/**
 * TowerShieldSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> SuffixCooldown.
 */

class TowerShieldSuffixCooldownEngine {
...
module.exports = { TowerShieldSuffixCooldownEngine };
