/**
 * TowerShieldSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> SuffixHealth.
 */

class TowerShieldSuffixHealthEngine {
...
module.exports = { TowerShieldSuffixHealthEngine };
