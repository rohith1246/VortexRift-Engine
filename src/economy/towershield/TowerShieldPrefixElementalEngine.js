/**
 * TowerShieldPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> PrefixElemental.
 */

class TowerShieldPrefixElementalEngine {
...
module.exports = { TowerShieldPrefixElementalEngine };
