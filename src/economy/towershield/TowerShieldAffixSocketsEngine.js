/**
 * TowerShieldAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> AffixSockets.
 */

class TowerShieldAffixSocketsEngine {
...
module.exports = { TowerShieldAffixSocketsEngine };
