/**
 * TowerShieldPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> PrefixCrit.
 */

class TowerShieldPrefixCritEngine {
...
module.exports = { TowerShieldPrefixCritEngine };
