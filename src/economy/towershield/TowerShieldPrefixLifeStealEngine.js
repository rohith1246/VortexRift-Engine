/**
 * TowerShieldPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> PrefixLifeSteal.
 */

class TowerShieldPrefixLifeStealEngine {
  constructor(itemLevel = 47) {
...
module.exports = { TowerShieldPrefixLifeStealEngine };
