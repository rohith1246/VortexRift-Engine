/**
 * TowerShieldPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> PrefixDamage.
 */

class TowerShieldPrefixDamageEngine {
  constructor(itemLevel = 35) {
...
module.exports = { TowerShieldPrefixDamageEngine };
