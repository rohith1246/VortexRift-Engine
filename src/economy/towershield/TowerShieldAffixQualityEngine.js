/**
 * TowerShieldAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> AffixQuality.
 */

class TowerShieldAffixQualityEngine {
...
module.exports = { TowerShieldAffixQualityEngine };
