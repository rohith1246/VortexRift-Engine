/**
 * TowerShieldPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: TowerShield -> PrefixArmorPen.
 */

class TowerShieldPrefixArmorPenEngine {
  constructor(itemLevel = 44) {
...
module.exports = { TowerShieldPrefixArmorPenEngine };
