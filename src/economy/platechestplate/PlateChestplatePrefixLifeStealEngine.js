/**
 * PlateChestplatePrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> PrefixLifeSteal.
 */

class PlateChestplatePrefixLifeStealEngine {
  constructor(itemLevel = 52) {
    this.itemType = 'PlateChestplate';
    this.affixGroup = 'PrefixLifeSteal';
  ...
  rollAffix() {
    ...
    return {
      affixName: 'PrefixLifeSteal_T' + this.baseTier,
...
module.exports = { PlateChestplatePrefixLifeStealEngine };
