/**
 * PlateChestplateSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> SuffixCooldown.
 */

class PlateChestplateSuffixCooldownEngine {
...
module.exports = { PlateChestplateSuffixCooldownEngine };
