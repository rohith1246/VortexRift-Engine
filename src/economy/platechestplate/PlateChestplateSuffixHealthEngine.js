/**
 * PlateChestplateSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> SuffixHealth.
 */

class PlateChestplateSuffixHealthEngine {
...
module.exports = { PlateChestplateSuffixHealthEngine };
