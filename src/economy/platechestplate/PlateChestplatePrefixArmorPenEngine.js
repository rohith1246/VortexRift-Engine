/**
 * PlateChestplatePrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> PrefixArmorPen.
 */

class PlateChestplatePrefixArmorPenEngine {
  constructor(itemLevel = 49) {
    this.itemType = 'PlateChestplate';
    this.affixGroup = 'PrefixArmorPen';
  ...
  rollAffix() {
    ...
    return {
      affixName: 'PrefixArmorPen_T' + this.baseTier,
...
module.exports = { PlateChestplatePrefixArmorPenEngine };
