/**
 * PlateChestplatePrefixCritEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> PrefixCrit.
 */

class PlateChestplatePrefixCritEngine {
...
module.exports = { PlateChestplatePrefixCritEngine };
