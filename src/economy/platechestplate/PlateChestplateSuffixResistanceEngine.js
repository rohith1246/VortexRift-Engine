/**
 * PlateChestplateSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> SuffixResistance.
 */

class PlateChestplateSuffixResistanceEngine {
...
module.exports = { PlateChestplateSuffixResistanceEngine };
