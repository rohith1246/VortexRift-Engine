/**
 * PlateChestplateSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> SuffixMana.
 */

class PlateChestplateSuffixManaEngine {
  constructor(itemLevel = 58) {
    this.itemType = 'PlateChestplate';
    this.affixGroup = 'SuffixMana';
  ...
  rollAffix() {
    ...
    return {
      affixName: 'SuffixMana_T' + this.baseTier,
...
module.exports = { PlateChestplateSuffixManaEngine };
