/**
 * PlateChestplatePrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: PlateChestplate -> PrefixElemental.
 */

class PlateChestplatePrefixElementalEngine {
  constructor(itemLevel = 46) {
...
module.exports = { PlateChestplatePrefixElementalEngine };
