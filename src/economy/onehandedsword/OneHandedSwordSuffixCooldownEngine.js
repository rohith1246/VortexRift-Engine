/**
 * OneHandedSwordSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> SuffixCooldown.
 */

class OneHandedSwordSuffixCooldownEngine {
...
module.exports = { OneHandedSwordSuffixCooldownEngine };
