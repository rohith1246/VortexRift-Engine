/**
 * OneHandedSwordPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> PrefixLifeSteal.
 */

class OneHandedSwordPrefixLifeStealEngine {
  constructor(itemLevel = 22) {
...
module.exports = { OneHandedSwordPrefixLifeStealEngine };
