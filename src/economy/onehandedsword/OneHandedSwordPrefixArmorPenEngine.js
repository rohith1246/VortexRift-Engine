/**
 * OneHandedSwordPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> PrefixArmorPen.
 */

class OneHandedSwordPrefixArmorPenEngine {
  constructor(itemLevel = 19) {
...
module.exports = { OneHandedSwordPrefixArmorPenEngine };
