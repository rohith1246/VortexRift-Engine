/**
 * OneHandedSwordSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> SuffixHealth.
 */

class OneHandedSwordSuffixHealthEngine {
...
module.exports = { OneHandedSwordSuffixHealthEngine };
