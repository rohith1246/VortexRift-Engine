/**
 * OneHandedSwordPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> PrefixElemental.
 */

class OneHandedSwordPrefixElementalEngine {
  constructor(itemLevel = 16) {
...
module.exports = { OneHandedSwordPrefixElementalEngine };
