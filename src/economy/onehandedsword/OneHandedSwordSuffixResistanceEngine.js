/**
 * OneHandedSwordSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> SuffixResistance.
 */

class OneHandedSwordSuffixResistanceEngine {
  constructor(itemLevel = 31) {
...
module.exports = { OneHandedSwordSuffixResistanceEngine };
