/**
 * OneHandedSwordPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> PrefixCrit.
 */

class OneHandedSwordPrefixCritEngine {
  constructor(itemLevel = 13) {
...
module.exports = { OneHandedSwordPrefixCritEngine };
