/**
 * OneHandedSwordSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: OneHandedSword -> SuffixMana.
 */

class OneHandedSwordSuffixManaEngine {
  constructor(itemLevel = 28) {
...
module.exports = { OneHandedSwordSuffixManaEngine };
