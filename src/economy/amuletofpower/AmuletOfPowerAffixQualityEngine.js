/**
 * AmuletOfPowerAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> AffixQuality.
 */

class AmuletOfPowerAffixQualityEngine {
  constructor(itemLevel = 106) {
...
module.exports = { AmuletOfPowerAffixQualityEngine };
