/**
 * AmuletOfPowerSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> SuffixStamina.
 */

class AmuletOfPowerSuffixStaminaEngine {
  constructor(itemLevel = 100) {
...
module.exports = { AmuletOfPowerSuffixStaminaEngine };
