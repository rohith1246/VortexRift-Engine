/**
 * AmuletOfPowerPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> PrefixLifeSteal.
 */

class AmuletOfPowerPrefixLifeStealEngine {
  constructor(itemLevel = 82) {
...
module.exports = { AmuletOfPowerPrefixLifeStealEngine };
