/**
 * AmuletOfPowerSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> SuffixCooldown.
 */

class AmuletOfPowerSuffixCooldownEngine {
...
module.exports = { AmuletOfPowerSuffixCooldownEngine };
