/**
 * AmuletOfPowerPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> PrefixDamage.
 */

class AmuletOfPowerPrefixDamageEngine {
  constructor(itemLevel = 70) {
...
module.exports = { AmuletOfPowerPrefixDamageEngine };
