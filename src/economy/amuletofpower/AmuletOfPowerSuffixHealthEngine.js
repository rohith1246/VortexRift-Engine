/**
 * AmuletOfPowerSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> SuffixHealth.
 */

class AmuletOfPowerSuffixHealthEngine {
  constructor(itemLevel = 85) {
...
module.exports = { AmuletOfPowerSuffixHealthEngine };
