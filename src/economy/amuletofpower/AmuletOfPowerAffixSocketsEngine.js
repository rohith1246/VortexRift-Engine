/**
 * AmuletOfPowerAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> AffixSockets.
 */

class AmuletOfPowerAffixSocketsEngine {
  constructor(itemLevel = 103) {
...
module.exports = { AmuletOfPowerAffixSocketsEngine };
