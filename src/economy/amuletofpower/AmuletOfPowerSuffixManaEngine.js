/**
 * AmuletOfPowerSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> SuffixMana.
 */

class AmuletOfPowerSuffixManaEngine {
  constructor(itemLevel = 88) {
...
module.exports = { AmuletOfPowerSuffixManaEngine };
