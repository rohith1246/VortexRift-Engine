/**
 * AmuletOfPowerPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: AmuletOfPower -> PrefixCrit.
 */

class AmuletOfPowerPrefixCritEngine {
  constructor(itemLevel = 73) {
...
module.exports = { AmuletOfPowerPrefixCritEngine };
