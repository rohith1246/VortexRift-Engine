/**
 * TwoHandedAxePrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> PrefixElemental.
 */

class TwoHandedAxePrefixElementalEngine {
  constructor(itemLevel = 21) {
...
module.exports = { TwoHandedAxePrefixElementalEngine };
