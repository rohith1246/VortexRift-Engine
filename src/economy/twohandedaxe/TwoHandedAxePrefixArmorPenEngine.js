/**
 * TwoHandedAxePrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> PrefixArmorPen.
 */

class TwoHandedAxePrefixArmorPenEngine {
  constructor(itemLevel = 24) {
...
module.exports = { TwoHandedAxePrefixArmorPenEngine };
