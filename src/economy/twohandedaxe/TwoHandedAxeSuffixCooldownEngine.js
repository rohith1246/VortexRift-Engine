/**
 * TwoHandedAxeSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixCooldown.
 */

class TwoHandedAxeSuffixCooldownEngine {
...
module.exports = { TwoHandedAxeSuffixCooldownEngine };
