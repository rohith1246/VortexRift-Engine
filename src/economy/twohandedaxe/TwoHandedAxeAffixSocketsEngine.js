/**
 * TwoHandedAxeAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> AffixSockets.
 */

class TwoHandedAxeAffixSocketsEngine {
...
module.exports = { TwoHandedAxeAffixSocketsEngine };
