/**
 * TwoHandedAxePrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> PrefixDamage.
 */

class TwoHandedAxePrefixDamageEngine {
  constructor(itemLevel = 15) {
...
module.exports = { TwoHandedAxePrefixDamageEngine };
