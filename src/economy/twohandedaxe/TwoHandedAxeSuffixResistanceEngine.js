/**
 * TwoHandedAxeSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixResistance.
 */

class TwoHandedAxeSuffixResistanceEngine {
  constructor(itemLevel = 36) {
...
module.exports = { TwoHandedAxeSuffixResistanceEngine };
