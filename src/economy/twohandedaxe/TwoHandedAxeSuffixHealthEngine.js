/**
 * TwoHandedAxeSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixHealth.
 */

class TwoHandedAxeSuffixHealthEngine {
...
module.exports = { TwoHandedAxeSuffixHealthEngine };
