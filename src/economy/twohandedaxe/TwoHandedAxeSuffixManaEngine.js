/**
 * TwoHandedAxeSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixMana.
 */

class TwoHandedAxeSuffixManaEngine {
  constructor(itemLevel = 33) {
...
module.exports = { TwoHandedAxeSuffixManaEngine };
