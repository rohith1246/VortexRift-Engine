/**
 * TwoHandedAxePrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> PrefixLifeSteal.
 */

class TwoHandedAxePrefixLifeStealEngine {
  constructor(itemLevel = 27) {
    this.itemType = 'TwoHandedAxe';
...
module.exports = { TwoHandedAxePrefixLifeStealEngine };
