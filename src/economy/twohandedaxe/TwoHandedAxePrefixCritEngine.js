/**
 * TwoHandedAxePrefixCritEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> PrefixCrit.
 */

class TwoHandedAxePrefixCritEngine {
  constructor(itemLevel = 18) {
    this.itemType = 'TwoHandedAxe';
    this.affixGroup = 'PrefixCrit';
  ...
  rollAffix() {
    ...
    return {
      affixName: 'PrefixCrit_T' + this.baseTier,
...
module.exports = { TwoHandedAxePrefixCritEngine };
