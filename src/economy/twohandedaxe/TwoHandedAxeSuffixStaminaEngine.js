/**
 * TwoHandedAxeSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixStamina.
 */

class TwoHandedAxeSuffixStaminaEngine {
...
module.exports = { TwoHandedAxeSuffixStaminaEngine };
