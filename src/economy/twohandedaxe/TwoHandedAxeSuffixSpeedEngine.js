/**
 * TwoHandedAxeSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> SuffixSpeed.
 */

class TwoHandedAxeSuffixSpeedEngine {
...
module.exports = { TwoHandedAxeSuffixSpeedEngine };
