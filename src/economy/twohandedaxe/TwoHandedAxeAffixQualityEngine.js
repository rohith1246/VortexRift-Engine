/**
 * TwoHandedAxeAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: TwoHandedAxe -> AffixQuality.
 */

class TwoHandedAxeAffixQualityEngine {
...
module.exports = { TwoHandedAxeAffixQualityEngine };
