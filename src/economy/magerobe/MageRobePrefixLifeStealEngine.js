/**
 * MageRobePrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> PrefixLifeSteal.
 */

class MageRobePrefixLifeStealEngine {
  constructor(itemLevel = 62) {
    this.itemType = 'MageRobe';
...
module.exports = { MageRobePrefixLifeStealEngine };
