/**
 * MageRobeAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> AffixQuality.
 */

class MageRobeAffixQualityEngine {
...
module.exports = { MageRobeAffixQualityEngine };
