/**
 * MageRobeSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixSpeed.
 */

class MageRobeSuffixSpeedEngine {
...
module.exports = { MageRobeSuffixSpeedEngine };
