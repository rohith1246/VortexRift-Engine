/**
 * MageRobeSuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixHealth.
 */

class MageRobeSuffixHealthEngine {
...
module.exports = { MageRobeSuffixHealthEngine };
