/**
 * MageRobeSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixMana.
 */

class MageRobeSuffixManaEngine {
  constructor(itemLevel = 68) {
...
module.exports = { MageRobeSuffixManaEngine };
