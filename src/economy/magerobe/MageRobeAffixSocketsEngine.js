/**
 * MageRobeAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> AffixSockets.
 */

class MageRobeAffixSocketsEngine {
...
module.exports = { MageRobeAffixSocketsEngine };
