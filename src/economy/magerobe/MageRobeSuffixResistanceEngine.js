/**
 * MageRobeSuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixResistance.
 */

class MageRobeSuffixResistanceEngine {
  constructor(itemLevel = 71) {
...
module.exports = { MageRobeSuffixResistanceEngine };
