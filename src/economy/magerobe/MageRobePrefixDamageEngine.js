/**
 * MageRobePrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> PrefixDamage.
 */

class MageRobePrefixDamageEngine {
  constructor(itemLevel = 50) {
...
module.exports = { MageRobePrefixDamageEngine };
