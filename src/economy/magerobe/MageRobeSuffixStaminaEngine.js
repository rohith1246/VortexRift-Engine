/**
 * MageRobeSuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixStamina.
 */

class MageRobeSuffixStaminaEngine {
...
module.exports = { MageRobeSuffixStaminaEngine };
