/**
 * MageRobePrefixCritEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> PrefixCrit.
 */

class MageRobePrefixCritEngine {
  constructor(itemLevel = 53) {
...
module.exports = { MageRobePrefixCritEngine };
