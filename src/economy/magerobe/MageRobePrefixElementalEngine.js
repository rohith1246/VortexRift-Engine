/**
 * MageRobePrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> PrefixElemental.
 */

class MageRobePrefixElementalEngine {
  constructor(itemLevel = 56) {
...
module.exports = { MageRobePrefixElementalEngine };
