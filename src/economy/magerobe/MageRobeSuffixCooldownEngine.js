/**
 * MageRobeSuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: MageRobe -> SuffixCooldown.
 */

class MageRobeSuffixCooldownEngine {
...
module.exports = { MageRobeSuffixCooldownEngine };
