/**
 * RingOfSorceryPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> PrefixDamage.
 */

class RingOfSorceryPrefixDamageEngine {
  constructor(itemLevel = 75) {
...
module.exports = { RingOfSorceryPrefixDamageEngine };
