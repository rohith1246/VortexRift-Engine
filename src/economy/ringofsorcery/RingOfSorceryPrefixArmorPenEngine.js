/**
 * RingOfSorceryPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> PrefixArmorPen.
 */

class RingOfSorceryPrefixArmorPenEngine {
  constructor(itemLevel = 84) {
...
module.exports = { RingOfSorceryPrefixArmorPenEngine };
