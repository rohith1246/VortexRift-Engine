/**
 * RingOfSorceryPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> PrefixLifeSteal.
 */

class RingOfSorceryPrefixLifeStealEngine {
  constructor(itemLevel = 87) {
...
module.exports = { RingOfSorceryPrefixLifeStealEngine };
