/**
 * RingOfSorcerySuffixManaEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixMana.
 */

class RingOfSorcerySuffixManaEngine {
  constructor(itemLevel = 93) {
...
module.exports = { RingOfSorcerySuffixManaEngine };
