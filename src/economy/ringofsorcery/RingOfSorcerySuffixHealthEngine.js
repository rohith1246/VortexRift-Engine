/**
 * RingOfSorcerySuffixHealthEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixHealth.
 */

class RingOfSorcerySuffixHealthEngine {
  constructor(itemLevel = 90) {
...
module.exports = { RingOfSorcerySuffixHealthEngine };
