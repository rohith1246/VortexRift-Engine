/**
 * RingOfSorceryAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> AffixSockets.
 */

class RingOfSorceryAffixSocketsEngine {
  constructor(itemLevel = 108) {
...
module.exports = { RingOfSorceryAffixSocketsEngine };
