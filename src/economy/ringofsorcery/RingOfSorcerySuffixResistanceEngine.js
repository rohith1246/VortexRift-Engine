/**
 * RingOfSorcerySuffixResistanceEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixResistance.
 */

class RingOfSorcerySuffixResistanceEngine {
  constructor(itemLevel = 96) {
...
module.exports = { RingOfSorcerySuffixResistanceEngine };
