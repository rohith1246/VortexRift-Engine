/**
 * RingOfSorceryPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> PrefixElemental.
 */

class RingOfSorceryPrefixElementalEngine {
...
module.exports = { RingOfSorceryPrefixElementalEngine };
