/**
 * RingOfSorcerySuffixStaminaEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixStamina.
 */

class RingOfSorcerySuffixStaminaEngine {
  constructor(itemLevel = 105) {
...
module.exports = { RingOfSorcerySuffixStaminaEngine };
