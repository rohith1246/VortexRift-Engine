/**
 * RingOfSorcerySuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixSpeed.
 */

class RingOfSorcerySuffixSpeedEngine {
...
module.exports = { RingOfSorcerySuffixSpeedEngine };
