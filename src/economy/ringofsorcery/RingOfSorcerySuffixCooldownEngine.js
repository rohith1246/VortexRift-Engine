/**
 * RingOfSorcerySuffixCooldownEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> SuffixCooldown.
 */

class RingOfSorcerySuffixCooldownEngine {
...
module.exports = { RingOfSorcerySuffixCooldownEngine };
