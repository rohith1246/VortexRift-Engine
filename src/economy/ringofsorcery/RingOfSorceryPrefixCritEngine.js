/**
 * RingOfSorceryPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: RingOfSorcery -> PrefixCrit.
 */

class RingOfSorceryPrefixCritEngine {
  constructor(itemLevel = 78) {
...
module.exports = { RingOfSorceryPrefixCritEngine };
