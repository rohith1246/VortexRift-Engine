/**
 * DaggerPairSuffixManaEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> SuffixMana.
 */

class DaggerPairSuffixManaEngine {
...
module.exports = { DaggerPairSuffixManaEngine };
