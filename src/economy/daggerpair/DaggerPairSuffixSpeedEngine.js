/**
 * DaggerPairSuffixSpeedEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> SuffixSpeed.
 */

class DaggerPairSuffixSpeedEngine {
...
module.exports = { DaggerPairSuffixSpeedEngine };
