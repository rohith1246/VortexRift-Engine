/**
 * DaggerPairPrefixCritEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> PrefixCrit.
 */

class DaggerPairPrefixCritEngine {
...
module.exports = { DaggerPairPrefixCritEngine };
