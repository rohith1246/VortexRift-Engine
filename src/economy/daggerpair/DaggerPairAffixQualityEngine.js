/**
 * DaggerPairAffixQualityEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> AffixQuality.
 */

class DaggerPairAffixQualityEngine {
...
module.exports = { DaggerPairAffixQualityEngine };
