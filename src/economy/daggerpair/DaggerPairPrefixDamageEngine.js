/**
 * DaggerPairPrefixDamageEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> PrefixDamage.
 */

class DaggerPairPrefixDamageEngine {
  constructor(itemLevel = 30) {
...
module.exports = { DaggerPairPrefixDamageEngine };
