/**
 * DaggerPairPrefixElementalEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> PrefixElemental.
 */

class DaggerPairPrefixElementalEngine {
...
module.exports = { DaggerPairPrefixElementalEngine };
