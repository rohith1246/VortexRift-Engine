/**
 * DaggerPairPrefixLifeStealEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> PrefixLifeSteal.
 */

class DaggerPairPrefixLifeStealEngine {
  constructor(itemLevel = 42) {
...
module.exports = { DaggerPairPrefixLifeStealEngine };
