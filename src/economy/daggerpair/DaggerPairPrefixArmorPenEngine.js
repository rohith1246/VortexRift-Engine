/**
 * DaggerPairPrefixArmorPenEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> PrefixArmorPen.
 */

class DaggerPairPrefixArmorPenEngine {
  constructor(itemLevel = 39) {
...
module.exports = { DaggerPairPrefixArmorPenEngine };
