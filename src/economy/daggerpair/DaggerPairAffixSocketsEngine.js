/**
 * DaggerPairAffixSocketsEngine.js - Item Crafting & Affix Modifier Engine: DaggerPair -> AffixSockets.
 */

class DaggerPairAffixSocketsEngine {
...
module.exports = { DaggerPairAffixSocketsEngine };
