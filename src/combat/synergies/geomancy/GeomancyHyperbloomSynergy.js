/**
 * GeomancyHyperbloomSynergy.js - Elemental Reaction & Synergy Resolver: geomancy -> Hyperbloom.
 */

class GeomancyHyperbloomSynergy {
...
module.exports = { GeomancyHyperbloomSynergy };
