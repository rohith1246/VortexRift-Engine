/**
 * GeomancyElectroChargeSynergy.js - Elemental Reaction & Synergy Resolver: geomancy -> ElectroCharge.
 */

class GeomancyElectroChargeSynergy {
...
module.exports = { GeomancyElectroChargeSynergy };
