/**
 * BiomancyCrystallizeSynergy.js - Elemental Reaction & Synergy Resolver: biomancy -> Crystallize.
 */

class BiomancyCrystallizeSynergy {
...
module.exports = { BiomancyCrystallizeSynergy };
