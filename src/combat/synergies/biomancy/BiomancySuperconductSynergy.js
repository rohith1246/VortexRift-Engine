/**
 * BiomancySuperconductSynergy.js - Elemental Reaction & Synergy Resolver: biomancy -> Superconduct.
 */

class BiomancySuperconductSynergy {
...
module.exports = { BiomancySuperconductSynergy };
