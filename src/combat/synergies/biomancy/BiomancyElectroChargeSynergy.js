/**
 * BiomancyElectroChargeSynergy.js - Elemental Reaction & Synergy Resolver: biomancy -> ElectroCharge.
 */

class BiomancyElectroChargeSynergy {
...
module.exports = { BiomancyElectroChargeSynergy };
