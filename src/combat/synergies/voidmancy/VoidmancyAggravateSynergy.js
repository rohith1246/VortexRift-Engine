/**
 * VoidmancyAggravateSynergy.js - Elemental Reaction & Synergy Resolver: voidmancy -> Aggravate.
 */

class VoidmancyAggravateSynergy {
...
module.exports = { VoidmancyAggravateSynergy };
