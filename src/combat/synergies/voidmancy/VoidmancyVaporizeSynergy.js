/**
 * VoidmancyVaporizeSynergy.js - Elemental Reaction & Synergy Resolver: voidmancy -> Vaporize.
 */

class VoidmancyVaporizeSynergy {
...
module.exports = { VoidmancyVaporizeSynergy };
