/**
 * PyromancyHyperbloomSynergy.js - Elemental Reaction & Synergy Resolver: pyromancy -> Hyperbloom.
 */

class PyromancyHyperbloomSynergy {
...
module.exports = { PyromancyHyperbloomSynergy };
