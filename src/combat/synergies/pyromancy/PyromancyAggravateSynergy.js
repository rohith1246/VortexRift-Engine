/**
 * PyromancyAggravateSynergy.js - Elemental Reaction & Synergy Resolver: pyromancy -> Aggravate.
 */

class PyromancyAggravateSynergy {
...
module.exports = { PyromancyAggravateSynergy };
