/**
 * NecromancyCrystallizeSynergy.js - Elemental Reaction & Synergy Resolver: necromancy -> Crystallize.
 */

class NecromancyCrystallizeSynergy {
...
module.exports = { NecromancyCrystallizeSynergy };
