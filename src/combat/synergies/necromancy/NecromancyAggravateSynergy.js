/**
 * NecromancyAggravateSynergy.js - Elemental Reaction & Synergy Resolver: necromancy -> Aggravate.
 */

class NecromancyAggravateSynergy {
...
module.exports = { NecromancyAggravateSynergy };
