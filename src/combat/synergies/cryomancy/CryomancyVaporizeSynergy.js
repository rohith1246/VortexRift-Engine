/**
 * CryomancyVaporizeSynergy.js - Elemental Reaction & Synergy Resolver: cryomancy -> Vaporize.
 */

class CryomancyVaporizeSynergy {
...
module.exports = { CryomancyVaporizeSynergy };
