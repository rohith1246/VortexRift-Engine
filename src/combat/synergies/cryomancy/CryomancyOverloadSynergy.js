/**
 * CryomancyOverloadSynergy.js - Elemental Reaction & Synergy Resolver: cryomancy -> Overload.
 */

class CryomancyOverloadSynergy {
...
module.exports = { CryomancyOverloadSynergy };
