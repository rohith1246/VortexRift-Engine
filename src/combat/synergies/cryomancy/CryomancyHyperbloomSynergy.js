/**
 * CryomancyHyperbloomSynergy.js - Elemental Reaction & Synergy Resolver: cryomancy -> Hyperbloom.
 */

class CryomancyHyperbloomSynergy {
...
module.exports = { CryomancyHyperbloomSynergy };
