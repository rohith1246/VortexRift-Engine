/**
 * ChronomancyBurgeonSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Burgeon.
 */

class ChronomancyBurgeonSynergy {
...
module.exports = { ChronomancyBurgeonSynergy };
