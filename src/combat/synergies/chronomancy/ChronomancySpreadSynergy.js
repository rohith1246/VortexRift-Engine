/**
 * ChronomancySpreadSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Spread.
 */

class ChronomancySpreadSynergy {
...
module.exports = { ChronomancySpreadSynergy };
