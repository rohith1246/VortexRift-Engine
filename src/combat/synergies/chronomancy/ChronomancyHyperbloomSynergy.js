/**
 * ChronomancyHyperbloomSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Hyperbloom.
 */

class ChronomancyHyperbloomSynergy {
...
module.exports = { ChronomancyHyperbloomSynergy };
