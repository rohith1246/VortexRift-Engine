/**
 * ChronomancyAggravateSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Aggravate.
 */

class ChronomancyAggravateSynergy {
...
module.exports = { ChronomancyAggravateSynergy };
