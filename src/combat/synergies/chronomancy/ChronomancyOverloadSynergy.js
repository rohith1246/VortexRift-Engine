/**
 * ChronomancyOverloadSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Overload.
 */

class ChronomancyOverloadSynergy {
...
module.exports = { ChronomancyOverloadSynergy };
