/**
 * ChronomancyQuickenSynergy.js - Elemental Reaction & Synergy Resolver: chronomancy -> Quicken.
 */

class ChronomancyQuickenSynergy {
...
module.exports = { ChronomancyQuickenSynergy };
