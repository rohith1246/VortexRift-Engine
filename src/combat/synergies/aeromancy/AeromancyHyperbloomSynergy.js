/**
 * AeromancyHyperbloomSynergy.js - Elemental Reaction & Synergy Resolver: aeromancy -> Hyperbloom.
 */

class AeromancyHyperbloomSynergy {
...
module.exports = { AeromancyHyperbloomSynergy };
