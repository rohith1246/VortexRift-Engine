/**
 * AeromancyCrystallizeSynergy.js - Elemental Reaction & Synergy Resolver: aeromancy -> Crystallize.
 */

class AeromancyCrystallizeSynergy {
...
module.exports = { AeromancyCrystallizeSynergy };
