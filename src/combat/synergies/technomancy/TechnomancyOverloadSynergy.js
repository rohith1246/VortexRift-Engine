/**
 * TechnomancyOverloadSynergy.js - Elemental Reaction & Synergy Resolver: technomancy -> Overload.
 */

class TechnomancyOverloadSynergy {
...
module.exports = { TechnomancyOverloadSynergy };
