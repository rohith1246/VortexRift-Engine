/**
 * TechnomancyVaporizeSynergy.js - Elemental Reaction & Synergy Resolver: technomancy -> Vaporize.
 */

class TechnomancyVaporizeSynergy {
...
module.exports = { TechnomancyVaporizeSynergy };
