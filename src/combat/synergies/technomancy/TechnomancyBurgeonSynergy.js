/**
 * TechnomancyBurgeonSynergy.js - Elemental Reaction & Synergy Resolver: technomancy -> Burgeon.
 */

class TechnomancyBurgeonSynergy {
...
module.exports = { TechnomancyBurgeonSynergy };
