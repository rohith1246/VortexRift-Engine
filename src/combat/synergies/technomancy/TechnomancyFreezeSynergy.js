/**
 * TechnomancyFreezeSynergy.js - Elemental Reaction & Synergy Resolver: technomancy -> Freeze.
 */

class TechnomancyFreezeSynergy {
...
module.exports = { TechnomancyFreezeSynergy };
