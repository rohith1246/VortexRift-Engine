/**
 * TechnomancySpreadSynergy.js - Elemental Reaction & Synergy Resolver: technomancy -> Spread.
 */

class TechnomancySpreadSynergy {
...
module.exports = { TechnomancySpreadSynergy };
