/**
 * ElectromancyBurgeonSynergy.js - Elemental Reaction & Synergy Resolver: electromancy -> Burgeon.
 */

class ElectromancyBurgeonSynergy {
...
module.exports = { ElectromancyBurgeonSynergy };
