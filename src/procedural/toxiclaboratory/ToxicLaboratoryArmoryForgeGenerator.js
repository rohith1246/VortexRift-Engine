/**
 * ToxicLaboratoryArmoryForgeGenerator.js - Procedural Dungeon Room Generator: ToxicLaboratory -> ArmoryForge.
 */

class ToxicLaboratoryArmoryForgeGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.biome = 'ToxicLaboratory';
    this.layout = 'ArmoryForge';
    this.width = 28;
    this.height = 17;
...
module.exports = { ToxicLaboratoryArmoryForgeGenerator };
