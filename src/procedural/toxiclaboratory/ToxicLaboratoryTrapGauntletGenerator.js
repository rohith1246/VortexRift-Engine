/**
 * ToxicLaboratoryTrapGauntletGenerator.js - Procedural Dungeon Room Generator: ToxicLaboratory -> TrapGauntlet.
 */

class ToxicLaboratoryTrapGauntletGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.biome = 'ToxicLaboratory';
    this.layout = 'TrapGauntlet';
    this.width = 20;
    this.height = 17;
...
module.exports = { ToxicLaboratoryTrapGauntletGenerator };
