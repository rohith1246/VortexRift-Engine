/**
 * EtherealVoidSacrificialAltarGenerator.js - Procedural Dungeon Room Generator: EtherealVoid -> SacrificialAltar.
 */

class EtherealVoidSacrificialAltarGenerator {
  constructor(seed = Date.now()) {
    this.seed = seed;
    this.biome = 'EtherealVoid';
    this.layout = 'SacrificialAltar';
    this.width = 16;
    this.height = 14;
    this.hazardDensity = 0.15000000000000002;
  }
      ...
      for (let x = 0; x < this.width; x++) {
        if (x === 0 || x === this.width - 1 || y === 0 || y === this.height - 1) {
          ...
          if (rand < this.hazardDensity) {
            grid[y][x] = { tile: 'HAZARD', type: 'etherealvoid_trap', walkable: true };
...
module.exports = { EtherealVoidSacrificialAltarGenerator };
