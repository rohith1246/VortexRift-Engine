/**
 * IronLegionPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: IronLegion -> PurifyCorruptedShrine.
 */

class IronLegionPurifyCorruptedShrineQuest {
  constructor(questId = 'q_ironlegion_4') {
...
module.exports = { IronLegionPurifyCorruptedShrineQuest };
