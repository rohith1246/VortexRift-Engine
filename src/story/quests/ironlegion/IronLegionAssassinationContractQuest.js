/**
 * IronLegionAssassinationContractQuest.js - Dynamic Quest FSM Controller: IronLegion -> AssassinationContract.
 */

class IronLegionAssassinationContractQuest {
  constructor(questId = 'q_ironlegion_1') {
    this.questId = questId;
    this.faction = 'IronLegion';
    this.questTitle = 'AssassinationContract';
    this.requiredLevel = 7;
...
module.exports = { IronLegionAssassinationContractQuest };
