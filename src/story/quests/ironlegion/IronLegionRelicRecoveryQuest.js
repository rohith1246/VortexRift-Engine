/**
 * IronLegionRelicRecoveryQuest.js - Dynamic Quest FSM Controller: IronLegion -> RelicRecovery.
 */

class IronLegionRelicRecoveryQuest {
  constructor(questId = 'q_ironlegion_0') {
...
module.exports = { IronLegionRelicRecoveryQuest };
