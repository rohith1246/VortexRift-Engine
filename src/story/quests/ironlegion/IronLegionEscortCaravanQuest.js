/**
 * IronLegionEscortCaravanQuest.js - Dynamic Quest FSM Controller: IronLegion -> EscortCaravan.
 */

class IronLegionEscortCaravanQuest {
  constructor(questId = 'q_ironlegion_3') {
...
module.exports = { IronLegionEscortCaravanQuest };
