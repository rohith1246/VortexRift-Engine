/**
 * IronLegionForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: IronLegion -> ForgeLegendaryWeapon.
 */

class IronLegionForgeLegendaryWeaponQuest {
  constructor(questId = 'q_ironlegion_12') {
    this.questId = questId;
    this.faction = 'IronLegion';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 9;
...
module.exports = { IronLegionForgeLegendaryWeaponQuest };
