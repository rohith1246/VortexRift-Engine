/**
 * IronLegionCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: IronLegion -> CloseVoidRift.
 */

class IronLegionCloseVoidRiftQuest {
  constructor(questId = 'q_ironlegion_11') {
...
module.exports = { IronLegionCloseVoidRiftQuest };
