/**
 * IronLegionDefendOutpostQuest.js - Dynamic Quest FSM Controller: IronLegion -> DefendOutpost.
 */

class IronLegionDefendOutpostQuest {
  constructor(questId = 'q_ironlegion_2') {
...
module.exports = { IronLegionDefendOutpostQuest };
