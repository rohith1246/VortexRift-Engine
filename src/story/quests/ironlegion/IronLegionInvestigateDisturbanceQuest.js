/**
 * IronLegionInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: IronLegion -> InvestigateDisturbance.
 */

class IronLegionInvestigateDisturbanceQuest {
  constructor(questId = 'q_ironlegion_13') {
    this.questId = questId;
    this.faction = 'IronLegion';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 11;
...
module.exports = { IronLegionInvestigateDisturbanceQuest };
