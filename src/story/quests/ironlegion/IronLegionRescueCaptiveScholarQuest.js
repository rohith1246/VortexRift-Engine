/**
 * IronLegionRescueCaptiveScholarQuest.js - Dynamic Quest FSM Controller: IronLegion -> RescueCaptiveScholar.
 */

class IronLegionRescueCaptiveScholarQuest {
  constructor(questId = 'q_ironlegion_9') {
...
module.exports = { IronLegionRescueCaptiveScholarQuest };
