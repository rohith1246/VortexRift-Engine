/**
 * IronLegionSlayDungeonBossQuest.js - Dynamic Quest FSM Controller: IronLegion -> SlayDungeonBoss.
 */

class IronLegionSlayDungeonBossQuest {
  constructor(questId = 'q_ironlegion_7') {
...
module.exports = { IronLegionSlayDungeonBossQuest };
