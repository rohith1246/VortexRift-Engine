/**
 * IronLegionGatherStarShardsQuest.js - Dynamic Quest FSM Controller: IronLegion -> GatherStarShards.
 */

class IronLegionGatherStarShardsQuest {
  constructor(questId = 'q_ironlegion_6') {
...
module.exports = { IronLegionGatherStarShardsQuest };
