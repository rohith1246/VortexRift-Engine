/**
 * NetherReapersEscortCaravanQuest.js - Dynamic Quest FSM Controller: NetherReapers -> EscortCaravan.
 */

class NetherReapersEscortCaravanQuest {
  constructor(questId = 'q_netherreapers_3') {
...
module.exports = { NetherReapersEscortCaravanQuest };
