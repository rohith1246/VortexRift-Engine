/**
 * NetherReapersDefendOutpostQuest.js - Dynamic Quest FSM Controller: NetherReapers -> DefendOutpost.
 */

class NetherReapersDefendOutpostQuest {
  constructor(questId = 'q_netherreapers_2') {
...
module.exports = { NetherReapersDefendOutpostQuest };
