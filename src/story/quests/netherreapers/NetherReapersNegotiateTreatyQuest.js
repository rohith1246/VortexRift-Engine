/**
 * NetherReapersNegotiateTreatyQuest.js - Dynamic Quest FSM Controller: NetherReapers -> NegotiateTreaty.
 */

class NetherReapersNegotiateTreatyQuest {
  constructor(questId = 'q_netherreapers_14') {
...
module.exports = { NetherReapersNegotiateTreatyQuest };
