/**
 * NetherReapersCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: NetherReapers -> CloseVoidRift.
 */

class NetherReapersCloseVoidRiftQuest {
  constructor(questId = 'q_netherreapers_11') {
...
module.exports = { NetherReapersCloseVoidRiftQuest };
