/**
 * NetherReapersRelicRecoveryQuest.js - Dynamic Quest FSM Controller: NetherReapers -> RelicRecovery.
 */

class NetherReapersRelicRecoveryQuest {
  constructor(questId = 'q_netherreapers_0') {
...
module.exports = { NetherReapersRelicRecoveryQuest };
