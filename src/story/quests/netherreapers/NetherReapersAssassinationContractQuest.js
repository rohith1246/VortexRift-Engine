/**
 * NetherReapersAssassinationContractQuest.js - Dynamic Quest FSM Controller: NetherReapers -> AssassinationContract.
 */

class NetherReapersAssassinationContractQuest {
  constructor(questId = 'q_netherreapers_1') {
...
module.exports = { NetherReapersAssassinationContractQuest };
