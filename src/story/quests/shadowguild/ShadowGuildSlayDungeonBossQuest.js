/**
 * ShadowGuildSlayDungeonBossQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> SlayDungeonBoss.
 */

class ShadowGuildSlayDungeonBossQuest {
  constructor(questId = 'q_shadowguild_7') {
...
module.exports = { ShadowGuildSlayDungeonBossQuest };
