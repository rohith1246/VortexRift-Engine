/**
 * ShadowGuildSabotageSupplyDepotQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> SabotageSupplyDepot.
 */

class ShadowGuildSabotageSupplyDepotQuest {
  constructor(questId = 'q_shadowguild_10') {
...
module.exports = { ShadowGuildSabotageSupplyDepotQuest };
