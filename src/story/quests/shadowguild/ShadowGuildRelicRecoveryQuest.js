/**
 * ShadowGuildRelicRecoveryQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> RelicRecovery.
 */

class ShadowGuildRelicRecoveryQuest {
  constructor(questId = 'q_shadowguild_0') {
...
module.exports = { ShadowGuildRelicRecoveryQuest };
