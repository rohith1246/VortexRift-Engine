/**
 * ShadowGuildDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> DecipherAncientTome.
 */

class ShadowGuildDecipherAncientTomeQuest {
  constructor(questId = 'q_shadowguild_8') {
...
module.exports = { ShadowGuildDecipherAncientTomeQuest };
