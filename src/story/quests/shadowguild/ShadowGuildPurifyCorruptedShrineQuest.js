/**
 * ShadowGuildPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> PurifyCorruptedShrine.
 */

class ShadowGuildPurifyCorruptedShrineQuest {
  constructor(questId = 'q_shadowguild_4') {
...
module.exports = { ShadowGuildPurifyCorruptedShrineQuest };
