/**
 * ShadowGuildRescueCaptiveScholarQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> RescueCaptiveScholar.
 */

class ShadowGuildRescueCaptiveScholarQuest {
  constructor(questId = 'q_shadowguild_9') {
...
module.exports = { ShadowGuildRescueCaptiveScholarQuest };
