/**
 * ShadowGuildNegotiateTreatyQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> NegotiateTreaty.
 */

class ShadowGuildNegotiateTreatyQuest {
  constructor(questId = 'q_shadowguild_14') {
...
module.exports = { ShadowGuildNegotiateTreatyQuest };
