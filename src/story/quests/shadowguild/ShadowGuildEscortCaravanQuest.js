/**
 * ShadowGuildEscortCaravanQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> EscortCaravan.
 */

class ShadowGuildEscortCaravanQuest {
  constructor(questId = 'q_shadowguild_3') {
...
module.exports = { ShadowGuildEscortCaravanQuest };
