/**
 * ShadowGuildCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: ShadowGuild -> CloseVoidRift.
 */

class ShadowGuildCloseVoidRiftQuest {
  constructor(questId = 'q_shadowguild_11') {
...
module.exports = { ShadowGuildCloseVoidRiftQuest };
