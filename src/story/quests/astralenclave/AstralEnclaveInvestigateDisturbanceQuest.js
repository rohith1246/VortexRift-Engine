/**
 * AstralEnclaveInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> InvestigateDisturbance.
 */

class AstralEnclaveInvestigateDisturbanceQuest {
  constructor(questId = 'q_astralenclave_13') {
    this.questId = questId;
    this.faction = 'AstralEnclave';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 53;
...
module.exports = { AstralEnclaveInvestigateDisturbanceQuest };
