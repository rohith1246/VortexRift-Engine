/**
 * AstralEnclaveDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> DecipherAncientTome.
 */

class AstralEnclaveDecipherAncientTomeQuest {
  constructor(questId = 'q_astralenclave_8') {
...
module.exports = { AstralEnclaveDecipherAncientTomeQuest };
