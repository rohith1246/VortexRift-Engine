/**
 * AstralEnclaveAssassinationContractQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> AssassinationContract.
 */

class AstralEnclaveAssassinationContractQuest {
  constructor(questId = 'q_astralenclave_1') {
...
module.exports = { AstralEnclaveAssassinationContractQuest };
