/**
 * AstralEnclaveRescueCaptiveScholarQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> RescueCaptiveScholar.
 */

class AstralEnclaveRescueCaptiveScholarQuest {
  constructor(questId = 'q_astralenclave_9') {
...
module.exports = { AstralEnclaveRescueCaptiveScholarQuest };
