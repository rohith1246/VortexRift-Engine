/**
 * AstralEnclavePurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> PurifyCorruptedShrine.
 */

class AstralEnclavePurifyCorruptedShrineQuest {
  constructor(questId = 'q_astralenclave_4') {
    this.questId = questId;
    this.faction = 'AstralEnclave';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 55;
...
module.exports = { AstralEnclavePurifyCorruptedShrineQuest };
