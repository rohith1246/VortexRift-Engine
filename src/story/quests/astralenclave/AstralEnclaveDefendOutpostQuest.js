/**
 * AstralEnclaveDefendOutpostQuest.js - Dynamic Quest FSM Controller: AstralEnclave -> DefendOutpost.
 */

class AstralEnclaveDefendOutpostQuest {
  constructor(questId = 'q_astralenclave_2') {
...
module.exports = { AstralEnclaveDefendOutpostQuest };
