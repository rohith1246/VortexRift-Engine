/**
 * SilverScribesRelicRecoveryQuest.js - Dynamic Quest FSM Controller: SilverScribes -> RelicRecovery.
 */

class SilverScribesRelicRecoveryQuest {
  constructor(questId = 'q_silverscribes_0') {
...
module.exports = { SilverScribesRelicRecoveryQuest };
