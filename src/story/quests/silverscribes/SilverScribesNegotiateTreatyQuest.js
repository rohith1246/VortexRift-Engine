/**
 * SilverScribesNegotiateTreatyQuest.js - Dynamic Quest FSM Controller: SilverScribes -> NegotiateTreaty.
 */

class SilverScribesNegotiateTreatyQuest {
  constructor(questId = 'q_silverscribes_14') {
...
module.exports = { SilverScribesNegotiateTreatyQuest };
