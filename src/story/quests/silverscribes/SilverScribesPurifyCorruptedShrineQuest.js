/**
 * SilverScribesPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: SilverScribes -> PurifyCorruptedShrine.
 */

class SilverScribesPurifyCorruptedShrineQuest {
  constructor(questId = 'q_silverscribes_4') {
    this.questId = questId;
    this.faction = 'SilverScribes';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 16;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to SilverScribes liaison', completed: false }
    ];
    this.reputationReward = 125;
    this.goldReward = 450;
  }
...
module.exports = { SilverScribesPurifyCorruptedShrineQuest };
