/**
 * SilverScribesCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: SilverScribes -> CloseVoidRift.
 */

class SilverScribesCloseVoidRiftQuest {
  constructor(questId = 'q_silverscribes_11') {
...
module.exports = { SilverScribesCloseVoidRiftQuest };
