/**
 * SilverScribesDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: SilverScribes -> DecipherAncientTome.
 */

class SilverScribesDecipherAncientTomeQuest {
  constructor(questId = 'q_silverscribes_8') {
...
module.exports = { SilverScribesDecipherAncientTomeQuest };
