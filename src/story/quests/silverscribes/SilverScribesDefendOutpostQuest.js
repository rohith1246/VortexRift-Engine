/**
 * SilverScribesDefendOutpostQuest.js - Dynamic Quest FSM Controller: SilverScribes -> DefendOutpost.
 */

class SilverScribesDefendOutpostQuest {
  constructor(questId = 'q_silverscribes_2') {
...
module.exports = { SilverScribesDefendOutpostQuest };
