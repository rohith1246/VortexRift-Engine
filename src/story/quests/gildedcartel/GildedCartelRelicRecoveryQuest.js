/**
 * GildedCartelRelicRecoveryQuest.js - Dynamic Quest FSM Controller: GildedCartel -> RelicRecovery.
 */

class GildedCartelRelicRecoveryQuest {
  constructor(questId = 'q_gildedcartel_0') {
...
module.exports = { GildedCartelRelicRecoveryQuest };
