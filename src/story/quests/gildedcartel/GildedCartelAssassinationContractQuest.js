/**
 * GildedCartelAssassinationContractQuest.js - Dynamic Quest FSM Controller: GildedCartel -> AssassinationContract.
 */

class GildedCartelAssassinationContractQuest {
  constructor(questId = 'q_gildedcartel_1') {
...
module.exports = { GildedCartelAssassinationContractQuest };
