/**
 * GildedCartelInfiltrateFortressQuest.js - Dynamic Quest FSM Controller: GildedCartel -> InfiltrateFortress.
 */

class GildedCartelInfiltrateFortressQuest {
  constructor(questId = 'q_gildedcartel_5') {
...
module.exports = { GildedCartelInfiltrateFortressQuest };
