/**
 * GildedCartelCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: GildedCartel -> CloseVoidRift.
 */

class GildedCartelCloseVoidRiftQuest {
  constructor(questId = 'q_gildedcartel_11') {
...
module.exports = { GildedCartelCloseVoidRiftQuest };
