/**
 * GildedCartelForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: GildedCartel -> ForgeLegendaryWeapon.
 */

class GildedCartelForgeLegendaryWeaponQuest {
  constructor(questId = 'q_gildedcartel_12') {
    this.questId = questId;
    this.faction = 'GildedCartel';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 33;
...
module.exports = { GildedCartelForgeLegendaryWeaponQuest };
