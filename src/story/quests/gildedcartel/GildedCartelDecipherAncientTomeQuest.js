/**
 * GildedCartelDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: GildedCartel -> DecipherAncientTome.
 */

class GildedCartelDecipherAncientTomeQuest {
  constructor(questId = 'q_gildedcartel_8') {
...
module.exports = { GildedCartelDecipherAncientTomeQuest };
