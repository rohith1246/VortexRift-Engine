/**
 * GildedCartelDefendOutpostQuest.js - Dynamic Quest FSM Controller: GildedCartel -> DefendOutpost.
 */

class GildedCartelDefendOutpostQuest {
  constructor(questId = 'q_gildedcartel_2') {
...
module.exports = { GildedCartelDefendOutpostQuest };
