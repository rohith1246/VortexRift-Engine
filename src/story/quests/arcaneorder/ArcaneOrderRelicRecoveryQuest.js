/**
 * ArcaneOrderRelicRecoveryQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> RelicRecovery.
 */

class ArcaneOrderRelicRecoveryQuest {
  constructor(questId = 'q_arcaneorder_0') {
...
module.exports = { ArcaneOrderRelicRecoveryQuest };
