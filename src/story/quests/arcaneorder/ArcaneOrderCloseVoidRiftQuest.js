/**
 * ArcaneOrderCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> CloseVoidRift.
 */

class ArcaneOrderCloseVoidRiftQuest {
  constructor(questId = 'q_arcaneorder_11') {
...
module.exports = { ArcaneOrderCloseVoidRiftQuest };
