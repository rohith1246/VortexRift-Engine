/**
 * ArcaneOrderForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> ForgeLegendaryWeapon.
 */

class ArcaneOrderForgeLegendaryWeaponQuest {
  constructor(questId = 'q_arcaneorder_12') {
    this.questId = questId;
    this.faction = 'ArcaneOrder';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 24;
...
module.exports = { ArcaneOrderForgeLegendaryWeaponQuest };
