/**
 * ArcaneOrderDefendOutpostQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> DefendOutpost.
 */

class ArcaneOrderDefendOutpostQuest {
  constructor(questId = 'q_arcaneorder_2') {
...
module.exports = { ArcaneOrderDefendOutpostQuest };
