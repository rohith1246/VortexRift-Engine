/**
 * ArcaneOrderSlayDungeonBossQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> SlayDungeonBoss.
 */

class ArcaneOrderSlayDungeonBossQuest {
  constructor(questId = 'q_arcaneorder_7') {
...
module.exports = { ArcaneOrderSlayDungeonBossQuest };
