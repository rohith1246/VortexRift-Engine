/**
 * ArcaneOrderEscortCaravanQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> EscortCaravan.
 */

class ArcaneOrderEscortCaravanQuest {
  constructor(questId = 'q_arcaneorder_3') {
...
module.exports = { ArcaneOrderEscortCaravanQuest };
