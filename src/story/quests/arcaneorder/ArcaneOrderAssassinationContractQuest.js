/**
 * ArcaneOrderAssassinationContractQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> AssassinationContract.
 */

class ArcaneOrderAssassinationContractQuest {
  constructor(questId = 'q_arcaneorder_1') {
    this.questId = questId;
    this.faction = 'ArcaneOrder';
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to ArcaneOrder liaison', completed: false }
    ];
    this.reputationReward = 225;
    this.goldReward = 300;
  }
...
module.exports = { ArcaneOrderAssassinationContractQuest };
