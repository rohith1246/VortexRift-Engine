/**
 * ArcaneOrderDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: ArcaneOrder -> DecipherAncientTome.
 */

class ArcaneOrderDecipherAncientTomeQuest {
  constructor(questId = 'q_arcaneorder_8') {
...
module.exports = { ArcaneOrderDecipherAncientTomeQuest };
