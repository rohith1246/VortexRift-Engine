/**
 * FrostGuardiansForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: FrostGuardians -> ForgeLegendaryWeapon.
 */

class FrostGuardiansForgeLegendaryWeaponQuest {
  constructor(questId = 'q_frostguardians_12') {
    this.questId = questId;
    this.faction = 'FrostGuardians';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 48;
...
module.exports = { FrostGuardiansForgeLegendaryWeaponQuest };
