/**
 * FrostGuardiansSabotageSupplyDepotQuest.js - Dynamic Quest FSM Controller: FrostGuardians -> SabotageSupplyDepot.
 */

class FrostGuardiansSabotageSupplyDepotQuest {
  constructor(questId = 'q_frostguardians_10') {
...
module.exports = { FrostGuardiansSabotageSupplyDepotQuest };
