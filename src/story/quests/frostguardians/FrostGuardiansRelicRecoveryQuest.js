/**
 * FrostGuardiansRelicRecoveryQuest.js - Dynamic Quest FSM Controller: FrostGuardians -> RelicRecovery.
 */

class FrostGuardiansRelicRecoveryQuest {
  constructor(questId = 'q_frostguardians_0') {
...
module.exports = { FrostGuardiansRelicRecoveryQuest };
