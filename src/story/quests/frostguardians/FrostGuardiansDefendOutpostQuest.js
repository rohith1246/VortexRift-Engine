/**
 * FrostGuardiansDefendOutpostQuest.js - Dynamic Quest FSM Controller: FrostGuardians -> DefendOutpost.
 */

class FrostGuardiansDefendOutpostQuest {
  constructor(questId = 'q_frostguardians_2') {
...
module.exports = { FrostGuardiansDefendOutpostQuest };
