/**
 * FrostGuardiansPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: FrostGuardians -> PurifyCorruptedShrine.
 */

class FrostGuardiansPurifyCorruptedShrineQuest {
  constructor(questId = 'q_frostguardians_4') {
    this.questId = questId;
    this.faction = 'FrostGuardians';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 52;
...
module.exports = { FrostGuardiansPurifyCorruptedShrineQuest };
