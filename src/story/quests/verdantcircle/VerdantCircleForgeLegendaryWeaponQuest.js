/**
 * VerdantCircleForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: VerdantCircle -> ForgeLegendaryWeapon.
 */

class VerdantCircleForgeLegendaryWeaponQuest {
  constructor(questId = 'q_verdantcircle_12') {
    this.questId = questId;
    this.faction = 'VerdantCircle';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 27;
...
module.exports = { VerdantCircleForgeLegendaryWeaponQuest };
