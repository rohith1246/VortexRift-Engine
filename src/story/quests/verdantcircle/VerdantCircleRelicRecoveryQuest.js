/**
 * VerdantCircleRelicRecoveryQuest.js - Dynamic Quest FSM Controller: VerdantCircle -> RelicRecovery.
 */

class VerdantCircleRelicRecoveryQuest {
  constructor(questId = 'q_verdantcircle_0') {
...
module.exports = { VerdantCircleRelicRecoveryQuest };
