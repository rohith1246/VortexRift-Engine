/**
 * VerdantCircleInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: VerdantCircle -> InvestigateDisturbance.
 */

class VerdantCircleInvestigateDisturbanceQuest {
  constructor(questId = 'q_verdantcircle_13') {
    this.questId = questId;
    this.faction = 'VerdantCircle';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 29;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to VerdantCircle liaison', completed: false }
    ];
...
module.exports = { VerdantCircleInvestigateDisturbanceQuest };
