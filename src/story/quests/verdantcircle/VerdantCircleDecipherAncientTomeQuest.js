/**
 * VerdantCircleDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: VerdantCircle -> DecipherAncientTome.
 */

class VerdantCircleDecipherAncientTomeQuest {
  constructor(questId = 'q_verdantcircle_8') {
...
module.exports = { VerdantCircleDecipherAncientTomeQuest };
