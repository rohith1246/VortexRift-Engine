/**
 * VoidHarbingersAssassinationContractQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> AssassinationContract.
 */

class VoidHarbingersAssassinationContractQuest {
  constructor(questId = 'q_voidharbingers_1') {
    this.questId = questId;
    this.faction = 'VoidHarbingers';
    this.questTitle = 'AssassinationContract';
    this.requiredLevel = 37;
...
module.exports = { VoidHarbingersAssassinationContractQuest };
