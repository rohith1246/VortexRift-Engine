/**
 * VoidHarbingersForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> ForgeLegendaryWeapon.
 */

class VoidHarbingersForgeLegendaryWeaponQuest {
  constructor(questId = 'q_voidharbingers_12') {
    this.questId = questId;
    this.faction = 'VoidHarbingers';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 39;
...
module.exports = { VoidHarbingersForgeLegendaryWeaponQuest };
