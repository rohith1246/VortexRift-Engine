/**
 * VoidHarbingersInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> InvestigateDisturbance.
 */

class VoidHarbingersInvestigateDisturbanceQuest {
  constructor(questId = 'q_voidharbingers_13') {
    this.questId = questId;
    this.faction = 'VoidHarbingers';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 41;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to VoidHarbingers liaison', completed: false }
    ];
    this.reputationReward = 350;
    this.goldReward = 900;
  }
...
module.exports = { VoidHarbingersInvestigateDisturbanceQuest };
