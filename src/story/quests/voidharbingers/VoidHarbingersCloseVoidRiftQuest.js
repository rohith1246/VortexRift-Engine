/**
 * VoidHarbingersCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> CloseVoidRift.
 */

class VoidHarbingersCloseVoidRiftQuest {
  constructor(questId = 'q_voidharbingers_11') {
...
module.exports = { VoidHarbingersCloseVoidRiftQuest };
