/**
 * VoidHarbingersRelicRecoveryQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> RelicRecovery.
 */

class VoidHarbingersRelicRecoveryQuest {
  constructor(questId = 'q_voidharbingers_0') {
...
module.exports = { VoidHarbingersRelicRecoveryQuest };
