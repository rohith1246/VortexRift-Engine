/**
 * VoidHarbingersRescueCaptiveScholarQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> RescueCaptiveScholar.
 */

class VoidHarbingersRescueCaptiveScholarQuest {
  constructor(questId = 'q_voidharbingers_9') {
    this.questId = questId;
    this.faction = 'VoidHarbingers';
    this.questTitle = 'RescueCaptiveScholar';
...
module.exports = { VoidHarbingersRescueCaptiveScholarQuest };
