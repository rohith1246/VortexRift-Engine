/**
 * VoidHarbingersEscortCaravanQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> EscortCaravan.
 */

class VoidHarbingersEscortCaravanQuest {
  constructor(questId = 'q_voidharbingers_3') {
...
module.exports = { VoidHarbingersEscortCaravanQuest };
