/**
 * VoidHarbingersPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: VoidHarbingers -> PurifyCorruptedShrine.
 */

class VoidHarbingersPurifyCorruptedShrineQuest {
  constructor(questId = 'q_voidharbingers_4') {
    this.questId = questId;
    this.faction = 'VoidHarbingers';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 43;
...
module.exports = { VoidHarbingersPurifyCorruptedShrineQuest };
