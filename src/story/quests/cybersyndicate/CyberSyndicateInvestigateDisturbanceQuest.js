/**
 * CyberSyndicateInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: CyberSyndicate -> InvestigateDisturbance.
 */

class CyberSyndicateInvestigateDisturbanceQuest {
  constructor(questId = 'q_cybersyndicate_13') {
    this.questId = questId;
    this.faction = 'CyberSyndicate';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 44;
...
module.exports = { CyberSyndicateInvestigateDisturbanceQuest };
