/**
 * CyberSyndicateForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: CyberSyndicate -> ForgeLegendaryWeapon.
 */

class CyberSyndicateForgeLegendaryWeaponQuest {
  constructor(questId = 'q_cybersyndicate_12') {
    this.questId = questId;
    this.faction = 'CyberSyndicate';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 42;
...
module.exports = { CyberSyndicateForgeLegendaryWeaponQuest };
