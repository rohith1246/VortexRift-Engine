/**
 * SolarisKnightsForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> ForgeLegendaryWeapon.
 */

class SolarisKnightsForgeLegendaryWeaponQuest {
  constructor(questId = 'q_solarisknights_12') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 21;
...
module.exports = { SolarisKnightsForgeLegendaryWeaponQuest };
