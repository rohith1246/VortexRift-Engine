/**
 * SolarisKnightsDecipherAncientTomeQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> DecipherAncientTome.
 */

class SolarisKnightsDecipherAncientTomeQuest {
  constructor(questId = 'q_solarisknights_8') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'DecipherAncientTome';
...
module.exports = { SolarisKnightsDecipherAncientTomeQuest };
