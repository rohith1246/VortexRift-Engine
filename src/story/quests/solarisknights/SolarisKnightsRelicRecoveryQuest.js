/**
 * SolarisKnightsRelicRecoveryQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> RelicRecovery.
 */

class SolarisKnightsRelicRecoveryQuest {
  constructor(questId = 'q_solarisknights_0') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'RelicRecovery';
...
module.exports = { SolarisKnightsRelicRecoveryQuest };
