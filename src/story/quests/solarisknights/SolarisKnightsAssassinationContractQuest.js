/**
 * SolarisKnightsAssassinationContractQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> AssassinationContract.
 */

class SolarisKnightsAssassinationContractQuest {
  constructor(questId = 'q_solarisknights_1') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'AssassinationContract';
    this.requiredLevel = 19;
...
module.exports = { SolarisKnightsAssassinationContractQuest };
