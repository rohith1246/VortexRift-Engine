/**
 * SolarisKnightsInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> InvestigateDisturbance.
 */

class SolarisKnightsInvestigateDisturbanceQuest {
  constructor(questId = 'q_solarisknights_13') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 23;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to SolarisKnights liaison', completed: false }
    ];
    this.reputationReward = 200;
    this.goldReward = 900;
  }
...
module.exports = { SolarisKnightsInvestigateDisturbanceQuest };
