/**
 * SolarisKnightsInfiltrateFortressQuest.js - Dynamic Quest FSM Controller: SolarisKnights -> InfiltrateFortress.
 */

class SolarisKnightsInfiltrateFortressQuest {
  constructor(questId = 'q_solarisknights_5') {
    this.questId = questId;
    this.faction = 'SolarisKnights';
    this.questTitle = 'InfiltrateFortress';
    this.requiredLevel = 17;
...
module.exports = { SolarisKnightsInfiltrateFortressQuest };
