/**
 * StormCallersSlayDungeonBossQuest.js - Dynamic Quest FSM Controller: StormCallers -> SlayDungeonBoss.
 */

class StormCallersSlayDungeonBossQuest {
  constructor(questId = 'q_stormcallers_7') {
...
module.exports = { StormCallersSlayDungeonBossQuest };
