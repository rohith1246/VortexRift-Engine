/**
 * StormCallersRelicRecoveryQuest.js - Dynamic Quest FSM Controller: StormCallers -> RelicRecovery.
 */

class StormCallersRelicRecoveryQuest {
  constructor(questId = 'q_stormcallers_0') {
...
module.exports = { StormCallersRelicRecoveryQuest };
