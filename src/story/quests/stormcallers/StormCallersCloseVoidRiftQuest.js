/**
 * StormCallersCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: StormCallers -> CloseVoidRift.
 */

class StormCallersCloseVoidRiftQuest {
  constructor(questId = 'q_stormcallers_11') {
...
module.exports = { StormCallersCloseVoidRiftQuest };
