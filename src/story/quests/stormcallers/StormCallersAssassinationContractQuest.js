/**
 * StormCallersAssassinationContractQuest.js - Dynamic Quest FSM Controller: StormCallers -> AssassinationContract.
 */

class StormCallersAssassinationContractQuest {
  constructor(questId = 'q_stormcallers_1') {
    this.questId = questId;
    this.faction = 'StormCallers';
    this.questTitle = 'AssassinationContract';
    this.requiredLevel = 34;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to StormCallers liaison', completed: false }
    ];
    this.reputationReward = 325;
    this.goldReward = 300;
  }
...
module.exports = { StormCallersAssassinationContractQuest };
