/**
 * StormCallersInfiltrateFortressQuest.js - Dynamic Quest FSM Controller: StormCallers -> InfiltrateFortress.
 */

class StormCallersInfiltrateFortressQuest {
  constructor(questId = 'q_stormcallers_5') {
    this.questId = questId;
    this.faction = 'StormCallers';
    this.questTitle = 'InfiltrateFortress';
    this.requiredLevel = 32;
...
module.exports = { StormCallersInfiltrateFortressQuest };
