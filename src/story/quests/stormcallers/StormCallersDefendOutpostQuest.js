/**
 * StormCallersDefendOutpostQuest.js - Dynamic Quest FSM Controller: StormCallers -> DefendOutpost.
 */

class StormCallersDefendOutpostQuest {
  constructor(questId = 'q_stormcallers_2') {
...
module.exports = { StormCallersDefendOutpostQuest };
