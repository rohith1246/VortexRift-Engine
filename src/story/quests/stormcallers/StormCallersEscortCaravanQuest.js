/**
 * StormCallersEscortCaravanQuest.js - Dynamic Quest FSM Controller: StormCallers -> EscortCaravan.
 */

class StormCallersEscortCaravanQuest {
  constructor(questId = 'q_stormcallers_3') {
...
module.exports = { StormCallersEscortCaravanQuest };
