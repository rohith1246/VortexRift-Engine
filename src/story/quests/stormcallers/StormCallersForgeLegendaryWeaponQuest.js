/**
 * StormCallersForgeLegendaryWeaponQuest.js - Dynamic Quest FSM Controller: StormCallers -> ForgeLegendaryWeapon.
 */

class StormCallersForgeLegendaryWeaponQuest {
  constructor(questId = 'q_stormcallers_12') {
    this.questId = questId;
    this.faction = 'StormCallers';
    this.questTitle = 'ForgeLegendaryWeapon';
    this.requiredLevel = 36;
...
module.exports = { StormCallersForgeLegendaryWeaponQuest };
