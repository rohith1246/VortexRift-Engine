/**
 * StormCallersNegotiateTreatyQuest.js - Dynamic Quest FSM Controller: StormCallers -> NegotiateTreaty.
 */

class StormCallersNegotiateTreatyQuest {
  constructor(questId = 'q_stormcallers_14') {
...
module.exports = { StormCallersNegotiateTreatyQuest };
