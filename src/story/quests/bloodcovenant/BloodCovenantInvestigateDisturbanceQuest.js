/**
 * BloodCovenantInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: BloodCovenant -> InvestigateDisturbance.
 */

class BloodCovenantInvestigateDisturbanceQuest {
  constructor(questId = 'q_bloodcovenant_13') {
    this.questId = questId;
    this.faction = 'BloodCovenant';
    this.questTitle = 'InvestigateDisturbance';
    this.requiredLevel = 47;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to BloodCovenant liaison', completed: false }
    ];
    this.reputationReward = 400;
    this.goldReward = 900;
  }
...
module.exports = { BloodCovenantInvestigateDisturbanceQuest };
