/**
 * BloodCovenantPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: BloodCovenant -> PurifyCorruptedShrine.
 */

class BloodCovenantPurifyCorruptedShrineQuest {
  constructor(questId = 'q_bloodcovenant_4') {
    this.questId = questId;
    this.faction = 'BloodCovenant';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 49;
...
module.exports = { BloodCovenantPurifyCorruptedShrineQuest };
