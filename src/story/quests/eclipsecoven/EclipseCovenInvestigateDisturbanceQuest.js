/**
 * EclipseCovenInvestigateDisturbanceQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> InvestigateDisturbance.
 */

class EclipseCovenInvestigateDisturbanceQuest {
  constructor(questId = 'q_eclipsecoven_13') {
...
module.exports = { EclipseCovenInvestigateDisturbanceQuest };
