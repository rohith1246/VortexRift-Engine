/**
 * EclipseCovenEscortCaravanQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> EscortCaravan.
 */

class EclipseCovenEscortCaravanQuest {
  constructor(questId = 'q_eclipsecoven_3') {
...
module.exports = { EclipseCovenEscortCaravanQuest };
