/**
 * EclipseCovenNegotiateTreatyQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> NegotiateTreaty.
 */

class EclipseCovenNegotiateTreatyQuest {
  constructor(questId = 'q_eclipsecoven_14') {
...
module.exports = { EclipseCovenNegotiateTreatyQuest };
