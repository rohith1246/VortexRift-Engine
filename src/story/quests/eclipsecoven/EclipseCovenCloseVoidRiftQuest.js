/**
 * EclipseCovenCloseVoidRiftQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> CloseVoidRift.
 */

class EclipseCovenCloseVoidRiftQuest {
  constructor(questId = 'q_eclipsecoven_11') {
...
module.exports = { EclipseCovenCloseVoidRiftQuest };
