/**
 * EclipseCovenPurifyCorruptedShrineQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> PurifyCorruptedShrine.
 */

class EclipseCovenPurifyCorruptedShrineQuest {
  constructor(questId = 'q_eclipsecoven_4') {
    this.questId = questId;
    this.faction = 'EclipseCoven';
    this.questTitle = 'PurifyCorruptedShrine';
    this.requiredLevel = 22;
    ...
    this.objectives = [
      ...
      { id: 'obj_3', desc: 'Return to EclipseCoven liaison', completed: false }
    ];
    this.reputationReward = 175;
    this.goldReward = 450;
  }
...
module.exports = { EclipseCovenPurifyCorruptedShrineQuest };
