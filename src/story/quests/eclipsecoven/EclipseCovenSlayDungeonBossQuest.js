/**
 * EclipseCovenSlayDungeonBossQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> SlayDungeonBoss.
 */

class EclipseCovenSlayDungeonBossQuest {
  constructor(questId = 'q_eclipsecoven_7') {
...
module.exports = { EclipseCovenSlayDungeonBossQuest };
