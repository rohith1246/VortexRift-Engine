/**
 * EclipseCovenDefendOutpostQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> DefendOutpost.
 */

class EclipseCovenDefendOutpostQuest {
  constructor(questId = 'q_eclipsecoven_2') {
...
module.exports = { EclipseCovenDefendOutpostQuest };
