/**
 * EclipseCovenInfiltrateFortressQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> InfiltrateFortress.
 */

class EclipseCovenInfiltrateFortressQuest {
  constructor(questId = 'q_eclipsecoven_5') {
...
module.exports = { EclipseCovenInfiltrateFortressQuest };
