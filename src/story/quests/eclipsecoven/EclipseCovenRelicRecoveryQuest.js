/**
 * EclipseCovenRelicRecoveryQuest.js - Dynamic Quest FSM Controller: EclipseCoven -> RelicRecovery.
 */

class EclipseCovenRelicRecoveryQuest {
  constructor(questId = 'q_eclipsecoven_0') {
...
module.exports = { EclipseCovenRelicRecoveryQuest };
