/**
 * SolarBarrierSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Barrier
 */

class SolarBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_solar_barrier';
...
module.exports = { SolarBarrierSpell };
