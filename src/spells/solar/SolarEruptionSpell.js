/**
 * SolarEruptionSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Eruption
 */

class SolarEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_eruption';
    this.name = 'SolarEruption';
    this.school = 'solar';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 135;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 356;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_solar_eruption';
...
module.exports = { SolarEruptionSpell };
