/**
 * SolarVortexSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Vortex
 */

class SolarVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_solar_vortex';
...
module.exports = { SolarVortexSpell };
