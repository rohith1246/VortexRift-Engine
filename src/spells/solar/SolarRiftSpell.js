/**
 * SolarRiftSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Rift
 */

class SolarRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_rift';
    this.name = 'SolarRift';
    this.school = 'solar';
    this.form = 'Rift';
    this.tier = 2;
    this.baseManaCost = config.mana || 129;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 338;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_solar_rift';
