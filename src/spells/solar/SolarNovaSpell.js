/**
 * SolarNovaSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Nova
 */

class SolarNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_nova';
    this.name = 'SolarNova';
    this.school = 'solar';
    this.form = 'Nova';
    this.tier = 3;
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_solar_nova';
