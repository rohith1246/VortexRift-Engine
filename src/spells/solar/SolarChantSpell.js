/**
 * SolarChantSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Chant
 */

class SolarChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_chant';
    this.name = 'SolarChant';
    this.school = 'solar';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 126;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 329;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_solar_chant';
...
module.exports = { SolarChantSpell };
