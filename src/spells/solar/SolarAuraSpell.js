/**
 * SolarAuraSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Aura
 */

class SolarAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_aura';
    this.name = 'SolarAura';
    this.school = 'solar';
    this.form = 'Aura';
    this.tier = 3;
    this.baseManaCost = config.mana || 132;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 347;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_solar_aura';
