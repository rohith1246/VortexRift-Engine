/**
 * SolarBlastSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Blast
 */

class SolarBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_solar_blast';
...
module.exports = { SolarBlastSpell };
