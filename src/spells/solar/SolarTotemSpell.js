/**
 * SolarTotemSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Totem
 */

class SolarTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_solar_totem';
...
module.exports = { SolarTotemSpell };
