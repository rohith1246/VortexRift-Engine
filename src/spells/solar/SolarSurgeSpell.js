/**
 * SolarSurgeSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Surge
 */

class SolarSurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_solar_surge';
...
module.exports = { SolarSurgeSpell };
