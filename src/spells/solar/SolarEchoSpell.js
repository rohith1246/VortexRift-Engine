/**
 * SolarEchoSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Echo
 */

class SolarEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_echo';
    this.name = 'SolarEcho';
    this.school = 'solar';
    this.form = 'Echo';
    this.tier = 1;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_solar_echo';
