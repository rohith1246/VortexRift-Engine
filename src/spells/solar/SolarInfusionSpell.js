/**
 * SolarInfusionSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Infusion
 */

class SolarInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_infusion';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_solar_infusion';
...
module.exports = { SolarInfusionSpell };
