/**
 * SolarShieldSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Shield
 */

class SolarShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_solar_shield';
...
module.exports = { SolarShieldSpell };
