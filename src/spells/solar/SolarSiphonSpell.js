/**
 * SolarSiphonSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Siphon
 */

class SolarSiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_siphon';
    this.name = 'SolarSiphon';
    this.school = 'solar';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 123;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_solar_siphon';
...
module.exports = { SolarSiphonSpell };
