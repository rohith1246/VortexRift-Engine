/**
 * SolarFieldSpell.js - Tactical Combat Spell Specification
 * School: solar | Form: Field
 */

class SolarFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_solar_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_solar_field';
...
module.exports = { SolarFieldSpell };
