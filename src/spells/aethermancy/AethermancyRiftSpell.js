/**
 * AethermancyRiftSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Rift
 */

class AethermancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aethermancy_rift';
...
module.exports = { AethermancyRiftSpell };
