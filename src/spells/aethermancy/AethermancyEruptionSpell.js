/**
 * AethermancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Eruption
 */

class AethermancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_eruption';
    this.name = 'AethermancyEruption';
    this.school = 'aethermancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 125;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 332;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aethermancy_eruption';
...
module.exports = { AethermancyEruptionSpell };
