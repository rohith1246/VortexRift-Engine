/**
 * AethermancyShieldSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Shield
 */

class AethermancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_shield';
    this.name = 'AethermancyShield';
    this.school = 'aethermancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 89;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aethermancy_shield';
...
module.exports = { AethermancyShieldSpell };
