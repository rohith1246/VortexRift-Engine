/**
 * AethermancyAuraSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Aura
 */

class AethermancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_aura';
    this.name = 'AethermancyAura';
    this.school = 'aethermancy';
    this.form = 'Aura';
    this.tier = 3;
    this.baseManaCost = config.mana || 122;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 323;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aethermancy_aura';
...
module.exports = { AethermancyAuraSpell };
