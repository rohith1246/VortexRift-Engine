/**
 * AethermancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Infusion
 */

class AethermancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_infusion';
    this.name = 'AethermancyInfusion';
    this.school = 'aethermancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 92;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 233;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aethermancy_infusion';
...
module.exports = { AethermancyInfusionSpell };
