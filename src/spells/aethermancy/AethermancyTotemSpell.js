/**
 * AethermancyTotemSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Totem
 */

class AethermancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aethermancy_totem';
...
module.exports = { AethermancyTotemSpell };
