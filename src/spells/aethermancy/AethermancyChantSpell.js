/**
 * AethermancyChantSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Chant
 */

class AethermancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aethermancy_chant';
...
module.exports = { AethermancyChantSpell };
