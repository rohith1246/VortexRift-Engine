/**
 * AethermancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Barrier
 */

class AethermancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_barrier';
    ...
    this.baseDamage = config.damage || 287;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aethermancy_barrier';
...
module.exports = { AethermancyBarrierSpell };
