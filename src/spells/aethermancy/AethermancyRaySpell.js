/**
 * AethermancyRaySpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Ray
 */

class AethermancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aethermancy_ray';
...
module.exports = { AethermancyRaySpell };
