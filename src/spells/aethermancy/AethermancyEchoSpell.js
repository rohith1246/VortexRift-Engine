/**
 * AethermancyEchoSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Echo
 */

class AethermancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_echo';
    this.name = 'AethermancyEcho';
    this.school = 'aethermancy';
    this.form = 'Echo';
    this.tier = 1;
    this.baseManaCost = config.mana || 104;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 269;
    this.projectileSpeed = 18;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aethermancy_echo';
...
module.exports = { AethermancyEchoSpell };
