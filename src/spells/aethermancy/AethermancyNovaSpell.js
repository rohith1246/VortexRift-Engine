/**
 * AethermancyNovaSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Nova
 */

class AethermancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aethermancy_nova';
...
module.exports = { AethermancyNovaSpell };
