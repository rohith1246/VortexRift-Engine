/**
 * AethermancyVortexSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Vortex
 */

class AethermancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aethermancy_vortex';
...
module.exports = { AethermancyVortexSpell };
