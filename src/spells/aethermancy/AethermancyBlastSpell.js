/**
 * AethermancyBlastSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Blast
 */

class AethermancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_blast';
    ...
    this.baseDamage = config.damage || 197;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aethermancy_blast';
...
module.exports = { AethermancyBlastSpell };
