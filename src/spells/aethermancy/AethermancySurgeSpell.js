/**
 * AethermancySurgeSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Surge
 */

class AethermancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_surge';
    this.name = 'AethermancySurge';
    this.school = 'aethermancy';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 83;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 206;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aethermancy_surge';
...
module.exports = { AethermancySurgeSpell };
