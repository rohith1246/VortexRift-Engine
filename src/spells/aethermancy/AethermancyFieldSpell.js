/**
 * AethermancyFieldSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Field
 */

class AethermancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_field';
    this.name = 'AethermancyField';
    this.school = 'aethermancy';
    this.form = 'Field';
    this.tier = 2;
    this.baseManaCost = config.mana || 107;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 278;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aethermancy_field';
...
module.exports = { AethermancyFieldSpell };
