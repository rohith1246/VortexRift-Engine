/**
 * AethermancySiphonSpell.js - Tactical Combat Spell Specification
 * School: aethermancy | Form: Siphon
 */

class AethermancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aethermancy_siphon';
    this.name = 'AethermancySiphon';
    this.school = 'aethermancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 113;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aethermancy_siphon';
...
module.exports = { AethermancySiphonSpell };
