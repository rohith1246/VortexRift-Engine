/**
 * AstromancyAuraSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Aura
 */

class AstromancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_aura';
    this.name = 'AstromancyAura';
    this.school = 'astromancy';
    this.form = 'Aura';
    this.tier = 3;
    this.baseManaCost = config.mana || 117;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 311;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_astromancy_aura';
...
module.exports = { AstromancyAuraSpell };
