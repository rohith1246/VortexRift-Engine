/**
 * AstromancyNovaSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Nova
 */

class AstromancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_astromancy_nova';
...
module.exports = { AstromancyNovaSpell };
