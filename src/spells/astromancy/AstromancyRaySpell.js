/**
 * AstromancyRaySpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Ray
 */

class AstromancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_astromancy_ray';
...
module.exports = { AstromancyRaySpell };
