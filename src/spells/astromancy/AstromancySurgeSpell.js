/**
 * AstromancySurgeSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Surge
 */

class AstromancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_astromancy_surge';
...
module.exports = { AstromancySurgeSpell };
