/**
 * AstromancyEchoSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Echo
 */

class AstromancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_echo';
    this.name = 'AstromancyEcho';
    this.school = 'astromancy';
    this.form = 'Echo';
    this.tier = 1;
    this.baseManaCost = config.mana || 99;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_astromancy_echo';
...
module.exports = { AstromancyEchoSpell };
