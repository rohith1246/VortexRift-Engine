/**
 * AstromancyTotemSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Totem
 */

class AstromancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_totem';
    this.name = 'AstromancyTotem';
    this.school = 'astromancy';
    this.form = 'Totem';
    this.tier = 4;
    this.baseManaCost = config.mana || 96;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_astromancy_totem';
...
module.exports = { AstromancyTotemSpell };
