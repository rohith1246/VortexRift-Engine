/**
 * AstromancySiphonSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Siphon
 */

class AstromancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_siphon';
    this.name = 'AstromancySiphon';
    this.school = 'astromancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 108;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_astromancy_siphon';
...
module.exports = { AstromancySiphonSpell };
