/**
 * AstromancyBlastSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Blast
 */

class AstromancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_astromancy_blast';
...
module.exports = { AstromancyBlastSpell };
