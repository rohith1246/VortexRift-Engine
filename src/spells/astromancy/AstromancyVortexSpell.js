/**
 * AstromancyVortexSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Vortex
 */

class AstromancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_astromancy_vortex';
...
module.exports = { AstromancyVortexSpell };
