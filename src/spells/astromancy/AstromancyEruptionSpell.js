/**
 * AstromancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Eruption
 */

class AstromancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_eruption';
    this.name = 'AstromancyEruption';
    this.school = 'astromancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 120;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 320;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_astromancy_eruption';
...
module.exports = { AstromancyEruptionSpell };
