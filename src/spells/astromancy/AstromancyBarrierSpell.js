/**
 * AstromancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Barrier
 */

class AstromancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_barrier';
    ...
    this.baseDamage = config.damage || 275;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_astromancy_barrier';
...
module.exports = { AstromancyBarrierSpell };
