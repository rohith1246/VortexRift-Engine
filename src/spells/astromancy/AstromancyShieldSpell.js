/**
 * AstromancyShieldSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Shield
 */

class AstromancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_shield';
    this.name = 'AstromancyShield';
    this.school = 'astromancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 84;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_astromancy_shield';
...
module.exports = { AstromancyShieldSpell };
