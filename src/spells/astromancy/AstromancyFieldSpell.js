/**
 * AstromancyFieldSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Field
 */

class AstromancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_field';
    this.name = 'AstromancyField';
    this.school = 'astromancy';
    this.form = 'Field';
    this.tier = 2;
    this.baseManaCost = config.mana || 102;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 266;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_astromancy_field';
...
module.exports = { AstromancyFieldSpell };
