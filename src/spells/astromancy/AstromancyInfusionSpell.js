/**
 * AstromancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Infusion
 */

class AstromancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_infusion';
    this.name = 'AstromancyInfusion';
    this.school = 'astromancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 87;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 221;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_astromancy_infusion';
...
module.exports = { AstromancyInfusionSpell };
