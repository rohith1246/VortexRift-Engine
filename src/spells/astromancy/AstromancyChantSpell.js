/**
 * AstromancyChantSpell.js - Tactical Combat Spell Specification
 * School: astromancy | Form: Chant
 */

class AstromancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_astromancy_chant';
    this.name = 'AstromancyChant';
    this.school = 'astromancy';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 111;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 293;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_astromancy_chant';
...
module.exports = { AstromancyChantSpell };
