/**
 * NecromancyTotemSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Totem
 */

class NecromancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_totem';
    this.name = 'NecromancyTotem';
    this.school = 'necromancy';
    this.form = 'Totem';
    this.tier = 4;
    this.baseManaCost = config.mana || 61;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_necromancy_totem';
...
module.exports = { NecromancyTotemSpell };
