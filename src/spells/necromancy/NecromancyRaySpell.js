/**
 * NecromancyRaySpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Ray
 */

class NecromancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_ray';
    ...
    this.baseDamage = config.damage || 155;
    this.projectileSpeed = 12;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_necromancy_ray';
...
module.exports = { NecromancyRaySpell };
