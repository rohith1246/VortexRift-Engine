/**
 * NecromancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Eruption
 */

class NecromancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_eruption';
    this.name = 'NecromancyEruption';
    this.school = 'necromancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 85;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 236;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_necromancy_eruption';
...
module.exports = { NecromancyEruptionSpell };
