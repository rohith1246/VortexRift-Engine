/**
 * NecromancySurgeSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Surge
 */

class NecromancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_surge';
    this.name = 'NecromancySurge';
    this.school = 'necromancy';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 43;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 110;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_necromancy_surge';
...
module.exports = { NecromancySurgeSpell };
