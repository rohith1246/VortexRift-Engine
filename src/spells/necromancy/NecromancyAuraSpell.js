/**
 * NecromancyAuraSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Aura
 */

class NecromancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_necromancy_aura';
...
module.exports = { NecromancyAuraSpell };
