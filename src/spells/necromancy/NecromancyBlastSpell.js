/**
 * NecromancyBlastSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Blast
 */

class NecromancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_blast';
    this.name = 'NecromancyBlast';
    this.school = 'necromancy';
    this.form = 'Blast';
    this.tier = 1;
    this.baseManaCost = config.mana || 40;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_necromancy_blast';
...
module.exports = { NecromancyBlastSpell };
