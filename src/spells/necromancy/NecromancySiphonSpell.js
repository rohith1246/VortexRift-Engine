/**
 * NecromancySiphonSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Siphon
 */

class NecromancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_siphon';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_necromancy_siphon';
...
module.exports = { NecromancySiphonSpell };
