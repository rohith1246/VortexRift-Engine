/**
 * NecromancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Barrier
 */

class NecromancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_barrier';
    ...
    this.baseDamage = config.damage || 191;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_necromancy_barrier';
...
module.exports = { NecromancyBarrierSpell };
