/**
 * NecromancyNovaSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Nova
 */

class NecromancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_nova';
    this.name = 'NecromancyNova';
    this.school = 'necromancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 46;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 119;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_necromancy_nova';
...
module.exports = { NecromancyNovaSpell };
