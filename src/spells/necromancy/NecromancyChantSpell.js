/**
 * NecromancyChantSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Chant
 */

class NecromancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_necromancy_chant';
...
module.exports = { NecromancyChantSpell };
