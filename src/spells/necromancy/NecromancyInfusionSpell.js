/**
 * NecromancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Infusion
 */

class NecromancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_infusion';
    this.name = 'NecromancyInfusion';
    this.school = 'necromancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 52;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 137;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_necromancy_infusion';
...
module.exports = { NecromancyInfusionSpell };
