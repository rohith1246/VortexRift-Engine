/**
 * NecromancyEchoSpell.js - Tactical Combat Spell Specification
 * School: necromancy | Form: Echo
 */

class NecromancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_necromancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_necromancy_echo';
...
module.exports = { NecromancyEchoSpell };
