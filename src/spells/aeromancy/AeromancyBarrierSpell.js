/**
 * AeromancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Barrier
 */

class AeromancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aeromancy_barrier';
...
module.exports = { AeromancyBarrierSpell };
