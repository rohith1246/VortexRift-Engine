/**
 * AeromancyTotemSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Totem
 */

class AeromancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aeromancy_totem';
...
module.exports = { AeromancyTotemSpell };
