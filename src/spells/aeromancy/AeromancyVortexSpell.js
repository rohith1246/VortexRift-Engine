/**
 * AeromancyVortexSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Vortex
 */

class AeromancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aeromancy_vortex';
...
module.exports = { AeromancyVortexSpell };
