/**
 * AeromancySurgeSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Surge
 */

class AeromancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aeromancy_surge';
...
module.exports = { AeromancySurgeSpell };
