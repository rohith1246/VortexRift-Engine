/**
 * AeromancyAuraSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Aura
 */

class AeromancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aeromancy_aura';
...
module.exports = { AeromancyAuraSpell };
