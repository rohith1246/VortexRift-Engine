/**
 * AeromancyFieldSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Field
 */

class AeromancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aeromancy_field';
...
module.exports = { AeromancyFieldSpell };
