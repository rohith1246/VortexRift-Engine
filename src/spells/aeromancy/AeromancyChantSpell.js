/**
 * AeromancyChantSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Chant
 */

class AeromancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aeromancy_chant';
...
module.exports = { AeromancyChantSpell };
