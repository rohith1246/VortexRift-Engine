/**
 * AeromancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Infusion
 */

class AeromancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_infusion';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aeromancy_infusion';
...
module.exports = { AeromancyInfusionSpell };
