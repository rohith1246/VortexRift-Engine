/**
 * AeromancyBlastSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Blast
 */

class AeromancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aeromancy_blast';
...
module.exports = { AeromancyBlastSpell };
