/**
 * AeromancyEchoSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Echo
 */

class AeromancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_aeromancy_echo';
...
module.exports = { AeromancyEchoSpell };
