/**
 * AeromancyShieldSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Shield
 */

class AeromancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_shield';
    this.name = 'AeromancyShield';
    this.school = 'aeromancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 64;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aeromancy_shield';
...
module.exports = { AeromancyShieldSpell };
