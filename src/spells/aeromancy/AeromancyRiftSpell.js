/**
 * AeromancyRiftSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Rift
 */

class AeromancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_aeromancy_rift';
...
module.exports = { AeromancyRiftSpell };
