/**
 * AeromancyNovaSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Nova
 */

class AeromancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aeromancy_nova';
...
module.exports = { AeromancyNovaSpell };
