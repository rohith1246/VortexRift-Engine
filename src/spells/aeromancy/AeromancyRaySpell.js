/**
 * AeromancyRaySpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Ray
 */

class AeromancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_aeromancy_ray';
...
module.exports = { AeromancyRaySpell };
