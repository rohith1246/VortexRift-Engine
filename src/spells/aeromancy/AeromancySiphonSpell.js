/**
 * AeromancySiphonSpell.js - Tactical Combat Spell Specification
 * School: aeromancy | Form: Siphon
 */

class AeromancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_aeromancy_siphon';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_aeromancy_siphon';
...
module.exports = { AeromancySiphonSpell };
