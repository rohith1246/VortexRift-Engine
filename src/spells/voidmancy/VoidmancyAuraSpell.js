/**
 * VoidmancyAuraSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Aura
 */

class VoidmancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_voidmancy_aura';
...
module.exports = { VoidmancyAuraSpell };
