/**
 * VoidmancyFieldSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Field
 */

class VoidmancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_voidmancy_field';
...
module.exports = { VoidmancyFieldSpell };
