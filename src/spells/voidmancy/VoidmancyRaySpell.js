/**
 * VoidmancyRaySpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Ray
 */

class VoidmancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_voidmancy_ray';
...
module.exports = { VoidmancyRaySpell };
