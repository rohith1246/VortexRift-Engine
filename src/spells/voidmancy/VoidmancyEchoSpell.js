/**
 * VoidmancyEchoSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Echo
 */

class VoidmancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_voidmancy_echo';
...
module.exports = { VoidmancyEchoSpell };
