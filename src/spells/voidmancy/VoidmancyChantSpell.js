/**
 * VoidmancyChantSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Chant
 */

class VoidmancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_chant';
    ...
    this.baseDamage = config.damage || 257;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_voidmancy_chant';
...
module.exports = { VoidmancyChantSpell };
