/**
 * VoidmancyTotemSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Totem
 */

class VoidmancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_voidmancy_totem';
...
module.exports = { VoidmancyTotemSpell };
