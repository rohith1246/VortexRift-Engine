/**
 * VoidmancyVortexSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Vortex
 */

class VoidmancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_voidmancy_vortex';
...
module.exports = { VoidmancyVortexSpell };
