/**
 * VoidmancySurgeSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Surge
 */

class VoidmancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_voidmancy_surge';
...
module.exports = { VoidmancySurgeSpell };
