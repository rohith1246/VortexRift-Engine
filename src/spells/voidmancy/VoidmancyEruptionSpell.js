/**
 * VoidmancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Eruption
 */

class VoidmancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_eruption';
    this.name = 'VoidmancyEruption';
    this.school = 'voidmancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 105;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 284;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_voidmancy_eruption';
...
module.exports = { VoidmancyEruptionSpell };
