/**
 * VoidmancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Infusion
 */

class VoidmancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_infusion';
    this.name = 'VoidmancyInfusion';
    this.school = 'voidmancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 72;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 185;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_voidmancy_infusion';
...
module.exports = { VoidmancyInfusionSpell };
