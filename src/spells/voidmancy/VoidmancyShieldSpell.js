/**
 * VoidmancyShieldSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Shield
 */

class VoidmancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_voidmancy_shield';
...
module.exports = { VoidmancyShieldSpell };
