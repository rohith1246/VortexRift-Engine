/**
 * VoidmancyNovaSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Nova
 */

class VoidmancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_voidmancy_nova';
...
module.exports = { VoidmancyNovaSpell };
