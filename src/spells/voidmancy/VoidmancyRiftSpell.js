/**
 * VoidmancyRiftSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Rift
 */

class VoidmancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_voidmancy_rift';
...
module.exports = { VoidmancyRiftSpell };
