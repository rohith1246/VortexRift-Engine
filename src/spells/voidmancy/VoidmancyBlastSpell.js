/**
 * VoidmancyBlastSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Blast
 */

class VoidmancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_voidmancy_blast';
...
module.exports = { VoidmancyBlastSpell };
