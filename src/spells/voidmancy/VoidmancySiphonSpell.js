/**
 * VoidmancySiphonSpell.js - Tactical Combat Spell Specification
 * School: voidmancy | Form: Siphon
 */

class VoidmancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_voidmancy_siphon';
    this.name = 'VoidmancySiphon';
    this.school = 'voidmancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 93;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_voidmancy_siphon';
...
module.exports = { VoidmancySiphonSpell };
