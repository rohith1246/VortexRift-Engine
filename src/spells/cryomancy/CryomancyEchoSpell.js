/**
 * CryomancyEchoSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Echo
 */

class CryomancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_cryomancy_echo';
...
module.exports = { CryomancyEchoSpell };
