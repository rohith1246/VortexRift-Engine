/**
 * CryomancySiphonSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Siphon
 */

class CryomancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_siphon';
    this.name = 'CryomancySiphon';
    this.school = 'cryomancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 63;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_cryomancy_siphon';
...
module.exports = { CryomancySiphonSpell };
