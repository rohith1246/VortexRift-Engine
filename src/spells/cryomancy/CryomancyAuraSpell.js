/**
 * CryomancyAuraSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Aura
 */

class CryomancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_cryomancy_aura';
...
module.exports = { CryomancyAuraSpell };
