/**
 * CryomancyChantSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Chant
 */

class CryomancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_cryomancy_chant';
...
module.exports = { CryomancyChantSpell };
