/**
 * CryomancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Infusion
 */

class CryomancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_infusion';
    this.name = 'CryomancyInfusion';
    this.school = 'cryomancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 42;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 113;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_cryomancy_infusion';
...
module.exports = { CryomancyInfusionSpell };
