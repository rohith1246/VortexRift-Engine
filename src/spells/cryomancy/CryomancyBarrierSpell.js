/**
 * CryomancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Barrier
 */

class CryomancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_barrier';
    ...
    this.baseDamage = config.damage || 167;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_cryomancy_barrier';
...
module.exports = { CryomancyBarrierSpell };
