/**
 * CryomancyFieldSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Field
 */

class CryomancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_cryomancy_field';
...
module.exports = { CryomancyFieldSpell };
