/**
 * CryomancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Eruption
 */

class CryomancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_eruption';
    this.name = 'CryomancyEruption';
    this.school = 'cryomancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 75;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 212;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_cryomancy_eruption';
...
module.exports = { CryomancyEruptionSpell };
