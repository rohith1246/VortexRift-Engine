/**
 * CryomancyTotemSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Totem
 */

class CryomancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_cryomancy_totem';
...
module.exports = { CryomancyTotemSpell };
