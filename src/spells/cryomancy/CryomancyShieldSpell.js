/**
 * CryomancyShieldSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Shield
 */

class CryomancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_shield';
    this.name = 'CryomancyShield';
    this.school = 'cryomancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 39;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 104;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_cryomancy_shield';
...
module.exports = { CryomancyShieldSpell };
