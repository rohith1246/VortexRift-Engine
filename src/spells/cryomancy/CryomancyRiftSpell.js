/**
 * CryomancyRiftSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Rift
 */

class CryomancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_cryomancy_rift';
...
module.exports = { CryomancyRiftSpell };
