/**
 * CryomancyVortexSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Vortex
 */

class CryomancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_cryomancy_vortex';
...
module.exports = { CryomancyVortexSpell };
