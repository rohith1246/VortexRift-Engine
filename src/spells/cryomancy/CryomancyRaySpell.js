/**
 * CryomancyRaySpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Ray
 */

class CryomancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_cryomancy_ray';
...
module.exports = { CryomancyRaySpell };
