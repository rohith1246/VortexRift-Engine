/**
 * CryomancyNovaSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Nova
 */

class CryomancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_nova';
    this.name = 'CryomancyNova';
    this.school = 'cryomancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 36;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 95;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_cryomancy_nova';
...
module.exports = { CryomancyNovaSpell };
