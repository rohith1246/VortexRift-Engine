/**
 * CryomancyBlastSpell.js - Tactical Combat Spell Specification
 * School: cryomancy | Form: Blast
 */

class CryomancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_cryomancy_blast';
    this.name = 'CryomancyBlast';
    this.school = 'cryomancy';
    this.form = 'Blast';
    this.tier = 1;
    this.baseManaCost = config.mana || 30;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 77;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_cryomancy_blast';
...
module.exports = { CryomancyBlastSpell };
