/**
 * TechnomancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Infusion
 */

class TechnomancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_infusion';
    this.name = 'TechnomancyInfusion';
    this.school = 'technomancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 82;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 209;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_technomancy_infusion';
...
module.exports = { TechnomancyInfusionSpell };
