/**
 * TechnomancyRiftSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Rift
 */

class TechnomancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_technomancy_rift';
...
module.exports = { TechnomancyRiftSpell };
