/**
 * TechnomancyAuraSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Aura
 */

class TechnomancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_technomancy_aura';
...
module.exports = { TechnomancyAuraSpell };
