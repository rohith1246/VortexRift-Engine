/**
 * TechnomancyBlastSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Blast
 */

class TechnomancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_blast';
    ...
    this.baseDamage = config.damage || 173;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_technomancy_blast';
...
module.exports = { TechnomancyBlastSpell };
