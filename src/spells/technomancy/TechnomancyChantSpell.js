/**
 * TechnomancyChantSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Chant
 */

class TechnomancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_technomancy_chant';
...
module.exports = { TechnomancyChantSpell };
