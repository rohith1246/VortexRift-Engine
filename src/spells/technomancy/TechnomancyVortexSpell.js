/**
 * TechnomancyVortexSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Vortex
 */

class TechnomancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_technomancy_vortex';
...
module.exports = { TechnomancyVortexSpell };
