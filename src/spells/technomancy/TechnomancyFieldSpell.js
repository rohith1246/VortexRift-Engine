/**
 * TechnomancyFieldSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Field
 */

class TechnomancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_field';
    this.name = 'TechnomancyField';
    this.school = 'technomancy';
    this.form = 'Field';
    this.tier = 2;
    this.baseManaCost = config.mana || 97;
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_technomancy_field';
...
module.exports = { TechnomancyFieldSpell };
