/**
 * TechnomancyTotemSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Totem
 */

class TechnomancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_totem';
    this.name = 'TechnomancyTotem';
    this.school = 'technomancy';
    this.form = 'Totem';
    this.tier = 4;
    this.baseManaCost = config.mana || 91;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_technomancy_totem';
...
module.exports = { TechnomancyTotemSpell };
