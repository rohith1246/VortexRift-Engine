/**
 * TechnomancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Barrier
 */

class TechnomancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_technomancy_barrier';
...
module.exports = { TechnomancyBarrierSpell };
