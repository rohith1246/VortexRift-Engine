/**
 * TechnomancySiphonSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Siphon
 */

class TechnomancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_siphon';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_technomancy_siphon';
...
module.exports = { TechnomancySiphonSpell };
