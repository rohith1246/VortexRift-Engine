/**
 * TechnomancyShieldSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Shield
 */

class TechnomancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_technomancy_shield';
...
module.exports = { TechnomancyShieldSpell };
