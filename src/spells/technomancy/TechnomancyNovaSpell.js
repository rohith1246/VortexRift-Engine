/**
 * TechnomancyNovaSpell.js - Tactical Combat Spell Specification
 * School: technomancy | Form: Nova
 */

class TechnomancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_technomancy_nova';
    this.name = 'TechnomancyNova';
    this.school = 'technomancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 76;
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_technomancy_nova';
...
module.exports = { TechnomancyNovaSpell };
