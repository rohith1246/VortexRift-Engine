/**
 * ElectromancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Infusion
 */

class ElectromancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_infusion';
    this.name = 'ElectromancyInfusion';
    this.school = 'electromancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 47;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 125;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_electromancy_infusion';
...
module.exports = { ElectromancyInfusionSpell };
