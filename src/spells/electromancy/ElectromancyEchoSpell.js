/**
 * ElectromancyEchoSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Echo
 */

class ElectromancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_echo';
    this.name = 'ElectromancyEcho';
    this.school = 'electromancy';
    this.form = 'Echo';
    this.tier = 1;
    this.baseManaCost = config.mana || 59;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_electromancy_echo';
...
module.exports = { ElectromancyEchoSpell };
