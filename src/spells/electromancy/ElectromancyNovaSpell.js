/**
 * ElectromancyNovaSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Nova
 */

class ElectromancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_nova';
    this.name = 'ElectromancyNova';
    this.school = 'electromancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 41;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 107;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_electromancy_nova';
...
module.exports = { ElectromancyNovaSpell };
