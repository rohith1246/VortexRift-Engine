/**
 * ElectromancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Barrier
 */

class ElectromancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_electromancy_barrier';
...
module.exports = { ElectromancyBarrierSpell };
