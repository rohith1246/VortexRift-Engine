/**
 * ElectromancySurgeSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Surge
 */

class ElectromancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_surge';
    this.name = 'ElectromancySurge';
    this.school = 'electromancy';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 38;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 98;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_electromancy_surge';
...
module.exports = { ElectromancySurgeSpell };
