/**
 * ElectromancyVortexSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Vortex
 */

class ElectromancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_vortex';
    this.name = 'ElectromancyVortex';
    this.school = 'electromancy';
    this.form = 'Vortex';
    this.tier = 2;
    this.baseManaCost = config.mana || 50;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 134;
    this.projectileSpeed = 27;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_electromancy_vortex';
...
module.exports = { ElectromancyVortexSpell };
