/**
 * ElectromancyTotemSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Totem
 */

class ElectromancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_totem';
    this.name = 'ElectromancyTotem';
    this.school = 'electromancy';
    this.form = 'Totem';
    this.tier = 4;
    this.baseManaCost = config.mana || 56;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 152;
    this.projectileSpeed = 15;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_electromancy_totem';
...
module.exports = { ElectromancyTotemSpell };
