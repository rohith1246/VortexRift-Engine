/**
 * ElectromancyRaySpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Ray
 */

class ElectromancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_ray';
    this.name = 'ElectromancyRay';
    this.school = 'electromancy';
    this.form = 'Ray';
    this.tier = 3;
    this.baseManaCost = config.mana || 53;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 143;
    this.projectileSpeed = 12;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_electromancy_ray';
...
module.exports = { ElectromancyRaySpell };
