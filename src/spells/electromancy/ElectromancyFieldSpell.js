/**
 * ElectromancyFieldSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Field
 */

class ElectromancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_field';
    this.name = 'ElectromancyField';
    this.school = 'electromancy';
    this.form = 'Field';
    this.tier = 2;
    this.baseManaCost = config.mana || 62;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 170;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_electromancy_field';
...
module.exports = { ElectromancyFieldSpell };
