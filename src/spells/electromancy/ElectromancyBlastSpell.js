/**
 * ElectromancyBlastSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Blast
 */

class ElectromancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_blast';
    this.name = 'ElectromancyBlast';
    this.school = 'electromancy';
    this.form = 'Blast';
    this.tier = 1;
    this.baseManaCost = config.mana || 35;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 89;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_electromancy_blast';
...
module.exports = { ElectromancyBlastSpell };
