/**
 * ElectromancyShieldSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Shield
 */

class ElectromancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_shield';
    this.name = 'ElectromancyShield';
    this.school = 'electromancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 44;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 116;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_electromancy_shield';
...
module.exports = { ElectromancyShieldSpell };
