/**
 * ElectromancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Eruption
 */

class ElectromancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_eruption';
    this.name = 'ElectromancyEruption';
    this.school = 'electromancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 80;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 224;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_electromancy_eruption';
...
module.exports = { ElectromancyEruptionSpell };
