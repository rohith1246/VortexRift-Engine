/**
 * ElectromancySiphonSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Siphon
 */

class ElectromancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_siphon';
    this.name = 'ElectromancySiphon';
    this.school = 'electromancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 68;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 188;
    this.projectileSpeed = 27;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_electromancy_siphon';
...
module.exports = { ElectromancySiphonSpell };
