/**
 * ElectromancyChantSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Chant
 */

class ElectromancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_electromancy_chant';
...
module.exports = { ElectromancyChantSpell };
