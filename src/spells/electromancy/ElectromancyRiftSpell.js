/**
 * ElectromancyRiftSpell.js - Tactical Combat Spell Specification
 * School: electromancy | Form: Rift
 */

class ElectromancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_electromancy_rift';
    this.name = 'ElectromancyRift';
    this.school = 'electromancy';
    this.form = 'Rift';
    this.tier = 2;
    this.baseManaCost = config.mana || 74;
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_electromancy_rift';
...
module.exports = { ElectromancyRiftSpell };
