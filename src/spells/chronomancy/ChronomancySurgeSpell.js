/**
 * ChronomancySurgeSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Surge
 */

class ChronomancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_surge';
    this.name = 'ChronomancySurge';
    this.school = 'chronomancy';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 48;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 122;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_chronomancy_surge';
...
module.exports = { ChronomancySurgeSpell };
