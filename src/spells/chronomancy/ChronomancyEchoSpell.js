/**
 * ChronomancyEchoSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Echo
 */

class ChronomancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_echo';
    this.name = 'ChronomancyEcho';
    this.school = 'chronomancy';
    this.form = 'Echo';
    this.tier = 1;
    this.baseManaCost = config.mana || 69;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_chronomancy_echo';
...
module.exports = { ChronomancyEchoSpell };
