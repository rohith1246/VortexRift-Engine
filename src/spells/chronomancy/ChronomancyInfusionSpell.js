/**
 * ChronomancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Infusion
 */

class ChronomancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_infusion';
    this.name = 'ChronomancyInfusion';
    this.school = 'chronomancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 57;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 149;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_chronomancy_infusion';
...
module.exports = { ChronomancyInfusionSpell };
