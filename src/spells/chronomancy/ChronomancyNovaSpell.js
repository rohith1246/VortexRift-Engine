/**
 * ChronomancyNovaSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Nova
 */

class ChronomancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_nova';
    this.name = 'ChronomancyNova';
    this.school = 'chronomancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 51;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 131;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_chronomancy_nova';
...
module.exports = { ChronomancyNovaSpell };
