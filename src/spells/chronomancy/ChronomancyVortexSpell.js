/**
 * ChronomancyVortexSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Vortex
 */

class ChronomancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_vortex';
    this.name = 'ChronomancyVortex';
    this.school = 'chronomancy';
    this.form = 'Vortex';
    this.tier = 2;
    this.baseManaCost = config.mana || 60;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 158;
    this.projectileSpeed = 27;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_chronomancy_vortex';
...
module.exports = { ChronomancyVortexSpell };
