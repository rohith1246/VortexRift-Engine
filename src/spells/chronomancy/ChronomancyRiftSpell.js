/**
 * ChronomancyRiftSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Rift
 */

class ChronomancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_rift';
    ...
    this.baseDamage = config.damage || 230;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_chronomancy_rift';
...
module.exports = { ChronomancyRiftSpell };
