/**
 * ChronomancyAuraSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Aura
 */

class ChronomancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_chronomancy_aura';
...
module.exports = { ChronomancyAuraSpell };
