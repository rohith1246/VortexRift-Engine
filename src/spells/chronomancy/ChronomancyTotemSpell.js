/**
 * ChronomancyTotemSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Totem
 */

class ChronomancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_totem';
    this.name = 'ChronomancyTotem';
    this.school = 'chronomancy';
    this.form = 'Totem';
    this.tier = 4;
    this.baseManaCost = config.mana || 66;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 176;
    this.projectileSpeed = 15;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_chronomancy_totem';
...
module.exports = { ChronomancyTotemSpell };
