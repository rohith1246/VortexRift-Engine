/**
 * ChronomancyChantSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Chant
 */

class ChronomancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_chant';
    this.name = 'ChronomancyChant';
    this.school = 'chronomancy';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 81;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_chronomancy_chant';
...
module.exports = { ChronomancyChantSpell };
