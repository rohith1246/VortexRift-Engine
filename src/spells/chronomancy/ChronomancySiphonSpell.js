/**
 * ChronomancySiphonSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Siphon
 */

class ChronomancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_siphon';
    this.name = 'ChronomancySiphon';
    this.school = 'chronomancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 78;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_chronomancy_siphon';
...
module.exports = { ChronomancySiphonSpell };
