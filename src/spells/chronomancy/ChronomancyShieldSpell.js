/**
 * ChronomancyShieldSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Shield
 */

class ChronomancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_shield';
    this.name = 'ChronomancyShield';
    this.school = 'chronomancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 54;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 140;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_chronomancy_shield';
...
module.exports = { ChronomancyShieldSpell };
