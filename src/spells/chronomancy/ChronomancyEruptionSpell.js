/**
 * ChronomancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Eruption
 */

class ChronomancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_eruption';
    this.name = 'ChronomancyEruption';
    ...
    this.baseDamage = config.damage || 248;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_chronomancy_eruption';
...
module.exports = { ChronomancyEruptionSpell };
