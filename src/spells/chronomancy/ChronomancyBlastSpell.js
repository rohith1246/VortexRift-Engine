/**
 * ChronomancyBlastSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Blast
 */

class ChronomancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_blast';
    this.name = 'ChronomancyBlast';
    this.school = 'chronomancy';
    this.form = 'Blast';
    this.tier = 1;
    this.baseManaCost = config.mana || 45;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_chronomancy_blast';
...
module.exports = { ChronomancyBlastSpell };
