/**
 * ChronomancyFieldSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Field
 */

class ChronomancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_field';
    ...
    this.baseDamage = config.damage || 194;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_chronomancy_field';
...
module.exports = { ChronomancyFieldSpell };
