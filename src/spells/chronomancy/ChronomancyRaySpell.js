/**
 * ChronomancyRaySpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Ray
 */

class ChronomancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_chronomancy_ray';
...
module.exports = { ChronomancyRaySpell };
