/**
 * ChronomancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: chronomancy | Form: Barrier
 */

class ChronomancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_chronomancy_barrier';
    ...
    this.baseDamage = config.damage || 203;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_chronomancy_barrier';
...
module.exports = { ChronomancyBarrierSpell };
