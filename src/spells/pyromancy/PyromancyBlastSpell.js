/**
 * PyromancyBlastSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Blast
 */

class PyromancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_blast';
    this.name = 'PyromancyBlast';
    this.school = 'pyromancy';
    this.form = 'Blast';
    this.tier = 1;
    this.baseManaCost = config.mana || 25;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 65;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_pyromancy_blast';
...
module.exports = { PyromancyBlastSpell };
