/**
 * PyromancyFieldSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Field
 */

class PyromancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_pyromancy_field';
...
module.exports = { PyromancyFieldSpell };
