/**
 * PyromancyRiftSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Rift
 */

class PyromancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_pyromancy_rift';
...
module.exports = { PyromancyRiftSpell };
