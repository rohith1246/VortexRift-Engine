/**
 * PyromancyNovaSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Nova
 */

class PyromancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_nova';
    this.name = 'PyromancyNova';
    this.school = 'pyromancy';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 31;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 83;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_pyromancy_nova';
...
module.exports = { PyromancyNovaSpell };
