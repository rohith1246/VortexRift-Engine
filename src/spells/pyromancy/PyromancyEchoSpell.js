/**
 * PyromancyEchoSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Echo
 */

class PyromancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_pyromancy_echo';
...
module.exports = { PyromancyEchoSpell };
