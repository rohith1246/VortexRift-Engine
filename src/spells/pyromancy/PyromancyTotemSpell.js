/**
 * PyromancyTotemSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Totem
 */

class PyromancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_pyromancy_totem';
...
module.exports = { PyromancyTotemSpell };
