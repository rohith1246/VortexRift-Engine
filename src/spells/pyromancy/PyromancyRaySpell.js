/**
 * PyromancyRaySpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Ray
 */

class PyromancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_pyromancy_ray';
...
module.exports = { PyromancyRaySpell };
