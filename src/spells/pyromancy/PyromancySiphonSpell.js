/**
 * PyromancySiphonSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Siphon
 */

class PyromancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_siphon';
    this.name = 'PyromancySiphon';
    this.school = 'pyromancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 58;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 164;
    this.projectileSpeed = 27;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_pyromancy_siphon';
...
module.exports = { PyromancySiphonSpell };
