/**
 * PyromancyShieldSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Shield
 */

class PyromancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_shield';
    this.name = 'PyromancyShield';
    this.school = 'pyromancy';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 34;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 92;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_pyromancy_shield';
...
module.exports = { PyromancyShieldSpell };
