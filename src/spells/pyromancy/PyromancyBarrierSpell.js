/**
 * PyromancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Barrier
 */

class PyromancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_pyromancy_barrier';
...
module.exports = { PyromancyBarrierSpell };
