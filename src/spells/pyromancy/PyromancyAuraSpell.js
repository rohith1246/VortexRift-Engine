/**
 * PyromancyAuraSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Aura
 */

class PyromancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_pyromancy_aura';
...
module.exports = { PyromancyAuraSpell };
