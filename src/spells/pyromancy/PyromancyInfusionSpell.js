/**
 * PyromancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Infusion
 */

class PyromancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_infusion';
    this.name = 'PyromancyInfusion';
    this.school = 'pyromancy';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 37;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 101;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_pyromancy_infusion';
...
module.exports = { PyromancyInfusionSpell };
