/**
 * PyromancyChantSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Chant
 */

class PyromancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_pyromancy_chant';
...
module.exports = { PyromancyChantSpell };
