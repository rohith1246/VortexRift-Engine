/**
 * PyromancyVortexSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Vortex
 */

class PyromancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_pyromancy_vortex';
...
module.exports = { PyromancyVortexSpell };
