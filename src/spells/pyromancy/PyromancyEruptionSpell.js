/**
 * PyromancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Eruption
 */

class PyromancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_eruption';
    this.name = 'PyromancyEruption';
    this.school = 'pyromancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 70;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 200;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_pyromancy_eruption';
...
module.exports = { PyromancyEruptionSpell };
