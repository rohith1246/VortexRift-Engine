/**
 * PyromancySurgeSpell.js - Tactical Combat Spell Specification
 * School: pyromancy | Form: Surge
 */

class PyromancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_pyromancy_surge';
    this.name = 'PyromancySurge';
    this.school = 'pyromancy';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 28;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 74;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_pyromancy_surge';
...
module.exports = { PyromancySurgeSpell };
