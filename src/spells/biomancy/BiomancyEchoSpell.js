/**
 * BiomancyEchoSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Echo
 */

class BiomancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_biomancy_echo';
...
module.exports = { BiomancyEchoSpell };
