/**
 * BiomancyChantSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Chant
 */

class BiomancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_chant';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_biomancy_chant';
...
module.exports = { BiomancyChantSpell };
