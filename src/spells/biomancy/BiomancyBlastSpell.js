/**
 * BiomancyBlastSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Blast
 */

class BiomancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_biomancy_blast';
...
module.exports = { BiomancyBlastSpell };
