/**
 * BiomancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Barrier
 */

class BiomancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_biomancy_barrier';
...
module.exports = { BiomancyBarrierSpell };
