/**
 * BiomancyShieldSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Shield
 */

class BiomancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_biomancy_shield';
...
module.exports = { BiomancyShieldSpell };
