/**
 * BiomancySiphonSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Siphon
 */

class BiomancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_siphon';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_biomancy_siphon';
...
module.exports = { BiomancySiphonSpell };
