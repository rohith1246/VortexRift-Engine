/**
 * BiomancyRaySpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Ray
 */

class BiomancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_biomancy_ray';
...
module.exports = { BiomancyRaySpell };
