/**
 * BiomancyVortexSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Vortex
 */

class BiomancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_biomancy_vortex';
...
module.exports = { BiomancyVortexSpell };
