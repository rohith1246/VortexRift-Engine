/**
 * BiomancyTotemSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Totem
 */

class BiomancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_biomancy_totem';
...
module.exports = { BiomancyTotemSpell };
