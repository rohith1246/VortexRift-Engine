/**
 * BiomancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Eruption
 */

class BiomancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_eruption';
    this.name = 'BiomancyEruption';
    this.school = 'biomancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 110;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_biomancy_eruption';
...
module.exports = { BiomancyEruptionSpell };
