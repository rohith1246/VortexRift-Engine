/**
 * BiomancyRiftSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Rift
 */

class BiomancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_biomancy_rift';
...
module.exports = { BiomancyRiftSpell };
