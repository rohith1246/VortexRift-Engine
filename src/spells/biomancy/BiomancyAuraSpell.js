/**
 * BiomancyAuraSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Aura
 */

class BiomancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_biomancy_aura';
...
module.exports = { BiomancyAuraSpell };
