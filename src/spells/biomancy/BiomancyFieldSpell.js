/**
 * BiomancyFieldSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Field
 */

class BiomancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_biomancy_field';
...
module.exports = { BiomancyFieldSpell };
