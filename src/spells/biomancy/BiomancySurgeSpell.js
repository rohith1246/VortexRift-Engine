/**
 * BiomancySurgeSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Surge
 */

class BiomancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_biomancy_surge';
...
module.exports = { BiomancySurgeSpell };
