/**
 * BiomancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: biomancy | Form: Infusion
 */

class BiomancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_biomancy_infusion';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_biomancy_infusion';
...
module.exports = { BiomancyInfusionSpell };
