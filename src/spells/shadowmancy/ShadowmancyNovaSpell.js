/**
 * ShadowmancyNovaSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Nova
 */

class ShadowmancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_shadowmancy_nova';
...
module.exports = { ShadowmancyNovaSpell };
