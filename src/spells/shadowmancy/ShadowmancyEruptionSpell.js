/**
 * ShadowmancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Eruption
 */

class ShadowmancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_eruption';
    this.name = 'ShadowmancyEruption';
    this.school = 'shadowmancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 130;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 344;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_shadowmancy_eruption';
...
module.exports = { ShadowmancyEruptionSpell };
