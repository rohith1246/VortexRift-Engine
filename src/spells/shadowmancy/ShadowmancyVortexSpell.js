/**
 * ShadowmancyVortexSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Vortex
 */

class ShadowmancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_shadowmancy_vortex';
...
module.exports = { ShadowmancyVortexSpell };
