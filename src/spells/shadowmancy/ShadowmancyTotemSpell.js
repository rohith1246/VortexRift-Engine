/**
 * ShadowmancyTotemSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Totem
 */

class ShadowmancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_shadowmancy_totem';
...
module.exports = { ShadowmancyTotemSpell };
