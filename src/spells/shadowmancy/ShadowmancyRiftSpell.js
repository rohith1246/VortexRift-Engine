/**
 * ShadowmancyRiftSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Rift
 */

class ShadowmancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_rift';
    this.name = 'ShadowmancyRift';
    this.school = 'shadowmancy';
    this.form = 'Rift';
    this.tier = 2;
    this.baseManaCost = config.mana || 124;
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_shadowmancy_rift';
...
module.exports = { ShadowmancyRiftSpell };
