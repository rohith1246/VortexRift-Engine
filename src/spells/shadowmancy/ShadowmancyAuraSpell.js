/**
 * ShadowmancyAuraSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Aura
 */

class ShadowmancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_shadowmancy_aura';
...
module.exports = { ShadowmancyAuraSpell };
