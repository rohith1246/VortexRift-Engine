/**
 * ShadowmancyShieldSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Shield
 */

class ShadowmancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_shadowmancy_shield';
...
module.exports = { ShadowmancyShieldSpell };
