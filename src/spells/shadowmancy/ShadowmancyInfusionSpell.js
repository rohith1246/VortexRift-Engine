/**
 * ShadowmancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Infusion
 */

class ShadowmancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_infusion';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_shadowmancy_infusion';
...
module.exports = { ShadowmancyInfusionSpell };
