/**
 * ShadowmancyFieldSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Field
 */

class ShadowmancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_shadowmancy_field';
...
module.exports = { ShadowmancyFieldSpell };
