/**
 * ShadowmancySiphonSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Siphon
 */

class ShadowmancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_siphon';
    this.name = 'ShadowmancySiphon';
    this.school = 'shadowmancy';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 118;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_shadowmancy_siphon';
...
module.exports = { ShadowmancySiphonSpell };
