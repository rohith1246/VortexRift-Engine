/**
 * ShadowmancyRaySpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Ray
 */

class ShadowmancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_shadowmancy_ray';
...
module.exports = { ShadowmancyRaySpell };
