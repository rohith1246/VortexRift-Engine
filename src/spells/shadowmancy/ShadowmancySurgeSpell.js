/**
 * ShadowmancySurgeSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Surge
 */

class ShadowmancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_shadowmancy_surge';
...
module.exports = { ShadowmancySurgeSpell };
