/**
 * ShadowmancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Barrier
 */

class ShadowmancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_barrier';
    ...
    this.baseDamage = config.damage || 299;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_shadowmancy_barrier';
...
module.exports = { ShadowmancyBarrierSpell };
