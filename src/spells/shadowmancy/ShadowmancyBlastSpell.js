/**
 * ShadowmancyBlastSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Blast
 */

class ShadowmancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_shadowmancy_blast';
...
module.exports = { ShadowmancyBlastSpell };
