/**
 * ShadowmancyEchoSpell.js - Tactical Combat Spell Specification
 * School: shadowmancy | Form: Echo
 */

class ShadowmancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_shadowmancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_shadowmancy_echo';
...
module.exports = { ShadowmancyEchoSpell };
