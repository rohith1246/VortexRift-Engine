/**
 * GeomancySiphonSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Siphon
 */

class GeomancySiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_siphon';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_geomancy_siphon';
...
module.exports = { GeomancySiphonSpell };
