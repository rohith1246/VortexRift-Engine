/**
 * GeomancyBarrierSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Barrier
 */

class GeomancyBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_geomancy_barrier';
...
module.exports = { GeomancyBarrierSpell };
