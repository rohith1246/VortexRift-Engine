/**
 * GeomancySurgeSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Surge
 */

class GeomancySurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_surge';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_geomancy_surge';
...
module.exports = { GeomancySurgeSpell };
