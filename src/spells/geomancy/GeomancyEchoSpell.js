/**
 * GeomancyEchoSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Echo
 */

class GeomancyEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_echo';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_geomancy_echo';
...
module.exports = { GeomancyEchoSpell };
