/**
 * GeomancyShieldSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Shield
 */

class GeomancyShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_geomancy_shield';
...
module.exports = { GeomancyShieldSpell };
