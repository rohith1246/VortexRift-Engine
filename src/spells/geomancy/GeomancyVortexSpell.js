/**
 * GeomancyVortexSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Vortex
 */

class GeomancyVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_vortex';
    this.name = 'GeomancyVortex';
    this.school = 'geomancy';
    this.form = 'Vortex';
    this.tier = 2;
    this.baseManaCost = config.mana || 65;
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_geomancy_vortex';
...
module.exports = { GeomancyVortexSpell };
