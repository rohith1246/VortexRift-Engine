/**
 * GeomancyTotemSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Totem
 */

class GeomancyTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_totem';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_geomancy_totem';
...
module.exports = { GeomancyTotemSpell };
