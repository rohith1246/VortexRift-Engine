/**
 * GeomancyFieldSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Field
 */

class GeomancyFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_field';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_geomancy_field';
...
module.exports = { GeomancyFieldSpell };
