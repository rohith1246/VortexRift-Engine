/**
 * GeomancyRiftSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Rift
 */

class GeomancyRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_rift';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_geomancy_rift';
...
module.exports = { GeomancyRiftSpell };
