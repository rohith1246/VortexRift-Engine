/**
 * GeomancyRaySpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Ray
 */

class GeomancyRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_ray';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_geomancy_ray';
...
module.exports = { GeomancyRaySpell };
