/**
 * GeomancyAuraSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Aura
 */

class GeomancyAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_aura';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_geomancy_aura';
...
module.exports = { GeomancyAuraSpell };
