/**
 * GeomancyNovaSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Nova
 */

class GeomancyNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_nova';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_geomancy_nova';
...
module.exports = { GeomancyNovaSpell };
