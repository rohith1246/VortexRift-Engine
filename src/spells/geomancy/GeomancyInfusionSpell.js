/**
 * GeomancyInfusionSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Infusion
 */

class GeomancyInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_infusion';
    ...
    this.baseDamage = config.damage || 161;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_geomancy_infusion';
...
module.exports = { GeomancyInfusionSpell };
