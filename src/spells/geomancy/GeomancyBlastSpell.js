/**
 * GeomancyBlastSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Blast
 */

class GeomancyBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_geomancy_blast';
...
module.exports = { GeomancyBlastSpell };
