/**
 * GeomancyChantSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Chant
 */

class GeomancyChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_chant';
    this.name = 'GeomancyChant';
    this.school = 'geomancy';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 86;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_geomancy_chant';
...
module.exports = { GeomancyChantSpell };
