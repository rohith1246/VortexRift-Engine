/**
 * GeomancyEruptionSpell.js - Tactical Combat Spell Specification
 * School: geomancy | Form: Eruption
 */

class GeomancyEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_geomancy_eruption';
    this.name = 'GeomancyEruption';
    this.school = 'geomancy';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 95;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 260;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_geomancy_eruption';
...
module.exports = { GeomancyEruptionSpell };
