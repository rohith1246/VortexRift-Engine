/**
 * PlasmaRaySpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Ray
 */

class PlasmaRaySpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_ray';
    this.name = 'PlasmaRay';
    this.school = 'plasma';
    this.form = 'Ray';
    this.tier = 3;
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_plasma_ray';
