/**
 * PlasmaBlastSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Blast
 */

class PlasmaBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_blast';
    this.name = 'PlasmaBlast';
    this.school = 'plasma';
    this.form = 'Blast';
    this.tier = 1;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_plasma_blast';
...
module.exports = { PlasmaBlastSpell };
