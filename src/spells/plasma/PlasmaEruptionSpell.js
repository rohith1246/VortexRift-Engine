/**
 * PlasmaEruptionSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Eruption
 */

class PlasmaEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_eruption';
    this.name = 'PlasmaEruption';
    this.school = 'plasma';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 145;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 380;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_plasma_eruption';
...
module.exports = { PlasmaEruptionSpell };
