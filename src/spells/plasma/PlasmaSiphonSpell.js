/**
 * PlasmaSiphonSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Siphon
 */

class PlasmaSiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_siphon';
    this.name = 'PlasmaSiphon';
    this.school = 'plasma';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 133;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_plasma_siphon';
...
module.exports = { PlasmaSiphonSpell };
