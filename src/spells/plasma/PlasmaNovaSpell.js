/**
 * PlasmaNovaSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Nova
 */

class PlasmaNovaSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_nova';
    this.name = 'PlasmaNova';
    this.school = 'plasma';
    this.form = 'Nova';
    this.tier = 3;
    this.baseManaCost = config.mana || 106;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 263;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_plasma_nova';
...
module.exports = { PlasmaNovaSpell };
