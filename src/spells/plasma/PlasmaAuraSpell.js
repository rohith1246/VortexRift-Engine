/**
 * PlasmaAuraSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Aura
 */

class PlasmaAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_aura';
    this.name = 'PlasmaAura';
    this.school = 'plasma';
    this.form = 'Aura';
    this.tier = 3;
    this.baseManaCost = config.mana || 142;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 371;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_plasma_aura';
...
module.exports = { PlasmaAuraSpell };
