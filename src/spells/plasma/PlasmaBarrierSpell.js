/**
 * PlasmaBarrierSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Barrier
 */

class PlasmaBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_barrier';
    this.name = 'PlasmaBarrier';
    this.school = 'plasma';
    this.form = 'Barrier';
    this.tier = 3;
    ...
    this.baseDamage = config.damage || 335;
    this.projectileSpeed = 24;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_plasma_barrier';
...
module.exports = { PlasmaBarrierSpell };
