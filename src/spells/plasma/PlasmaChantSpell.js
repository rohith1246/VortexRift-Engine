/**
 * PlasmaChantSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Chant
 */

class PlasmaChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_chant';
    this.name = 'PlasmaChant';
    this.school = 'plasma';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 136;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 353;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_plasma_chant';
...
module.exports = { PlasmaChantSpell };
