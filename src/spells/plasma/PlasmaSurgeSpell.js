/**
 * PlasmaSurgeSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Surge
 */

class PlasmaSurgeSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_surge';
    this.name = 'PlasmaSurge';
    this.school = 'plasma';
    this.form = 'Surge';
    this.tier = 2;
    this.baseManaCost = config.mana || 103;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 15;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 254;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_plasma_surge';
...
module.exports = { PlasmaSurgeSpell };
