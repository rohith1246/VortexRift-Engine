/**
 * PlasmaFieldSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Field
 */

class PlasmaFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_field';
    this.name = 'PlasmaField';
    this.school = 'plasma';
    this.form = 'Field';
    this.tier = 2;
    this.baseManaCost = config.mana || 127;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 326;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_plasma_field';
...
module.exports = { PlasmaFieldSpell };
