/**
 * PlasmaRiftSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Rift
 */

class PlasmaRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_rift';
    this.name = 'PlasmaRift';
    this.school = 'plasma';
    this.form = 'Rift';
    this.tier = 2;
    this.baseManaCost = config.mana || 139;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 362;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_plasma_rift';
...
module.exports = { PlasmaRiftSpell };
