/**
 * PlasmaShieldSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Shield
 */

class PlasmaShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_shield';
    this.name = 'PlasmaShield';
    this.school = 'plasma';
    this.form = 'Shield';
    this.tier = 4;
    this.baseManaCost = config.mana || 109;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_plasma_shield';
...
module.exports = { PlasmaShieldSpell };
