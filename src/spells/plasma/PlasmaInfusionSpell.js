/**
 * PlasmaInfusionSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Infusion
 */

class PlasmaInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_infusion';
    this.name = 'PlasmaInfusion';
    this.school = 'plasma';
    this.form = 'Infusion';
    this.tier = 1;
    this.baseManaCost = config.mana || 112;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 281;
    this.projectileSpeed = 24;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_plasma_infusion';
...
module.exports = { PlasmaInfusionSpell };
