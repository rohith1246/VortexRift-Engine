/**
 * PlasmaVortexSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Vortex
 */

class PlasmaVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_vortex';
    this.name = 'PlasmaVortex';
    this.school = 'plasma';
    this.form = 'Vortex';
    this.tier = 2;
    ...
    this.baseDamage = config.damage || 290;
    this.projectileSpeed = 27;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_plasma_vortex';
...
module.exports = { PlasmaVortexSpell };
