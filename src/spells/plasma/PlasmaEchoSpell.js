/**
 * PlasmaEchoSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Echo
 */

class PlasmaEchoSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_echo';
    this.name = 'PlasmaEcho';
    this.school = 'plasma';
    this.form = 'Echo';
    this.tier = 1;
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_plasma_echo';
...
module.exports = { PlasmaEchoSpell };
