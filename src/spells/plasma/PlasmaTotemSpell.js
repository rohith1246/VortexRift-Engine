/**
 * PlasmaTotemSpell.js - Tactical Combat Spell Specification
 * School: plasma | Form: Totem
 */

class PlasmaTotemSpell {
  constructor(config = {}) {
    this.spellId = 'spell_plasma_totem';
    this.name = 'PlasmaTotem';
    this.school = 'plasma';
    this.form = 'Totem';
    this.tier = 4;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_plasma_totem';
...
module.exports = { PlasmaTotemSpell };
