/**
 * LunarFieldSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Field
 */

class LunarFieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_field';
    ...
    this.baseDamage = config.damage || 314;
    this.projectileSpeed = 21;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_lunar_field';
...
module.exports = { LunarFieldSpell };
