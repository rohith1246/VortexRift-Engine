/**
 * LunarRiftSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Rift
 */

class LunarRiftSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_rift';
    this.name = 'LunarRift';
    this.school = 'lunar';
    this.form = 'Rift';
    this.tier = 2;
    this.baseManaCost = config.mana || 134;
    this.staminaCost = config.stamina || 21;
    this.cooldownTicks = config.cooldown || 25;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 350;
    this.projectileSpeed = 15;
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_lunar_rift';
