/**
 * LunarBlastSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Blast
 */

class LunarBlastSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_blast';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_lunar_blast';
...
module.exports = { LunarBlastSpell };
