/**
 * LunarAuraSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Aura
 */

class LunarAuraSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_aura';
    this.name = 'LunarAura';
    this.school = 'lunar';
    this.form = 'Aura';
    this.tier = 3;
    this.baseManaCost = config.mana || 137;
    this.staminaCost = config.stamina || 27;
    this.cooldownTicks = config.cooldown || 30;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 359;
    this.projectileSpeed = 18;
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_lunar_aura';
