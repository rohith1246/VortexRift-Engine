/**
 * LunarChantSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Chant
 */

class LunarChantSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_chant';
    this.name = 'LunarChant';
    this.school = 'lunar';
    this.form = 'Chant';
    this.tier = 1;
    this.baseManaCost = config.mana || 131;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 20;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 341;
    this.projectileSpeed = 12;
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_lunar_chant';
...
module.exports = { LunarChantSpell };
