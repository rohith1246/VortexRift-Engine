/**
 * LunarBarrierSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Barrier
 */

class LunarBarrierSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_barrier';
    ...
    this.aoeRadius = 3.5;
    this.statusEffect = 'status_lunar_barrier';
...
module.exports = { LunarBarrierSpell };
