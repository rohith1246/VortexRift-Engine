/**
 * LunarSiphonSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Siphon
 */

class LunarSiphonSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_siphon';
    this.name = 'LunarSiphon';
    this.school = 'lunar';
    this.form = 'Siphon';
    this.tier = 4;
    this.baseManaCost = config.mana || 128;
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_lunar_siphon';
...
module.exports = { LunarSiphonSpell };
