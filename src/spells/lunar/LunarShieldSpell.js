/**
 * LunarShieldSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Shield
 */

class LunarShieldSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_shield';
    ...
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_lunar_shield';
...
module.exports = { LunarShieldSpell };
