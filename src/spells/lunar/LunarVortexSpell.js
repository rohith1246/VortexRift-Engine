/**
 * LunarVortexSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Vortex
 */

class LunarVortexSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_vortex';
    ...
    this.aoeRadius = 2.5;
    this.statusEffect = 'status_lunar_vortex';
...
module.exports = { LunarVortexSpell };
