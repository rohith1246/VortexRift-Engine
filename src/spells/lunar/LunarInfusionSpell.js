/**
 * LunarInfusionSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Infusion
 */

class LunarInfusionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_infusion';
    ...
    this.aoeRadius = 1.5;
    this.statusEffect = 'status_lunar_infusion';
...
module.exports = { LunarInfusionSpell };
