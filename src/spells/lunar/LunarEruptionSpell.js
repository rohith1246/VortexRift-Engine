/**
 * LunarEruptionSpell.js - Tactical Combat Spell Specification
 * School: lunar | Form: Eruption
 */

class LunarEruptionSpell {
  constructor(config = {}) {
    this.spellId = 'spell_lunar_eruption';
    this.name = 'LunarEruption';
    this.school = 'lunar';
    this.form = 'Eruption';
    this.tier = 4;
    this.baseManaCost = config.mana || 140;
    this.staminaCost = config.stamina || 15;
    this.cooldownTicks = config.cooldown || 10;
    this.currentCooldown = 0;
    this.baseDamage = config.damage || 368;
    this.projectileSpeed = 21;
    this.aoeRadius = 4.5;
    this.statusEffect = 'status_lunar_eruption';
...
module.exports = { LunarEruptionSpell };
