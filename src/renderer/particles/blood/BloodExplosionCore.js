/**
 * BloodExplosionCore.js - High-Performance GPU Particle Emitter: Blood -> ExplosionCore.
 */

class BloodExplosionCore {
  constructor(maxParticles = 1850) {
    this.element = 'Blood';
...
module.exports = { BloodExplosionCore };
