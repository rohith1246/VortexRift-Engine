/**
 * TerraLightningBranch.js - High-Performance GPU Particle Emitter: Terra -> LightningBranch.
 */

class TerraLightningBranch {
  constructor(maxParticles = 2200) {
    this.element = 'Terra';
...
module.exports = { TerraLightningBranch };
