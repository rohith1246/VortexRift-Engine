/**
 * FrostVortexSpout.js - High-Performance GPU Particle Emitter: Frost -> VortexSpout.
 */

class FrostVortexSpout {
  constructor(maxParticles = 750) {
    this.element = 'Frost';
...
module.exports = { FrostVortexSpout };
