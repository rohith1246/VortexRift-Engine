/**
 * VortexFluidCascade.js - High-Performance GPU Particle Emitter: Vortex -> FluidCascade.
 */

class VortexFluidCascade {
  constructor(maxParticles = 2350) {
    this.element = 'Vortex';
...
module.exports = { VortexFluidCascade };
