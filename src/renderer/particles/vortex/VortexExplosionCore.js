/**
 * VortexExplosionCore.js - High-Performance GPU Particle Emitter: Vortex -> ExplosionCore.
 */

class VortexExplosionCore {
  constructor(maxParticles = 2450) {
    this.element = 'Vortex';
...
module.exports = { VortexExplosionCore };
