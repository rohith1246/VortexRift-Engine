/**
 * VortexPillarOfLight.js - High-Performance GPU Particle Emitter: Vortex -> PillarOfLight.
 */

class VortexPillarOfLight {
  constructor(maxParticles = 2600) {
    this.element = 'Vortex';
...
module.exports = { VortexPillarOfLight };
