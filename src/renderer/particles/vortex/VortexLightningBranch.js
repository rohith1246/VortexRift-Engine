/**
 * VortexLightningBranch.js - High-Performance GPU Particle Emitter: Vortex -> LightningBranch.
 */

class VortexLightningBranch {
  constructor(maxParticles = 2300) {
    this.element = 'Vortex';
...
module.exports = { VortexLightningBranch };
