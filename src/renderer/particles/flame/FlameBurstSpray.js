/**
 * FlameBurstSpray.js - High-Performance GPU Particle Emitter: Flame -> BurstSpray.
 */

class FlameBurstSpray {
  constructor(maxParticles = 550) {
    this.element = 'Flame';
...
module.exports = { FlameBurstSpray };
