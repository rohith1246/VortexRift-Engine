/**
 * FlameVortexSpout.js - High-Performance GPU Particle Emitter: Flame -> VortexSpout.
 */

class FlameVortexSpout {
  constructor(maxParticles = 650) {
    this.element = 'Flame';
...
module.exports = { FlameVortexSpout };
