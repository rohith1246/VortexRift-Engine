/**
 * RadianceBeamTracer.js - High-Performance GPU Particle Emitter: Radiance -> BeamTracer.
 */

class RadianceBeamTracer {
  constructor(maxParticles = 1100) {
    this.element = 'Radiance';
    this.emitterType = 'BeamTracer';
...
module.exports = { RadianceBeamTracer };
