/**
 * RadianceFluidCascade.js - High-Performance GPU Particle Emitter: Radiance -> FluidCascade.
 */

class RadianceFluidCascade {
  constructor(maxParticles = 1450) {
    this.element = 'Radiance';
    this.emitterType = 'FluidCascade';
...
module.exports = { RadianceFluidCascade };
