/**
 * RadianceBurstSpray.js - High-Performance GPU Particle Emitter: Radiance -> BurstSpray.
 */

class RadianceBurstSpray {
  constructor(maxParticles = 1050) {
    this.element = 'Radiance';
    this.emitterType = 'BurstSpray';
...
module.exports = { RadianceBurstSpray };
