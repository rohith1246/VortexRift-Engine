/**
 * RadianceSparkleCloud.js - High-Performance GPU Particle Emitter: Radiance -> SparkleCloud.
 */

class RadianceSparkleCloud {
  constructor(maxParticles = 1350) {
    this.element = 'Radiance';
    this.emitterType = 'SparkleCloud';
...
module.exports = { RadianceSparkleCloud };
