/**
 * RadianceLightningBranch.js - High-Performance GPU Particle Emitter: Radiance -> LightningBranch.
 */

class RadianceLightningBranch {
...
module.exports = { RadianceLightningBranch };
