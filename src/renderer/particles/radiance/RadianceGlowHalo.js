/**
 * RadianceGlowHalo.js - High-Performance GPU Particle Emitter: Radiance -> GlowHalo.
 */

class RadianceGlowHalo {
  constructor(maxParticles = 1650) {
    this.element = 'Radiance';
    this.emitterType = 'GlowHalo';
...
module.exports = { RadianceGlowHalo };
