/**
 * RadianceVortexSpout.js - High-Performance GPU Particle Emitter: Radiance -> VortexSpout.
 */

class RadianceVortexSpout {
  constructor(maxParticles = 1150) {
    this.element = 'Radiance';
    this.emitterType = 'VortexSpout';
    this.maxParticles = maxParticles;
    this.particles = new Float32Array(maxParticles * 6); // x, y, z, vx, vy, vz
    this.lifespans = new Float32Array(maxParticles);
    this.activeCount = 0;
    this.emissionRate = 110;
  }
...
module.exports = { RadianceVortexSpout };
