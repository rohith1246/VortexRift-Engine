/**
 * RadianceAshScatter.js - High-Performance GPU Particle Emitter: Radiance -> AshScatter.
 */

class RadianceAshScatter {
  constructor(maxParticles = 1600) {
    this.element = 'Radiance';
    this.emitterType = 'AshScatter';
...
module.exports = { RadianceAshScatter };
