/**
 * RadianceSmokeColumn.js - High-Performance GPU Particle Emitter: Radiance -> SmokeColumn.
 */

class RadianceSmokeColumn {
  constructor(maxParticles = 1300) {
    this.element = 'Radiance';
    this.emitterType = 'SmokeColumn';
...
module.exports = { RadianceSmokeColumn };
