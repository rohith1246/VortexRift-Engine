/**
 * RadiancePillarOfLight.js - High-Performance GPU Particle Emitter: Radiance -> PillarOfLight.
 */

class RadiancePillarOfLight {
  constructor(maxParticles = 1700) {
    this.element = 'Radiance';
    this.emitterType = 'PillarOfLight';
    this.maxParticles = maxParticles;
    this.particles = new Float32Array(maxParticles * 6); // x, y, z, vx, vy, vz
    this.lifespans = new Float32Array(maxParticles);
    this.activeCount = 0;
    this.emissionRate = 130;
  }
...
module.exports = { RadiancePillarOfLight };
