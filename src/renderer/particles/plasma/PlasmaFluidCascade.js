/**
 * PlasmaFluidCascade.js - High-Performance GPU Particle Emitter: Plasma -> FluidCascade.
 */

class PlasmaFluidCascade {
  constructor(maxParticles = 2150) {
    this.element = 'Plasma';
...
module.exports = { PlasmaFluidCascade };
