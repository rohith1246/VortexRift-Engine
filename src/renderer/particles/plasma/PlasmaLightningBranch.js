/**
 * PlasmaLightningBranch.js - High-Performance GPU Particle Emitter: Plasma -> LightningBranch.
 */

class PlasmaLightningBranch {
  constructor(maxParticles = 2100) {
    this.element = 'Plasma';
...
module.exports = { PlasmaLightningBranch };
