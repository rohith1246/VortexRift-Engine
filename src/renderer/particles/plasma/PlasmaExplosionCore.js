/**
 * PlasmaExplosionCore.js - High-Performance GPU Particle Emitter: Plasma -> ExplosionCore.
 */

class PlasmaExplosionCore {
  constructor(maxParticles = 2250) {
    this.element = 'Plasma';
...
module.exports = { PlasmaExplosionCore };
