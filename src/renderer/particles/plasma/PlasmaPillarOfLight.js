/**
 * PlasmaPillarOfLight.js - High-Performance GPU Particle Emitter: Plasma -> PillarOfLight.
 */

class PlasmaPillarOfLight {
  constructor(maxParticles = 2400) {
    this.element = 'Plasma';
...
module.exports = { PlasmaPillarOfLight };
