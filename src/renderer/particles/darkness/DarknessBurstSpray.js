/**
 * DarknessBurstSpray.js - High-Performance GPU Particle Emitter: Darkness -> BurstSpray.
 */

class DarknessBurstSpray {
  constructor(maxParticles = 950) {
...
module.exports = { DarknessBurstSpray };
