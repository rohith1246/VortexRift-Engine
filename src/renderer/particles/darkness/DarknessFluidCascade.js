/**
 * DarknessFluidCascade.js - High-Performance GPU Particle Emitter: Darkness -> FluidCascade.
 */

class DarknessFluidCascade {
  constructor(maxParticles = 1350) {
...
module.exports = { DarknessFluidCascade };
