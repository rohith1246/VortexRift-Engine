/**
 * DarknessLightningBranch.js - High-Performance GPU Particle Emitter: Darkness -> LightningBranch.
 */

class DarknessLightningBranch {
  constructor(maxParticles = 1300) {
    this.element = 'Darkness';
    this.emitterType = 'LightningBranch';
...
module.exports = { DarknessLightningBranch };
