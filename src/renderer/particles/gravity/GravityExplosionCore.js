/**
 * GravityExplosionCore.js - High-Performance GPU Particle Emitter: Gravity -> ExplosionCore.
 */

class GravityExplosionCore {
  constructor(maxParticles = 1650) {
    this.element = 'Gravity';
    this.emitterType = 'ExplosionCore';
    this.maxParticles = maxParticles;
    this.particles = new Float32Array(maxParticles * 6); // x, y, z, vx, vy, vz
    this.lifespans = new Float32Array(maxParticles);
    this.activeCount = 0;
    this.emissionRate = 70;
  }
...
module.exports = { GravityExplosionCore };
