/**
 * GravityOrbitalRings.js - High-Performance GPU Particle Emitter: Gravity -> OrbitalRings.
 */

class GravityOrbitalRings {
  constructor(maxParticles = 1300) {
    this.element = 'Gravity';
    this.emitterType = 'OrbitalRings';
...
module.exports = { GravityOrbitalRings };
