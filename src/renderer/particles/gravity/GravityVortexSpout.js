/**
 * GravityVortexSpout.js - High-Performance GPU Particle Emitter: Gravity -> VortexSpout.
 */

class GravityVortexSpout {
  constructor(maxParticles = 1250) {
...
module.exports = { GravityVortexSpout };
