/**
 * GravityDistortionWave.js - High-Performance GPU Particle Emitter: Gravity -> DistortionWave.
 */

class GravityDistortionWave {
  constructor(maxParticles = 1600) {
    this.element = 'Gravity';
    this.emitterType = 'DistortionWave';
...
module.exports = { GravityDistortionWave };
