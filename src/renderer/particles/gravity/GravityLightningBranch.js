/**
 * GravityLightningBranch.js - High-Performance GPU Particle Emitter: Gravity -> LightningBranch.
 */

class GravityLightningBranch {
...
module.exports = { GravityLightningBranch };
