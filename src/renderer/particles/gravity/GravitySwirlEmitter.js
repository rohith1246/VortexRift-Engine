/**
 * GravitySwirlEmitter.js - High-Performance GPU Particle Emitter: Gravity -> SwirlEmitter.
 */

class GravitySwirlEmitter {
  constructor(maxParticles = 1100) {
    this.element = 'Gravity';
    this.emitterType = 'SwirlEmitter';
...
module.exports = { GravitySwirlEmitter };
