/**
 * GravityGlowHalo.js - High-Performance GPU Particle Emitter: Gravity -> GlowHalo.
 */

class GravityGlowHalo {
  constructor(maxParticles = 1750) {
...
module.exports = { GravityGlowHalo };
