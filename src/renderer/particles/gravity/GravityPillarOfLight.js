/**
 * GravityPillarOfLight.js - High-Performance GPU Particle Emitter: Gravity -> PillarOfLight.
 */

class GravityPillarOfLight {
  constructor(maxParticles = 1800) {
    this.element = 'Gravity';
...
module.exports = { GravityPillarOfLight };
