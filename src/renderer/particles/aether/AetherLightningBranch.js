/**
 * AetherLightningBranch.js - High-Performance GPU Particle Emitter: Aether -> LightningBranch.
 */

class AetherLightningBranch {
  constructor(maxParticles = 1900) {
    this.element = 'Aether';
...
module.exports = { AetherLightningBranch };
