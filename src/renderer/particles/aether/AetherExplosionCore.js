/**
 * AetherExplosionCore.js - High-Performance GPU Particle Emitter: Aether -> ExplosionCore.
 */

class AetherExplosionCore {
  constructor(maxParticles = 2050) {
    this.element = 'Aether';
...
module.exports = { AetherExplosionCore };
