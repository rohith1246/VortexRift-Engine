/**
 * AetherFluidCascade.js - High-Performance GPU Particle Emitter: Aether -> FluidCascade.
 */

class AetherFluidCascade {
  constructor(maxParticles = 1950) {
    this.element = 'Aether';
...
module.exports = { AetherFluidCascade };
