/**
 * SparkLightningBranch.js - High-Performance GPU Particle Emitter: Spark -> LightningBranch.
 */

class SparkLightningBranch {
  constructor(maxParticles = 1100) {
    this.element = 'Spark';
...
module.exports = { SparkLightningBranch };
