/**
 * SparkVortexSpout.js - High-Performance GPU Particle Emitter: Spark -> VortexSpout.
 */

class SparkVortexSpout {
  constructor(maxParticles = 850) {
    this.element = 'Spark';
...
module.exports = { SparkVortexSpout };
