/**
 * ChaosKnightKitingProjectileAI.js - Monster Behavior Tree Controller: ChaosKnight with KitingProjectile strategy.
 */

class ChaosKnightKitingProjectileAI {
...
module.exports = { ChaosKnightKitingProjectileAI };
