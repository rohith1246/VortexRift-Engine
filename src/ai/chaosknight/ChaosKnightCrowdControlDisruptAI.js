/**
 * ChaosKnightCrowdControlDisruptAI.js - Monster Behavior Tree Controller: ChaosKnight with CrowdControlDisrupt strategy.
 */

class ChaosKnightCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'ChaosKnight';
...
module.exports = { ChaosKnightCrowdControlDisruptAI };
