/**
 * ChaosKnightAreaDenialHazardAI.js - Monster Behavior Tree Controller: ChaosKnight with AreaDenialHazard strategy.
 */

class ChaosKnightAreaDenialHazardAI {
...
module.exports = { ChaosKnightAreaDenialHazardAI };
