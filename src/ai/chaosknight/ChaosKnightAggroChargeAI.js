/**
 * ChaosKnightAggroChargeAI.js - Monster Behavior Tree Controller: ChaosKnight with AggroCharge strategy.
 */

class ChaosKnightAggroChargeAI {
...
module.exports = { ChaosKnightAggroChargeAI };
