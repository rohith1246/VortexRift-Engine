/**
 * ChaosKnightFlankWeakTargetsAI.js - Monster Behavior Tree Controller: ChaosKnight with FlankWeakTargets strategy.
 */

class ChaosKnightFlankWeakTargetsAI {
...
module.exports = { ChaosKnightFlankWeakTargetsAI };
