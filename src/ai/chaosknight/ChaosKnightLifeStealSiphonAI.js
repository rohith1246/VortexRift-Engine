/**
 * ChaosKnightLifeStealSiphonAI.js - Monster Behavior Tree Controller: ChaosKnight with LifeStealSiphon strategy.
 */

class ChaosKnightLifeStealSiphonAI {
...
module.exports = { ChaosKnightLifeStealSiphonAI };
