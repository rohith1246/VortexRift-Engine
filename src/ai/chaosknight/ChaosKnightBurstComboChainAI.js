/**
 * ChaosKnightBurstComboChainAI.js - Monster Behavior Tree Controller: ChaosKnight with BurstComboChain strategy.
 */

class ChaosKnightBurstComboChainAI {
...
module.exports = { ChaosKnightBurstComboChainAI };
