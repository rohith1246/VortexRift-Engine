/**
 * ChaosKnightHealAlliesAI.js - Monster Behavior Tree Controller: ChaosKnight with HealAllies strategy.
 */

class ChaosKnightHealAlliesAI {
...
module.exports = { ChaosKnightHealAlliesAI };
