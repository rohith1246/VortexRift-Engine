/**
 * ChaosKnightTeleportBlinkAI.js - Monster Behavior Tree Controller: ChaosKnight with TeleportBlink strategy.
 */

class ChaosKnightTeleportBlinkAI {
...
module.exports = { ChaosKnightTeleportBlinkAI };
