/**
 * ChaosKnightSummonMinionsAI.js - Monster Behavior Tree Controller: ChaosKnight with SummonMinions strategy.
 */

class ChaosKnightSummonMinionsAI {
...
module.exports = { ChaosKnightSummonMinionsAI };
