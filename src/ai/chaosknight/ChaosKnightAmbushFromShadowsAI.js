/**
 * ChaosKnightAmbushFromShadowsAI.js - Monster Behavior Tree Controller: ChaosKnight with AmbushFromShadows strategy.
 */

class ChaosKnightAmbushFromShadowsAI {
...
module.exports = { ChaosKnightAmbushFromShadowsAI };
