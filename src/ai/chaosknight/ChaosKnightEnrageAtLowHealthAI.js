/**
 * ChaosKnightEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: ChaosKnight with EnrageAtLowHealth strategy.
 */

class ChaosKnightEnrageAtLowHealthAI {
...
module.exports = { ChaosKnightEnrageAtLowHealthAI };
