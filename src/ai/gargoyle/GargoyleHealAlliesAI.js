/**
 * GargoyleHealAlliesAI.js - Monster Behavior Tree Controller: Gargoyle with HealAllies strategy.
 */

class GargoyleHealAlliesAI {
...
module.exports = { GargoyleHealAlliesAI };
