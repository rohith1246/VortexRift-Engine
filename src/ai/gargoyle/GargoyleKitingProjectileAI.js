/**
 * GargoyleKitingProjectileAI.js - Monster Behavior Tree Controller: Gargoyle with KitingProjectile strategy.
 */

class GargoyleKitingProjectileAI {
...
module.exports = { GargoyleKitingProjectileAI };
