/**
 * GargoyleBurstComboChainAI.js - Monster Behavior Tree Controller: Gargoyle with BurstComboChain strategy.
 */

class GargoyleBurstComboChainAI {
...
module.exports = { GargoyleBurstComboChainAI };
