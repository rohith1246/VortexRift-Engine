/**
 * GargoyleAmbushFromShadowsAI.js - Monster Behavior Tree Controller: Gargoyle with AmbushFromShadows strategy.
 */

class GargoyleAmbushFromShadowsAI {
...
module.exports = { GargoyleAmbushFromShadowsAI };
