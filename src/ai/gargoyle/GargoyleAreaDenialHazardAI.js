/**
 * GargoyleAreaDenialHazardAI.js - Monster Behavior Tree Controller: Gargoyle with AreaDenialHazard strategy.
 */

class GargoyleAreaDenialHazardAI {
...
module.exports = { GargoyleAreaDenialHazardAI };
