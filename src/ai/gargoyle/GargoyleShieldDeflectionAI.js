/**
 * GargoyleShieldDeflectionAI.js - Monster Behavior Tree Controller: Gargoyle with ShieldDeflection strategy.
 */

class GargoyleShieldDeflectionAI {
...
module.exports = { GargoyleShieldDeflectionAI };
