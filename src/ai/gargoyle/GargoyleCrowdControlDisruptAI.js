/**
 * GargoyleCrowdControlDisruptAI.js - Monster Behavior Tree Controller: Gargoyle with CrowdControlDisrupt strategy.
 */

class GargoyleCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'Gargoyle';
...
module.exports = { GargoyleCrowdControlDisruptAI };
