/**
 * GargoyleReflectDamageAI.js - Monster Behavior Tree Controller: Gargoyle with ReflectDamage strategy.
 */

class GargoyleReflectDamageAI {
...
module.exports = { GargoyleReflectDamageAI };
