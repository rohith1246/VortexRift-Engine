/**
 * GargoyleAggroChargeAI.js - Monster Behavior Tree Controller: Gargoyle with AggroCharge strategy.
 */

class GargoyleAggroChargeAI {
...
module.exports = { GargoyleAggroChargeAI };
