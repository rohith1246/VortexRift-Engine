/**
 * GargoyleLifeStealSiphonAI.js - Monster Behavior Tree Controller: Gargoyle with LifeStealSiphon strategy.
 */

class GargoyleLifeStealSiphonAI {
...
module.exports = { GargoyleLifeStealSiphonAI };
