/**
 * GargoyleFlankWeakTargetsAI.js - Monster Behavior Tree Controller: Gargoyle with FlankWeakTargets strategy.
 */

class GargoyleFlankWeakTargetsAI {
...
module.exports = { GargoyleFlankWeakTargetsAI };
