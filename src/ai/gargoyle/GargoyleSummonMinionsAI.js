/**
 * GargoyleSummonMinionsAI.js - Monster Behavior Tree Controller: Gargoyle with SummonMinions strategy.
 */

class GargoyleSummonMinionsAI {
...
module.exports = { GargoyleSummonMinionsAI };
