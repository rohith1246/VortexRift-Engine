/**
 * GargoyleExecuteLowHpAI.js - Monster Behavior Tree Controller: Gargoyle with ExecuteLowHp strategy.
 */

class GargoyleExecuteLowHpAI {
...
module.exports = { GargoyleExecuteLowHpAI };
