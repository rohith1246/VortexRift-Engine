/**
 * GargoyleTeleportBlinkAI.js - Monster Behavior Tree Controller: Gargoyle with TeleportBlink strategy.
 */

class GargoyleTeleportBlinkAI {
...
module.exports = { GargoyleTeleportBlinkAI };
