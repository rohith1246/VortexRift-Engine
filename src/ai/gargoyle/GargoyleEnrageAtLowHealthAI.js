/**
 * GargoyleEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: Gargoyle with EnrageAtLowHealth strategy.
 */

class GargoyleEnrageAtLowHealthAI {
...
module.exports = { GargoyleEnrageAtLowHealthAI };
