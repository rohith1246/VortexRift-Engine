/**
 * DemonHoundFlankWeakTargetsAI.js - Monster Behavior Tree Controller: DemonHound with FlankWeakTargets strategy.
 */

class DemonHoundFlankWeakTargetsAI {
...
module.exports = { DemonHoundFlankWeakTargetsAI };
