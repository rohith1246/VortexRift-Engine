/**
 * DemonHoundKitingProjectileAI.js - Monster Behavior Tree Controller: DemonHound with KitingProjectile strategy.
 */

class DemonHoundKitingProjectileAI {
...
module.exports = { DemonHoundKitingProjectileAI };
