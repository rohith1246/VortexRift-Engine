/**
 * DemonHoundCrowdControlDisruptAI.js - Monster Behavior Tree Controller: DemonHound with CrowdControlDisrupt strategy.
 */

class DemonHoundCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'DemonHound';
...
module.exports = { DemonHoundCrowdControlDisruptAI };
