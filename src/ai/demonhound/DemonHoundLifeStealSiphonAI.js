/**
 * DemonHoundLifeStealSiphonAI.js - Monster Behavior Tree Controller: DemonHound with LifeStealSiphon strategy.
 */

class DemonHoundLifeStealSiphonAI {
...
module.exports = { DemonHoundLifeStealSiphonAI };
