/**
 * DemonHoundEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: DemonHound with EnrageAtLowHealth strategy.
 */

class DemonHoundEnrageAtLowHealthAI {
...
module.exports = { DemonHoundEnrageAtLowHealthAI };
