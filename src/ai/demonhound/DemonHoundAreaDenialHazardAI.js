/**
 * DemonHoundAreaDenialHazardAI.js - Monster Behavior Tree Controller: DemonHound with AreaDenialHazard strategy.
 */

class DemonHoundAreaDenialHazardAI {
...
module.exports = { DemonHoundAreaDenialHazardAI };
