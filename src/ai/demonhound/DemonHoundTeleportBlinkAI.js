/**
 * DemonHoundTeleportBlinkAI.js - Monster Behavior Tree Controller: DemonHound with TeleportBlink strategy.
 */

class DemonHoundTeleportBlinkAI {
...
module.exports = { DemonHoundTeleportBlinkAI };
