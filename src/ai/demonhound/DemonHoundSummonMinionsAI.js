/**
 * DemonHoundSummonMinionsAI.js - Monster Behavior Tree Controller: DemonHound with SummonMinions strategy.
 */

class DemonHoundSummonMinionsAI {
...
module.exports = { DemonHoundSummonMinionsAI };
