/**
 * DemonHoundAggroChargeAI.js - Monster Behavior Tree Controller: DemonHound with AggroCharge strategy.
 */

class DemonHoundAggroChargeAI {
...
module.exports = { DemonHoundAggroChargeAI };
