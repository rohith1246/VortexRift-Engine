/**
 * DemonHoundHealAlliesAI.js - Monster Behavior Tree Controller: DemonHound with HealAllies strategy.
 */

class DemonHoundHealAlliesAI {
...
module.exports = { DemonHoundHealAlliesAI };
