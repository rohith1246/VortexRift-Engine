/**
 * DemonHoundBurstComboChainAI.js - Monster Behavior Tree Controller: DemonHound with BurstComboChain strategy.
 */

class DemonHoundBurstComboChainAI {
...
module.exports = { DemonHoundBurstComboChainAI };
