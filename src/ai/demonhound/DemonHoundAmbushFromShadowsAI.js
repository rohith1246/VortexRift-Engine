/**
 * DemonHoundAmbushFromShadowsAI.js - Monster Behavior Tree Controller: DemonHound with AmbushFromShadows strategy.
 */

class DemonHoundAmbushFromShadowsAI {
...
module.exports = { DemonHoundAmbushFromShadowsAI };
