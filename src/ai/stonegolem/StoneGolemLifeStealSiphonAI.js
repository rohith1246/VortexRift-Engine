/**
 * StoneGolemLifeStealSiphonAI.js - Monster Behavior Tree Controller: StoneGolem with LifeStealSiphon strategy.
 */

class StoneGolemLifeStealSiphonAI {
...
module.exports = { StoneGolemLifeStealSiphonAI };
