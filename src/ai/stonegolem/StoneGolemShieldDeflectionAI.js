/**
 * StoneGolemShieldDeflectionAI.js - Monster Behavior Tree Controller: StoneGolem with ShieldDeflection strategy.
 */

class StoneGolemShieldDeflectionAI {
...
module.exports = { StoneGolemShieldDeflectionAI };
