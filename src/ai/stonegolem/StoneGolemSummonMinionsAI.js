/**
 * StoneGolemSummonMinionsAI.js - Monster Behavior Tree Controller: StoneGolem with SummonMinions strategy.
 */

class StoneGolemSummonMinionsAI {
...
module.exports = { StoneGolemSummonMinionsAI };
