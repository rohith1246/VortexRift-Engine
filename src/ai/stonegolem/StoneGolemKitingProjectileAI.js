/**
 * StoneGolemKitingProjectileAI.js - Monster Behavior Tree Controller: StoneGolem with KitingProjectile strategy.
 */

class StoneGolemKitingProjectileAI {
...
module.exports = { StoneGolemKitingProjectileAI };
