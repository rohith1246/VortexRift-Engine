/**
 * StoneGolemBurstComboChainAI.js - Monster Behavior Tree Controller: StoneGolem with BurstComboChain strategy.
 */

class StoneGolemBurstComboChainAI {
...
module.exports = { StoneGolemBurstComboChainAI };
