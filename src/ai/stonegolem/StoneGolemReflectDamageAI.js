/**
 * StoneGolemReflectDamageAI.js - Monster Behavior Tree Controller: StoneGolem with ReflectDamage strategy.
 */

class StoneGolemReflectDamageAI {
...
module.exports = { StoneGolemReflectDamageAI };
