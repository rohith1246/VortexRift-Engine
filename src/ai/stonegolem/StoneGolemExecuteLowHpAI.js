/**
 * StoneGolemExecuteLowHpAI.js - Monster Behavior Tree Controller: StoneGolem with ExecuteLowHp strategy.
 */

class StoneGolemExecuteLowHpAI {
...
module.exports = { StoneGolemExecuteLowHpAI };
