/**
 * StoneGolemCrowdControlDisruptAI.js - Monster Behavior Tree Controller: StoneGolem with CrowdControlDisrupt strategy.
 */

class StoneGolemCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'StoneGolem';
...
module.exports = { StoneGolemCrowdControlDisruptAI };
