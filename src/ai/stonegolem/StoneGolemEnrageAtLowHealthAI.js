/**
 * StoneGolemEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: StoneGolem with EnrageAtLowHealth strategy.
 */

class StoneGolemEnrageAtLowHealthAI {
...
module.exports = { StoneGolemEnrageAtLowHealthAI };
