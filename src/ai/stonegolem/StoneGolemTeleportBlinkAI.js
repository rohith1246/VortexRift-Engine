/**
 * StoneGolemTeleportBlinkAI.js - Monster Behavior Tree Controller: StoneGolem with TeleportBlink strategy.
 */

class StoneGolemTeleportBlinkAI {
...
module.exports = { StoneGolemTeleportBlinkAI };
