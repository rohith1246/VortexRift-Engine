/**
 * StoneGolemAreaDenialHazardAI.js - Monster Behavior Tree Controller: StoneGolem with AreaDenialHazard strategy.
 */

class StoneGolemAreaDenialHazardAI {
...
module.exports = { StoneGolemAreaDenialHazardAI };
