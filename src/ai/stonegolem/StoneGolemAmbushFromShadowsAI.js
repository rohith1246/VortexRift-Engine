/**
 * StoneGolemAmbushFromShadowsAI.js - Monster Behavior Tree Controller: StoneGolem with AmbushFromShadows strategy.
 */

class StoneGolemAmbushFromShadowsAI {
...
module.exports = { StoneGolemAmbushFromShadowsAI };
