/**
 * StoneGolemHealAlliesAI.js - Monster Behavior Tree Controller: StoneGolem with HealAllies strategy.
 */

class StoneGolemHealAlliesAI {
...
module.exports = { StoneGolemHealAlliesAI };
