/**
 * StoneGolemAggroChargeAI.js - Monster Behavior Tree Controller: StoneGolem with AggroCharge strategy.
 */

class StoneGolemAggroChargeAI {
...
module.exports = { StoneGolemAggroChargeAI };
