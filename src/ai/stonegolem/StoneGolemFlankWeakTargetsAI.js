/**
 * StoneGolemFlankWeakTargetsAI.js - Monster Behavior Tree Controller: StoneGolem with FlankWeakTargets strategy.
 */

class StoneGolemFlankWeakTargetsAI {
...
module.exports = { StoneGolemFlankWeakTargetsAI };
