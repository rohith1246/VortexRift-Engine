/**
 * AbyssalSirenAreaDenialHazardAI.js - Monster Behavior Tree Controller: AbyssalSiren with AreaDenialHazard strategy.
 */

class AbyssalSirenAreaDenialHazardAI {
...
module.exports = { AbyssalSirenAreaDenialHazardAI };
