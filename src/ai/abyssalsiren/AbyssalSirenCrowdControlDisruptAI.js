/**
 * AbyssalSirenCrowdControlDisruptAI.js - Monster Behavior Tree Controller: AbyssalSiren with CrowdControlDisrupt strategy.
 */

class AbyssalSirenCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'AbyssalSiren';
...
module.exports = { AbyssalSirenCrowdControlDisruptAI };
