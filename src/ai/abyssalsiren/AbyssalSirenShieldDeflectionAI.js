/**
 * AbyssalSirenShieldDeflectionAI.js - Monster Behavior Tree Controller: AbyssalSiren with ShieldDeflection strategy.
 */

class AbyssalSirenShieldDeflectionAI {
...
module.exports = { AbyssalSirenShieldDeflectionAI };
