/**
 * AbyssalSirenReflectDamageAI.js - Monster Behavior Tree Controller: AbyssalSiren with ReflectDamage strategy.
 */

class AbyssalSirenReflectDamageAI {
...
module.exports = { AbyssalSirenReflectDamageAI };
