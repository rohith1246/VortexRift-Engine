/**
 * AbyssalSirenAmbushFromShadowsAI.js - Monster Behavior Tree Controller: AbyssalSiren with AmbushFromShadows strategy.
 */

class AbyssalSirenAmbushFromShadowsAI {
...
module.exports = { AbyssalSirenAmbushFromShadowsAI };
