/**
 * AbyssalSirenTeleportBlinkAI.js - Monster Behavior Tree Controller: AbyssalSiren with TeleportBlink strategy.
 */

class AbyssalSirenTeleportBlinkAI {
...
module.exports = { AbyssalSirenTeleportBlinkAI };
