/**
 * AbyssalSirenEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: AbyssalSiren with EnrageAtLowHealth strategy.
 */

class AbyssalSirenEnrageAtLowHealthAI {
...
module.exports = { AbyssalSirenEnrageAtLowHealthAI };
