/**
 * AbyssalSirenHealAlliesAI.js - Monster Behavior Tree Controller: AbyssalSiren with HealAllies strategy.
 */

class AbyssalSirenHealAlliesAI {
...
module.exports = { AbyssalSirenHealAlliesAI };
