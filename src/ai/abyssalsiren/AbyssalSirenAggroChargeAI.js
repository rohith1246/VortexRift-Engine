/**
 * AbyssalSirenAggroChargeAI.js - Monster Behavior Tree Controller: AbyssalSiren with AggroCharge strategy.
 */

class AbyssalSirenAggroChargeAI {
...
module.exports = { AbyssalSirenAggroChargeAI };
