/**
 * AbyssalSirenFlankWeakTargetsAI.js - Monster Behavior Tree Controller: AbyssalSiren with FlankWeakTargets strategy.
 */

class AbyssalSirenFlankWeakTargetsAI {
...
module.exports = { AbyssalSirenFlankWeakTargetsAI };
