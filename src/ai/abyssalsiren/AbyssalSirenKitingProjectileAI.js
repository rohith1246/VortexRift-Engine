/**
 * AbyssalSirenKitingProjectileAI.js - Monster Behavior Tree Controller: AbyssalSiren with KitingProjectile strategy.
 */

class AbyssalSirenKitingProjectileAI {
...
module.exports = { AbyssalSirenKitingProjectileAI };
