/**
 * AbyssalSirenBurstComboChainAI.js - Monster Behavior Tree Controller: AbyssalSiren with BurstComboChain strategy.
 */

class AbyssalSirenBurstComboChainAI {
...
module.exports = { AbyssalSirenBurstComboChainAI };
