/**
 * AbyssalSirenLifeStealSiphonAI.js - Monster Behavior Tree Controller: AbyssalSiren with LifeStealSiphon strategy.
 */

class AbyssalSirenLifeStealSiphonAI {
...
module.exports = { AbyssalSirenLifeStealSiphonAI };
