/**
 * AbyssalSirenExecuteLowHpAI.js - Monster Behavior Tree Controller: AbyssalSiren with ExecuteLowHp strategy.
 */

class AbyssalSirenExecuteLowHpAI {
...
module.exports = { AbyssalSirenExecuteLowHpAI };
