/**
 * AbyssalSirenSummonMinionsAI.js - Monster Behavior Tree Controller: AbyssalSiren with SummonMinions strategy.
 */

class AbyssalSirenSummonMinionsAI {
...
module.exports = { AbyssalSirenSummonMinionsAI };
