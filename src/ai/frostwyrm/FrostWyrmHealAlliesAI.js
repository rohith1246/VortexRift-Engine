/**
 * FrostWyrmHealAlliesAI.js - Monster Behavior Tree Controller: FrostWyrm with HealAllies strategy.
 */

class FrostWyrmHealAlliesAI {
...
module.exports = { FrostWyrmHealAlliesAI };
