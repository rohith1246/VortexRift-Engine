/**
 * FrostWyrmExecuteLowHpAI.js - Monster Behavior Tree Controller: FrostWyrm with ExecuteLowHp strategy.
 */

class FrostWyrmExecuteLowHpAI {
...
module.exports = { FrostWyrmExecuteLowHpAI };
