/**
 * FrostWyrmSummonMinionsAI.js - Monster Behavior Tree Controller: FrostWyrm with SummonMinions strategy.
 */

class FrostWyrmSummonMinionsAI {
...
module.exports = { FrostWyrmSummonMinionsAI };
