/**
 * FrostWyrmAreaDenialHazardAI.js - Monster Behavior Tree Controller: FrostWyrm with AreaDenialHazard strategy.
 */

class FrostWyrmAreaDenialHazardAI {
...
module.exports = { FrostWyrmAreaDenialHazardAI };
