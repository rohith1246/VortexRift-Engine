/**
 * FrostWyrmCrowdControlDisruptAI.js - Monster Behavior Tree Controller: FrostWyrm with CrowdControlDisrupt strategy.
 */

class FrostWyrmCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FrostWyrm';
...
module.exports = { FrostWyrmCrowdControlDisruptAI };
