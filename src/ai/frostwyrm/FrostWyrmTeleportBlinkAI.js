/**
 * FrostWyrmTeleportBlinkAI.js - Monster Behavior Tree Controller: FrostWyrm with TeleportBlink strategy.
 */

class FrostWyrmTeleportBlinkAI {
...
module.exports = { FrostWyrmTeleportBlinkAI };
