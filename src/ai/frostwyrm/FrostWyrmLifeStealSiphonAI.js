/**
 * FrostWyrmLifeStealSiphonAI.js - Monster Behavior Tree Controller: FrostWyrm with LifeStealSiphon strategy.
 */

class FrostWyrmLifeStealSiphonAI {
...
module.exports = { FrostWyrmLifeStealSiphonAI };
