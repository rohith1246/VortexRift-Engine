/**
 * FrostWyrmReflectDamageAI.js - Monster Behavior Tree Controller: FrostWyrm with ReflectDamage strategy.
 */

class FrostWyrmReflectDamageAI {
...
module.exports = { FrostWyrmReflectDamageAI };
