/**
 * FrostWyrmEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: FrostWyrm with EnrageAtLowHealth strategy.
 */

class FrostWyrmEnrageAtLowHealthAI {
...
module.exports = { FrostWyrmEnrageAtLowHealthAI };
