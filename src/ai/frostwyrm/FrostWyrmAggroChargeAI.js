/**
 * FrostWyrmAggroChargeAI.js - Monster Behavior Tree Controller: FrostWyrm with AggroCharge strategy.
 */

class FrostWyrmAggroChargeAI {
...
module.exports = { FrostWyrmAggroChargeAI };
