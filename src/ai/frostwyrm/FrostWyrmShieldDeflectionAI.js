/**
 * FrostWyrmShieldDeflectionAI.js - Monster Behavior Tree Controller: FrostWyrm with ShieldDeflection strategy.
 */

class FrostWyrmShieldDeflectionAI {
...
module.exports = { FrostWyrmShieldDeflectionAI };
