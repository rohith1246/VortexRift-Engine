/**
 * FrostWyrmFlankWeakTargetsAI.js - Monster Behavior Tree Controller: FrostWyrm with FlankWeakTargets strategy.
 */

class FrostWyrmFlankWeakTargetsAI {
...
module.exports = { FrostWyrmFlankWeakTargetsAI };
