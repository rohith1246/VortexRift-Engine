/**
 * FrostWyrmKitingProjectileAI.js - Monster Behavior Tree Controller: FrostWyrm with KitingProjectile strategy.
 */

class FrostWyrmKitingProjectileAI {
...
module.exports = { FrostWyrmKitingProjectileAI };
