/**
 * FrostWyrmAmbushFromShadowsAI.js - Monster Behavior Tree Controller: FrostWyrm with AmbushFromShadows strategy.
 */

class FrostWyrmAmbushFromShadowsAI {
...
module.exports = { FrostWyrmAmbushFromShadowsAI };
