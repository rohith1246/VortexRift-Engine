/**
 * FrostWyrmBurstComboChainAI.js - Monster Behavior Tree Controller: FrostWyrm with BurstComboChain strategy.
 */

class FrostWyrmBurstComboChainAI {
...
module.exports = { FrostWyrmBurstComboChainAI };
