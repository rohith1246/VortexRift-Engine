/**
 * StormTitanFlankWeakTargetsAI.js - Monster Behavior Tree Controller: StormTitan with FlankWeakTargets strategy.
 */

class StormTitanFlankWeakTargetsAI {
...
module.exports = { StormTitanFlankWeakTargetsAI };
