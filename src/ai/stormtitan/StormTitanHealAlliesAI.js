/**
 * StormTitanHealAlliesAI.js - Monster Behavior Tree Controller: StormTitan with HealAllies strategy.
 */

class StormTitanHealAlliesAI {
...
module.exports = { StormTitanHealAlliesAI };
