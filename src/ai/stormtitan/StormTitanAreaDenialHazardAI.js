/**
 * StormTitanAreaDenialHazardAI.js - Monster Behavior Tree Controller: StormTitan with AreaDenialHazard strategy.
 */

class StormTitanAreaDenialHazardAI {
...
module.exports = { StormTitanAreaDenialHazardAI };
