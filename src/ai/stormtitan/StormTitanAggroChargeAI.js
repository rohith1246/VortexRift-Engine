/**
 * StormTitanAggroChargeAI.js - Monster Behavior Tree Controller: StormTitan with AggroCharge strategy.
 */

class StormTitanAggroChargeAI {
...
module.exports = { StormTitanAggroChargeAI };
