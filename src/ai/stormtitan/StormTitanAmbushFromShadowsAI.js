/**
 * StormTitanAmbushFromShadowsAI.js - Monster Behavior Tree Controller: StormTitan with AmbushFromShadows strategy.
 */

class StormTitanAmbushFromShadowsAI {
...
module.exports = { StormTitanAmbushFromShadowsAI };
