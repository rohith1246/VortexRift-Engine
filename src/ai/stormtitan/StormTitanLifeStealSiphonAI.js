/**
 * StormTitanLifeStealSiphonAI.js - Monster Behavior Tree Controller: StormTitan with LifeStealSiphon strategy.
 */

class StormTitanLifeStealSiphonAI {
...
module.exports = { StormTitanLifeStealSiphonAI };
