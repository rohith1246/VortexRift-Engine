/**
 * StormTitanSummonMinionsAI.js - Monster Behavior Tree Controller: StormTitan with SummonMinions strategy.
 */

class StormTitanSummonMinionsAI {
...
module.exports = { StormTitanSummonMinionsAI };
