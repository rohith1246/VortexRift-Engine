/**
 * StormTitanBurstComboChainAI.js - Monster Behavior Tree Controller: StormTitan with BurstComboChain strategy.
 */

class StormTitanBurstComboChainAI {
...
module.exports = { StormTitanBurstComboChainAI };
