/**
 * StormTitanKitingProjectileAI.js - Monster Behavior Tree Controller: StormTitan with KitingProjectile strategy.
 */

class StormTitanKitingProjectileAI {
...
module.exports = { StormTitanKitingProjectileAI };
