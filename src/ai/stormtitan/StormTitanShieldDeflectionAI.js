/**
 * StormTitanShieldDeflectionAI.js - Monster Behavior Tree Controller: StormTitan with ShieldDeflection strategy.
 */

class StormTitanShieldDeflectionAI {
...
module.exports = { StormTitanShieldDeflectionAI };
