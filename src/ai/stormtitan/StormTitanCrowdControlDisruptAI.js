/**
 * StormTitanCrowdControlDisruptAI.js - Monster Behavior Tree Controller: StormTitan with CrowdControlDisrupt strategy.
 */

class StormTitanCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'StormTitan';
...
module.exports = { StormTitanCrowdControlDisruptAI };
