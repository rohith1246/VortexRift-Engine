/**
 * StormTitanTeleportBlinkAI.js - Monster Behavior Tree Controller: StormTitan with TeleportBlink strategy.
 */

class StormTitanTeleportBlinkAI {
...
module.exports = { StormTitanTeleportBlinkAI };
