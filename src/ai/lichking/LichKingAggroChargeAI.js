/**
 * LichKingAggroChargeAI.js - Monster Behavior Tree Controller: LichKing with AggroCharge strategy.
 */

class LichKingAggroChargeAI {
...
module.exports = { LichKingAggroChargeAI };
