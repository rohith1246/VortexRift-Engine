/**
 * LichKingFlankWeakTargetsAI.js - Monster Behavior Tree Controller: LichKing with FlankWeakTargets strategy.
 */

class LichKingFlankWeakTargetsAI {
...
module.exports = { LichKingFlankWeakTargetsAI };
