/**
 * LichKingAreaDenialHazardAI.js - Monster Behavior Tree Controller: LichKing with AreaDenialHazard strategy.
 */

class LichKingAreaDenialHazardAI {
...
module.exports = { LichKingAreaDenialHazardAI };
