/**
 * LichKingHealAlliesAI.js - Monster Behavior Tree Controller: LichKing with HealAllies strategy.
 */

class LichKingHealAlliesAI {
...
module.exports = { LichKingHealAlliesAI };
