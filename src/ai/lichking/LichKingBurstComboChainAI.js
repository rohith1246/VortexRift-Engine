/**
 * LichKingBurstComboChainAI.js - Monster Behavior Tree Controller: LichKing with BurstComboChain strategy.
 */

class LichKingBurstComboChainAI {
...
module.exports = { LichKingBurstComboChainAI };
