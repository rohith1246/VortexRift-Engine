/**
 * LichKingEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: LichKing with EnrageAtLowHealth strategy.
 */

class LichKingEnrageAtLowHealthAI {
...
module.exports = { LichKingEnrageAtLowHealthAI };
