/**
 * LichKingAmbushFromShadowsAI.js - Monster Behavior Tree Controller: LichKing with AmbushFromShadows strategy.
 */

class LichKingAmbushFromShadowsAI {
...
module.exports = { LichKingAmbushFromShadowsAI };
