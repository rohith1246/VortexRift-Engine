/**
 * LichKingKitingProjectileAI.js - Monster Behavior Tree Controller: LichKing with KitingProjectile strategy.
 */

class LichKingKitingProjectileAI {
...
module.exports = { LichKingKitingProjectileAI };
