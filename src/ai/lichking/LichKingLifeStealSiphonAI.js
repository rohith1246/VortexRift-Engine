/**
 * LichKingLifeStealSiphonAI.js - Monster Behavior Tree Controller: LichKing with LifeStealSiphon strategy.
 */

class LichKingLifeStealSiphonAI {
...
module.exports = { LichKingLifeStealSiphonAI };
