/**
 * LichKingTeleportBlinkAI.js - Monster Behavior Tree Controller: LichKing with TeleportBlink strategy.
 */

class LichKingTeleportBlinkAI {
...
module.exports = { LichKingTeleportBlinkAI };
