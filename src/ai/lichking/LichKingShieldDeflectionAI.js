/**
 * LichKingShieldDeflectionAI.js - Monster Behavior Tree Controller: LichKing with ShieldDeflection strategy.
 */

class LichKingShieldDeflectionAI {
...
module.exports = { LichKingShieldDeflectionAI };
