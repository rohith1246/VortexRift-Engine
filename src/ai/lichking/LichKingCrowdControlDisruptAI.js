/**
 * LichKingCrowdControlDisruptAI.js - Monster Behavior Tree Controller: LichKing with CrowdControlDisrupt strategy.
 */

class LichKingCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'LichKing';
...
module.exports = { LichKingCrowdControlDisruptAI };
