/**
 * LichKingSummonMinionsAI.js - Monster Behavior Tree Controller: LichKing with SummonMinions strategy.
 */

class LichKingSummonMinionsAI {
...
module.exports = { LichKingSummonMinionsAI };
