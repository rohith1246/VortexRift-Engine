/**
 * BloodReaperReflectDamageAI.js - Monster Behavior Tree Controller: BloodReaper with ReflectDamage strategy.
 */

class BloodReaperReflectDamageAI {
...
module.exports = { BloodReaperReflectDamageAI };
