/**
 * BloodReaperTeleportBlinkAI.js - Monster Behavior Tree Controller: BloodReaper with TeleportBlink strategy.
 */

class BloodReaperTeleportBlinkAI {
...
module.exports = { BloodReaperTeleportBlinkAI };
