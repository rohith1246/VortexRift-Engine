/**
 * BloodReaperLifeStealSiphonAI.js - Monster Behavior Tree Controller: BloodReaper with LifeStealSiphon strategy.
 */

class BloodReaperLifeStealSiphonAI {
...
module.exports = { BloodReaperLifeStealSiphonAI };
