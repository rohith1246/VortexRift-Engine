/**
 * BloodReaperShieldDeflectionAI.js - Monster Behavior Tree Controller: BloodReaper with ShieldDeflection strategy.
 */

class BloodReaperShieldDeflectionAI {
...
module.exports = { BloodReaperShieldDeflectionAI };
