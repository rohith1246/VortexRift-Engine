/**
 * BloodReaperSummonMinionsAI.js - Monster Behavior Tree Controller: BloodReaper with SummonMinions strategy.
 */

class BloodReaperSummonMinionsAI {
...
module.exports = { BloodReaperSummonMinionsAI };
