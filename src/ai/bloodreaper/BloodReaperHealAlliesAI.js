/**
 * BloodReaperHealAlliesAI.js - Monster Behavior Tree Controller: BloodReaper with HealAllies strategy.
 */

class BloodReaperHealAlliesAI {
...
module.exports = { BloodReaperHealAlliesAI };
