/**
 * BloodReaperAmbushFromShadowsAI.js - Monster Behavior Tree Controller: BloodReaper with AmbushFromShadows strategy.
 */

class BloodReaperAmbushFromShadowsAI {
...
module.exports = { BloodReaperAmbushFromShadowsAI };
