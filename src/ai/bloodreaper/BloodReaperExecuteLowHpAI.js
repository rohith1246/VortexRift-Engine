/**
 * BloodReaperExecuteLowHpAI.js - Monster Behavior Tree Controller: BloodReaper with ExecuteLowHp strategy.
 */

class BloodReaperExecuteLowHpAI {
...
module.exports = { BloodReaperExecuteLowHpAI };
