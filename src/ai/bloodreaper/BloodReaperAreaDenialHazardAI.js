/**
 * BloodReaperAreaDenialHazardAI.js - Monster Behavior Tree Controller: BloodReaper with AreaDenialHazard strategy.
 */

class BloodReaperAreaDenialHazardAI {
...
module.exports = { BloodReaperAreaDenialHazardAI };
