/**
 * BloodReaperAggroChargeAI.js - Monster Behavior Tree Controller: BloodReaper with AggroCharge strategy.
 */

class BloodReaperAggroChargeAI {
...
module.exports = { BloodReaperAggroChargeAI };
