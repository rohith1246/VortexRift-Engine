/**
 * BloodReaperCrowdControlDisruptAI.js - Monster Behavior Tree Controller: BloodReaper with CrowdControlDisrupt strategy.
 */

class BloodReaperCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'BloodReaper';
...
module.exports = { BloodReaperCrowdControlDisruptAI };
