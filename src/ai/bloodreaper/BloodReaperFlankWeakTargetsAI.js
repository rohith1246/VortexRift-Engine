/**
 * BloodReaperFlankWeakTargetsAI.js - Monster Behavior Tree Controller: BloodReaper with FlankWeakTargets strategy.
 */

class BloodReaperFlankWeakTargetsAI {
...
module.exports = { BloodReaperFlankWeakTargetsAI };
