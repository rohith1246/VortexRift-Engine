/**
 * BloodReaperBurstComboChainAI.js - Monster Behavior Tree Controller: BloodReaper with BurstComboChain strategy.
 */

class BloodReaperBurstComboChainAI {
...
module.exports = { BloodReaperBurstComboChainAI };
