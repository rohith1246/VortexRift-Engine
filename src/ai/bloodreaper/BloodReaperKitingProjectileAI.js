/**
 * BloodReaperKitingProjectileAI.js - Monster Behavior Tree Controller: BloodReaper with KitingProjectile strategy.
 */

class BloodReaperKitingProjectileAI {
...
module.exports = { BloodReaperKitingProjectileAI };
