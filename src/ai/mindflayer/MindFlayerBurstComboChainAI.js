/**
 * MindFlayerBurstComboChainAI.js - Monster Behavior Tree Controller: MindFlayer with BurstComboChain strategy.
 */

class MindFlayerBurstComboChainAI {
...
module.exports = { MindFlayerBurstComboChainAI };
