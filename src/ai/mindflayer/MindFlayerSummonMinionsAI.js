/**
 * MindFlayerSummonMinionsAI.js - Monster Behavior Tree Controller: MindFlayer with SummonMinions strategy.
 */

class MindFlayerSummonMinionsAI {
...
module.exports = { MindFlayerSummonMinionsAI };
