/**
 * MindFlayerLifeStealSiphonAI.js - Monster Behavior Tree Controller: MindFlayer with LifeStealSiphon strategy.
 */

class MindFlayerLifeStealSiphonAI {
...
module.exports = { MindFlayerLifeStealSiphonAI };
