/**
 * MindFlayerAggroChargeAI.js - Monster Behavior Tree Controller: MindFlayer with AggroCharge strategy.
 */

class MindFlayerAggroChargeAI {
...
module.exports = { MindFlayerAggroChargeAI };
