/**
 * MindFlayerKitingProjectileAI.js - Monster Behavior Tree Controller: MindFlayer with KitingProjectile strategy.
 */

class MindFlayerKitingProjectileAI {
...
module.exports = { MindFlayerKitingProjectileAI };
