/**
 * MindFlayerShieldDeflectionAI.js - Monster Behavior Tree Controller: MindFlayer with ShieldDeflection strategy.
 */

class MindFlayerShieldDeflectionAI {
...
module.exports = { MindFlayerShieldDeflectionAI };
