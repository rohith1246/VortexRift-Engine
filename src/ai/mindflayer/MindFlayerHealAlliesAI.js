/**
 * MindFlayerHealAlliesAI.js - Monster Behavior Tree Controller: MindFlayer with HealAllies strategy.
 */

class MindFlayerHealAlliesAI {
...
module.exports = { MindFlayerHealAlliesAI };
