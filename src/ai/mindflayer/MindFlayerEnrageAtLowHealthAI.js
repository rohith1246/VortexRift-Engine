/**
 * MindFlayerEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: MindFlayer with EnrageAtLowHealth strategy.
 */

class MindFlayerEnrageAtLowHealthAI {
...
module.exports = { MindFlayerEnrageAtLowHealthAI };
