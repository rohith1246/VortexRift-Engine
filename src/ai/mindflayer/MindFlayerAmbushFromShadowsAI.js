/**
 * MindFlayerAmbushFromShadowsAI.js - Monster Behavior Tree Controller: MindFlayer with AmbushFromShadows strategy.
 */

class MindFlayerAmbushFromShadowsAI {
...
module.exports = { MindFlayerAmbushFromShadowsAI };
