/**
 * MindFlayerCrowdControlDisruptAI.js - Monster Behavior Tree Controller: MindFlayer with CrowdControlDisrupt strategy.
 */

class MindFlayerCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'MindFlayer';
...
module.exports = { MindFlayerCrowdControlDisruptAI };
