/**
 * MindFlayerTeleportBlinkAI.js - Monster Behavior Tree Controller: MindFlayer with TeleportBlink strategy.
 */

class MindFlayerTeleportBlinkAI {
...
module.exports = { MindFlayerTeleportBlinkAI };
