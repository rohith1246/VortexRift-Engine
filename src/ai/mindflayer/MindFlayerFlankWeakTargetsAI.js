/**
 * MindFlayerFlankWeakTargetsAI.js - Monster Behavior Tree Controller: MindFlayer with FlankWeakTargets strategy.
 */

class MindFlayerFlankWeakTargetsAI {
...
module.exports = { MindFlayerFlankWeakTargetsAI };
