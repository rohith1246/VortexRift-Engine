/**
 * MindFlayerReflectDamageAI.js - Monster Behavior Tree Controller: MindFlayer with ReflectDamage strategy.
 */

class MindFlayerReflectDamageAI {
...
module.exports = { MindFlayerReflectDamageAI };
