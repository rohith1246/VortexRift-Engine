/**
 * MindFlayerExecuteLowHpAI.js - Monster Behavior Tree Controller: MindFlayer with ExecuteLowHp strategy.
 */

class MindFlayerExecuteLowHpAI {
...
module.exports = { MindFlayerExecuteLowHpAI };
