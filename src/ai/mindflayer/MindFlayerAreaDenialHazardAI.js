/**
 * MindFlayerAreaDenialHazardAI.js - Monster Behavior Tree Controller: MindFlayer with AreaDenialHazard strategy.
 */

class MindFlayerAreaDenialHazardAI {
...
module.exports = { MindFlayerAreaDenialHazardAI };
