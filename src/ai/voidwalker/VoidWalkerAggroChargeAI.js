/**
 * VoidWalkerAggroChargeAI.js - Monster Behavior Tree Controller: VoidWalker with AggroCharge strategy.
 */

class VoidWalkerAggroChargeAI {
...
module.exports = { VoidWalkerAggroChargeAI };
