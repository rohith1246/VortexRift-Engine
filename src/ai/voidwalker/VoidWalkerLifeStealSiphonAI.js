/**
 * VoidWalkerLifeStealSiphonAI.js - Monster Behavior Tree Controller: VoidWalker with LifeStealSiphon strategy.
 */

class VoidWalkerLifeStealSiphonAI {
...
module.exports = { VoidWalkerLifeStealSiphonAI };
