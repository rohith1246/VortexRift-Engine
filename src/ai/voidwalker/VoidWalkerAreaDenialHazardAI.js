/**
 * VoidWalkerAreaDenialHazardAI.js - Monster Behavior Tree Controller: VoidWalker with AreaDenialHazard strategy.
 */

class VoidWalkerAreaDenialHazardAI {
...
module.exports = { VoidWalkerAreaDenialHazardAI };
