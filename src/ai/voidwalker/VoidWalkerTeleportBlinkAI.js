/**
 * VoidWalkerTeleportBlinkAI.js - Monster Behavior Tree Controller: VoidWalker with TeleportBlink strategy.
 */

class VoidWalkerTeleportBlinkAI {
...
module.exports = { VoidWalkerTeleportBlinkAI };
