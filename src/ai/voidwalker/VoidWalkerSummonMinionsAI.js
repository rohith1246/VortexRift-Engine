/**
 * VoidWalkerSummonMinionsAI.js - Monster Behavior Tree Controller: VoidWalker with SummonMinions strategy.
 */

class VoidWalkerSummonMinionsAI {
...
module.exports = { VoidWalkerSummonMinionsAI };
