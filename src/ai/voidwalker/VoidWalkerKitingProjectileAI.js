/**
 * VoidWalkerKitingProjectileAI.js - Monster Behavior Tree Controller: VoidWalker with KitingProjectile strategy.
 */

class VoidWalkerKitingProjectileAI {
...
module.exports = { VoidWalkerKitingProjectileAI };
