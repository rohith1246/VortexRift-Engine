/**
 * VoidWalkerEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: VoidWalker with EnrageAtLowHealth strategy.
 */

class VoidWalkerEnrageAtLowHealthAI {
...
module.exports = { VoidWalkerEnrageAtLowHealthAI };
