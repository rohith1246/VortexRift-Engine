/**
 * VoidWalkerAmbushFromShadowsAI.js - Monster Behavior Tree Controller: VoidWalker with AmbushFromShadows strategy.
 */

class VoidWalkerAmbushFromShadowsAI {
...
module.exports = { VoidWalkerAmbushFromShadowsAI };
