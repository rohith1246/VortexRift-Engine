/**
 * VoidWalkerBurstComboChainAI.js - Monster Behavior Tree Controller: VoidWalker with BurstComboChain strategy.
 */

class VoidWalkerBurstComboChainAI {
...
module.exports = { VoidWalkerBurstComboChainAI };
