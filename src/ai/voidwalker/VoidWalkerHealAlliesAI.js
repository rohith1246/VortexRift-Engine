/**
 * VoidWalkerHealAlliesAI.js - Monster Behavior Tree Controller: VoidWalker with HealAllies strategy.
 */

class VoidWalkerHealAlliesAI {
...
module.exports = { VoidWalkerHealAlliesAI };
