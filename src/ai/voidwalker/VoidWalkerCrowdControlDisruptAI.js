/**
 * VoidWalkerCrowdControlDisruptAI.js - Monster Behavior Tree Controller: VoidWalker with CrowdControlDisrupt strategy.
 */

class VoidWalkerCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'VoidWalker';
...
module.exports = { VoidWalkerCrowdControlDisruptAI };
