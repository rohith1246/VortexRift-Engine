/**
 * VoidWalkerFlankWeakTargetsAI.js - Monster Behavior Tree Controller: VoidWalker with FlankWeakTargets strategy.
 */

class VoidWalkerFlankWeakTargetsAI {
...
module.exports = { VoidWalkerFlankWeakTargetsAI };
