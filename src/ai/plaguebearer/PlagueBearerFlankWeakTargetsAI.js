/**
 * PlagueBearerFlankWeakTargetsAI.js - Monster Behavior Tree Controller: PlagueBearer with FlankWeakTargets strategy.
 */

class PlagueBearerFlankWeakTargetsAI {
...
module.exports = { PlagueBearerFlankWeakTargetsAI };
