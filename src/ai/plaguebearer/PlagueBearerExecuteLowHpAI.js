/**
 * PlagueBearerExecuteLowHpAI.js - Monster Behavior Tree Controller: PlagueBearer with ExecuteLowHp strategy.
 */

class PlagueBearerExecuteLowHpAI {
...
module.exports = { PlagueBearerExecuteLowHpAI };
