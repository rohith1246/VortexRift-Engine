/**
 * PlagueBearerAggroChargeAI.js - Monster Behavior Tree Controller: PlagueBearer with AggroCharge strategy.
 */

class PlagueBearerAggroChargeAI {
...
module.exports = { PlagueBearerAggroChargeAI };
