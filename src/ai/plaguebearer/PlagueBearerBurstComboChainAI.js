/**
 * PlagueBearerBurstComboChainAI.js - Monster Behavior Tree Controller: PlagueBearer with BurstComboChain strategy.
 */

class PlagueBearerBurstComboChainAI {
...
module.exports = { PlagueBearerBurstComboChainAI };
