/**
 * PlagueBearerEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: PlagueBearer with EnrageAtLowHealth strategy.
 */

class PlagueBearerEnrageAtLowHealthAI {
...
module.exports = { PlagueBearerEnrageAtLowHealthAI };
