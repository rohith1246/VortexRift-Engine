/**
 * PlagueBearerKitingProjectileAI.js - Monster Behavior Tree Controller: PlagueBearer with KitingProjectile strategy.
 */

class PlagueBearerKitingProjectileAI {
...
module.exports = { PlagueBearerKitingProjectileAI };
