/**
 * PlagueBearerTeleportBlinkAI.js - Monster Behavior Tree Controller: PlagueBearer with TeleportBlink strategy.
 */

class PlagueBearerTeleportBlinkAI {
...
module.exports = { PlagueBearerTeleportBlinkAI };
