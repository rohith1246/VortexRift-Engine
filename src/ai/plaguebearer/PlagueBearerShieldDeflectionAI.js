/**
 * PlagueBearerShieldDeflectionAI.js - Monster Behavior Tree Controller: PlagueBearer with ShieldDeflection strategy.
 */

class PlagueBearerShieldDeflectionAI {
...
module.exports = { PlagueBearerShieldDeflectionAI };
