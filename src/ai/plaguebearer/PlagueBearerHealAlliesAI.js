/**
 * PlagueBearerHealAlliesAI.js - Monster Behavior Tree Controller: PlagueBearer with HealAllies strategy.
 */

class PlagueBearerHealAlliesAI {
...
module.exports = { PlagueBearerHealAlliesAI };
