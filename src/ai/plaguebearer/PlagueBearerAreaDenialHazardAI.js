/**
 * PlagueBearerAreaDenialHazardAI.js - Monster Behavior Tree Controller: PlagueBearer with AreaDenialHazard strategy.
 */

class PlagueBearerAreaDenialHazardAI {
...
module.exports = { PlagueBearerAreaDenialHazardAI };
