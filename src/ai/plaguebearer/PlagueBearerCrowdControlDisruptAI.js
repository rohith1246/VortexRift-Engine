/**
 * PlagueBearerCrowdControlDisruptAI.js - Monster Behavior Tree Controller: PlagueBearer with CrowdControlDisrupt strategy.
 */

class PlagueBearerCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'PlagueBearer';
...
module.exports = { PlagueBearerCrowdControlDisruptAI };
