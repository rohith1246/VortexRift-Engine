/**
 * PlagueBearerLifeStealSiphonAI.js - Monster Behavior Tree Controller: PlagueBearer with LifeStealSiphon strategy.
 */

class PlagueBearerLifeStealSiphonAI {
...
module.exports = { PlagueBearerLifeStealSiphonAI };
