/**
 * PlagueBearerAmbushFromShadowsAI.js - Monster Behavior Tree Controller: PlagueBearer with AmbushFromShadows strategy.
 */

class PlagueBearerAmbushFromShadowsAI {
...
module.exports = { PlagueBearerAmbushFromShadowsAI };
