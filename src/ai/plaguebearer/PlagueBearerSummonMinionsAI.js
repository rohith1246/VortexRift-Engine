/**
 * PlagueBearerSummonMinionsAI.js - Monster Behavior Tree Controller: PlagueBearer with SummonMinions strategy.
 */

class PlagueBearerSummonMinionsAI {
...
module.exports = { PlagueBearerSummonMinionsAI };
