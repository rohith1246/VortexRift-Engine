/**
 * PlagueBearerReflectDamageAI.js - Monster Behavior Tree Controller: PlagueBearer with ReflectDamage strategy.
 */

class PlagueBearerReflectDamageAI {
...
module.exports = { PlagueBearerReflectDamageAI };
