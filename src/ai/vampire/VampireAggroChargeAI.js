/**
 * VampireAggroChargeAI.js - Monster Behavior Tree Controller: Vampire with AggroCharge strategy.
 */

class VampireAggroChargeAI {
...
module.exports = { VampireAggroChargeAI };
