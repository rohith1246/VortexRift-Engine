/**
 * VampireAreaDenialHazardAI.js - Monster Behavior Tree Controller: Vampire with AreaDenialHazard strategy.
 */

class VampireAreaDenialHazardAI {
...
module.exports = { VampireAreaDenialHazardAI };
