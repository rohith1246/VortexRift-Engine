/**
 * VampireSummonMinionsAI.js - Monster Behavior Tree Controller: Vampire with SummonMinions strategy.
 */

class VampireSummonMinionsAI {
...
module.exports = { VampireSummonMinionsAI };
