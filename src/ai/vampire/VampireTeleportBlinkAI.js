/**
 * VampireTeleportBlinkAI.js - Monster Behavior Tree Controller: Vampire with TeleportBlink strategy.
 */

class VampireTeleportBlinkAI {
...
module.exports = { VampireTeleportBlinkAI };
