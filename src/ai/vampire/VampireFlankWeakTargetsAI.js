/**
 * VampireFlankWeakTargetsAI.js - Monster Behavior Tree Controller: Vampire with FlankWeakTargets strategy.
 */

class VampireFlankWeakTargetsAI {
...
module.exports = { VampireFlankWeakTargetsAI };
