/**
 * VampireCrowdControlDisruptAI.js - Monster Behavior Tree Controller: Vampire with CrowdControlDisrupt strategy.
 */

class VampireCrowdControlDisruptAI {
...
module.exports = { VampireCrowdControlDisruptAI };
