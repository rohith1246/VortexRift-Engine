/**
 * VampireKitingProjectileAI.js - Monster Behavior Tree Controller: Vampire with KitingProjectile strategy.
 */

class VampireKitingProjectileAI {
...
module.exports = { VampireKitingProjectileAI };
