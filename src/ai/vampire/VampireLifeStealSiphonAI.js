/**
 * VampireLifeStealSiphonAI.js - Monster Behavior Tree Controller: Vampire with LifeStealSiphon strategy.
 */

class VampireLifeStealSiphonAI {
...
module.exports = { VampireLifeStealSiphonAI };
