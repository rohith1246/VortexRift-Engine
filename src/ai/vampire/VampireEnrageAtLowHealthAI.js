/**
 * VampireEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: Vampire with EnrageAtLowHealth strategy.
 */

class VampireEnrageAtLowHealthAI {
...
module.exports = { VampireEnrageAtLowHealthAI };
