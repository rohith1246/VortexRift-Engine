/**
 * VampireBurstComboChainAI.js - Monster Behavior Tree Controller: Vampire with BurstComboChain strategy.
 */

class VampireBurstComboChainAI {
...
module.exports = { VampireBurstComboChainAI };
