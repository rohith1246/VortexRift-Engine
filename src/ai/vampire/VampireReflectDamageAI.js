/**
 * VampireReflectDamageAI.js - Monster Behavior Tree Controller: Vampire with ReflectDamage strategy.
 */

class VampireReflectDamageAI {
...
module.exports = { VampireReflectDamageAI };
