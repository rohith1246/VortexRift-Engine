/**
 * VampireShieldDeflectionAI.js - Monster Behavior Tree Controller: Vampire with ShieldDeflection strategy.
 */

class VampireShieldDeflectionAI {
...
module.exports = { VampireShieldDeflectionAI };
