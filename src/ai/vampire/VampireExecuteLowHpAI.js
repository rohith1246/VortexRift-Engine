/**
 * VampireExecuteLowHpAI.js - Monster Behavior Tree Controller: Vampire with ExecuteLowHp strategy.
 */

class VampireExecuteLowHpAI {
...
module.exports = { VampireExecuteLowHpAI };
