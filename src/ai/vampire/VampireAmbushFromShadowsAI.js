/**
 * VampireAmbushFromShadowsAI.js - Monster Behavior Tree Controller: Vampire with AmbushFromShadows strategy.
 */

class VampireAmbushFromShadowsAI {
...
module.exports = { VampireAmbushFromShadowsAI };
