/**
 * FireElementalLifeStealSiphonAI.js - Monster Behavior Tree Controller: FireElemental with LifeStealSiphon strategy.
 */

class FireElementalLifeStealSiphonAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'LifeStealSiphon';
    this.aggroRadius = 21;
    this.attackRange = 2;
...
module.exports = { FireElementalLifeStealSiphonAI };
