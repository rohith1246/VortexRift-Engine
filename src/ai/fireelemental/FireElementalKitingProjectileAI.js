/**
 * FireElementalKitingProjectileAI.js - Monster Behavior Tree Controller: FireElemental with KitingProjectile strategy.
 */

class FireElementalKitingProjectileAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'KitingProjectile';
    this.aggroRadius = 21;
    this.attackRange = 6;
...
module.exports = { FireElementalKitingProjectileAI };
