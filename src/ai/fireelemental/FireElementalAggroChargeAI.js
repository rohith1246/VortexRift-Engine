/**
 * FireElementalAggroChargeAI.js - Monster Behavior Tree Controller: FireElemental with AggroCharge strategy.
 */

class FireElementalAggroChargeAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'AggroCharge';
    this.aggroRadius = 21;
    this.attackRange = 2;
...
module.exports = { FireElementalAggroChargeAI };
