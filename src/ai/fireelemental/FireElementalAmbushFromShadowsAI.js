/**
 * FireElementalAmbushFromShadowsAI.js - Monster Behavior Tree Controller: FireElemental with AmbushFromShadows strategy.
 */

class FireElementalAmbushFromShadowsAI {
...
module.exports = { FireElementalAmbushFromShadowsAI };
