/**
 * FireElementalReflectDamageAI.js - Monster Behavior Tree Controller: FireElemental with ReflectDamage strategy.
 */

class FireElementalReflectDamageAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'ReflectDamage';
    this.aggroRadius = 21;
    this.attackRange = 4;
...
module.exports = { FireElementalReflectDamageAI };
