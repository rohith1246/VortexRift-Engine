/**
 * FireElementalCrowdControlDisruptAI.js - Monster Behavior Tree Controller: FireElemental with CrowdControlDisrupt strategy.
 */

class FireElementalCrowdControlDisruptAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'CrowdControlDisrupt';
    this.aggroRadius = 21;
    this.attackRange = 6;
...
module.exports = { FireElementalCrowdControlDisruptAI };
