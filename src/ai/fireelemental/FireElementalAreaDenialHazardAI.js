/**
 * FireElementalAreaDenialHazardAI.js - Monster Behavior Tree Controller: FireElemental with AreaDenialHazard strategy.
 */

class FireElementalAreaDenialHazardAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'AreaDenialHazard';
    this.aggroRadius = 21;
    this.attackRange = 4;
...
module.exports = { FireElementalAreaDenialHazardAI };
