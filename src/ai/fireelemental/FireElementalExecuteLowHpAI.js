/**
 * FireElementalExecuteLowHpAI.js - Monster Behavior Tree Controller: FireElemental with ExecuteLowHp strategy.
 */

class FireElementalExecuteLowHpAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'ExecuteLowHp';
    this.aggroRadius = 21;
    this.attackRange = 6;
...
module.exports = { FireElementalExecuteLowHpAI };
