/**
 * FireElementalEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: FireElemental with EnrageAtLowHealth strategy.
 */

class FireElementalEnrageAtLowHealthAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'EnrageAtLowHealth';
    this.aggroRadius = 21;
    this.attackRange = 2;
...
module.exports = { FireElementalEnrageAtLowHealthAI };
