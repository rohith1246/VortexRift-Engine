/**
 * FireElementalBurstComboChainAI.js - Monster Behavior Tree Controller: FireElemental with BurstComboChain strategy.
 */

class FireElementalBurstComboChainAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'BurstComboChain';
    this.aggroRadius = 21;
    this.attackRange = 8;
...
module.exports = { FireElementalBurstComboChainAI };
