/**
 * FireElementalSummonMinionsAI.js - Monster Behavior Tree Controller: FireElemental with SummonMinions strategy.
 */

class FireElementalSummonMinionsAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'SummonMinions';
    this.aggroRadius = 21;
    this.attackRange = 8;
...
module.exports = { FireElementalSummonMinionsAI };
