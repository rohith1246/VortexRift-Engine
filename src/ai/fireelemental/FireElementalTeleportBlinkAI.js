/**
 * FireElementalTeleportBlinkAI.js - Monster Behavior Tree Controller: FireElemental with TeleportBlink strategy.
 */

class FireElementalTeleportBlinkAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'TeleportBlink';
    this.aggroRadius = 21;
    this.attackRange = 6;
...
module.exports = { FireElementalTeleportBlinkAI };
