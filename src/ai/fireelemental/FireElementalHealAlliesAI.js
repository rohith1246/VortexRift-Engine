/**
 * FireElementalHealAlliesAI.js - Monster Behavior Tree Controller: FireElemental with HealAllies strategy.
 */

class FireElementalHealAlliesAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'HealAllies';
    this.aggroRadius = 21;
    this.attackRange = 2;
...
module.exports = { FireElementalHealAlliesAI };
