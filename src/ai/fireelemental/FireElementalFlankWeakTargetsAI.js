/**
 * FireElementalFlankWeakTargetsAI.js - Monster Behavior Tree Controller: FireElemental with FlankWeakTargets strategy.
 */

class FireElementalFlankWeakTargetsAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'FlankWeakTargets';
    this.aggroRadius = 21;
    this.attackRange = 4;
...
module.exports = { FireElementalFlankWeakTargetsAI };
