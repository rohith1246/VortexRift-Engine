/**
 * FireElementalShieldDeflectionAI.js - Monster Behavior Tree Controller: FireElemental with ShieldDeflection strategy.
 */

class FireElementalShieldDeflectionAI {
  constructor(entity, blackboard = {}) {
    this.entity = entity;
    this.blackboard = blackboard;
    this.monsterType = 'FireElemental';
    this.behaviorName = 'ShieldDeflection';
    this.aggroRadius = 21;
    this.attackRange = 8;
...
module.exports = { FireElementalShieldDeflectionAI };
