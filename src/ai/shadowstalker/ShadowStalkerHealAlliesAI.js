/**
 * ShadowStalkerHealAlliesAI.js - Monster Behavior Tree Controller: ShadowStalker with HealAllies strategy.
 */

class ShadowStalkerHealAlliesAI {
...
module.exports = { ShadowStalkerHealAlliesAI };
