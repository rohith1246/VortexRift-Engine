/**
 * ShadowStalkerFlankWeakTargetsAI.js - Monster Behavior Tree Controller: ShadowStalker with FlankWeakTargets strategy.
 */

class ShadowStalkerFlankWeakTargetsAI {
...
module.exports = { ShadowStalkerFlankWeakTargetsAI };
