/**
 * ShadowStalkerLifeStealSiphonAI.js - Monster Behavior Tree Controller: ShadowStalker with LifeStealSiphon strategy.
 */

class ShadowStalkerLifeStealSiphonAI {
...
module.exports = { ShadowStalkerLifeStealSiphonAI };
