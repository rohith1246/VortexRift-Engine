/**
 * ShadowStalkerKitingProjectileAI.js - Monster Behavior Tree Controller: ShadowStalker with KitingProjectile strategy.
 */

class ShadowStalkerKitingProjectileAI {
...
module.exports = { ShadowStalkerKitingProjectileAI };
