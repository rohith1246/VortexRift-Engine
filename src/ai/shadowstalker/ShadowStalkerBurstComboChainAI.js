/**
 * ShadowStalkerBurstComboChainAI.js - Monster Behavior Tree Controller: ShadowStalker with BurstComboChain strategy.
 */

class ShadowStalkerBurstComboChainAI {
...
module.exports = { ShadowStalkerBurstComboChainAI };
