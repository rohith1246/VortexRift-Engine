/**
 * ShadowStalkerAreaDenialHazardAI.js - Monster Behavior Tree Controller: ShadowStalker with AreaDenialHazard strategy.
 */

class ShadowStalkerAreaDenialHazardAI {
...
module.exports = { ShadowStalkerAreaDenialHazardAI };
