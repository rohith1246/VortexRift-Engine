/**
 * ShadowStalkerEnrageAtLowHealthAI.js - Monster Behavior Tree Controller: ShadowStalker with EnrageAtLowHealth strategy.
 */

class ShadowStalkerEnrageAtLowHealthAI {
...
module.exports = { ShadowStalkerEnrageAtLowHealthAI };
