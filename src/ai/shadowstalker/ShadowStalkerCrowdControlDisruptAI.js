/**
 * ShadowStalkerCrowdControlDisruptAI.js - Monster Behavior Tree Controller: ShadowStalker with CrowdControlDisrupt strategy.
 */

class ShadowStalkerCrowdControlDisruptAI {
...
module.exports = { ShadowStalkerCrowdControlDisruptAI };
